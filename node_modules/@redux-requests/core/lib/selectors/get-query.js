...
var isQueryEqual = function isQueryEqual(currentVal, previousVal) {
  ...
  if (
    ...
    var currentDependencies = (0, _normalizers.getDependentKeys)(
      currentVal.data,
      currentVal.normalizedData,
      currentVal.usedKeys
    );
    var previousDependencies = (0, _normalizers.getDependentKeys)(
      previousVal.data,
    ...
    for (
      var _iterator = _createForOfIteratorHelperLoose(currentDependencies),
        _step;
...
var createCustomSelector = (0, _reselect.createSelectorCreator)(
  _reselect.defaultMemoize,
  isQueryEqual
);
...
var defaultQueryMultiple = (0, _extends2["default"])({}, defaultQuery, {
  data: [],
});
...
var getDefaultQuery = function getDefaultQuery(defaultData, multiple) {
  ...
  if (defaultData !== undefined) {
    var query = (0, _extends2["default"])({}, defaultQuery, {
      data: defaultData,
    });
...
var _default = function _default(state, _ref2) {
  var type = _ref2.type,
