...
var isCacheValid = function isCacheValid(cache, action) {
  ...
  return (
    cache.cacheKey ===
      ((_action$meta = action.meta) == null ? void 0 : _action$meta.cacheKey) &&
...
var _default = function _default(state, action) {
  ...
  cache =
    clearAll && action.resetCached
      ? {}
      : (0, _helpers.mapObject)(cache, function (k, v) {
          var cacheValue = cache[k];
  ...
  downloadProgress = clearAll
    ? {}
    : (0, _helpers.mapObject)(downloadProgress, function (k, v) {
        return clearAll || keys.includes(k) ? resetMutation(v) : v;
      });
  uploadProgress = clearAll
    ? {}
    : (0, _helpers.mapObject)(uploadProgress, function (k, v) {
        return clearAll || keys.includes(k) ? resetMutation(v) : v;
      });
  return {
    queries: queries,
