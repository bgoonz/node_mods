...
var queryReducer = function queryReducer(
  ...
  if (
    ...
    var data = (0, _updateData["default"])(
      state.normalized
        ? (0, _selectors.getQuery)(
            {
              requests: {
                normalizedData: normalizedData,
                queries:
                  ((_queries = {}), (_queries[actionType] = state), _queries),
                downloadProgress: {},
                uploadProgress: {},
              },
            },
  ...
  switch (action.type) {
    case (0, _actions.success)(actionType):
      return ((_action$meta3 = action.meta) != null &&
        ...
        ((_action$meta4 = action.meta) != null && _action$meta4.cacheResponse)
        ? state
        : (0, _extends4["default"])({}, state, {
    ...
    case (0, _actions.error)(actionType):
      return (_action$meta5 = action.meta) != null && _action$meta5.ssrError
        ? state
        : (0, _extends4["default"])({}, state, {
            data: null,
            pending: state.pending - 1,
    ...
    default:
      return ((_action$meta6 = action.meta) != null &&
        ...
        ((_action$meta7 = action.meta) != null && _action$meta7.ssrError) ||
        ((_action$meta8 = action.meta) != null && _action$meta8.cacheResponse)
        ? state
        : (0, _extends4["default"])({}, state, {
            pending: state.pending + 1,
            error: null,
...
var maybeGetQueryActionType = function maybeGetQueryActionType(action, config) {
  ...
  if (
    (0, _actions.isResponseAction)(action) &&
    config.isRequestActionQuery(
      (0, _actions.getRequestActionFromResponse)(action)
    )
  ) {
...
var updateNormalizedData = function updateNormalizedData(
  ...
  if (
    ...
    var _normalize = (0, _normalizers.normalize)(
  ...
  if (
    (0, _actions.isResponseAction)(action) &&
    (0, _actions.isErrorAction)(action) &&
    action.meta.revertedData
  ) {
    var _normalize2 = (0, _normalizers.normalize)(
        action.meta.revertedData,
        config
      ),
  ...
  if (
    ...
    var _normalize3 = (0, _normalizers.normalize)(
  ...
  if ((_action$meta10 = action.meta) != null && _action$meta10.localData) {
    var _normalize4 = (0, _normalizers.normalize)(
        ...
        Object.keys(action.meta.mutations)
          ...
          .reduce(function (prev, actionType) {
            ...
            if (
              ...
              var _normalize5 = (0, _normalizers.normalize)(
                  updatedQuery.data,
                  config
                ),
              ...
              normalizedData = (0, _normalizers.mergeData)(
                normalizedData,
                newNormalizedData
              );
  ...
  if (queryActionType) {
    ...
    if (updatedQuery === undefined) {
      ...
      var _state$queries = state.queries,
        ...
        remainingQueries = (0, _objectWithoutPropertiesLoose2["default"])(
          _state$queries,
    ...
    if (
      ...
      return {
        queries: (0, _extends4["default"])(
          ...
          state.queries,
          ((_extends2 = {}),
          (_extends2[queryType] = (0, _extends4["default"])({}, updatedQuery, {
            data: data,
            usedKeys: usedKeys,
          })),
          _extends2)
    ...
    return {
      queries: (0, _extends4["default"])(
        {},
        state.queries,
        ((_extends3 = {}), (_extends3[queryType] = updatedQuery), _extends3)
      ),
      normalizedData: normalizedData,
    };
  }
