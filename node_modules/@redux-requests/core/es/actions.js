...
export var createSuccessAction = function createSuccessAction(
  action,
  response
) {
  return _extends(
...
export var getResponseFromSuccessAction = function getResponseFromSuccessAction(
  action
) {
...
export var getRequestActionFromResponse = function getRequestActionFromResponse(
  action
) {
...
export var resetRequests = function resetRequests(
  requests,
  abortPending,
  resetCached
) {
...
export var setDownloadProgress = function setDownloadProgress(
  requestType,
  progress
) {
  return {
...
export var setUploadProgress = function setUploadProgress(
  requestType,
  progress
) {
  return {
