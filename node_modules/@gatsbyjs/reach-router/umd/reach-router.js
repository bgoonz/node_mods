...
*/
  ...
  var Location = function Location(_ref) {
    ...
    return React__default.createElement(
      ...
      function (context) {
        return context
          ? children(context)
          : React__default.createElement(LocationProvider, null, children);
      }
    );
  };
  ...
  var LocationProvider = (function (_React$Component) {
    ...
    LocationProvider.prototype.componentDidMount =
  ...
  var RouterImpl = (function (_React$PureComponent) {
    ...
    RouterImpl.prototype.render = function render() {
      var _props = this.props,
        ...
        domProps = objectWithoutProperties(_props, [
          "location",
          "navigate",
          "basepath",
          "primary",
      ...
      var routes = React__default.Children.toArray(children).reduce(function (
        array,
        child
      ) {
      ...
      if (match$$1) {
        ...
        var clone = React__default.cloneElement(
          element,
          props,
  ...
  var FocusHandler = function FocusHandler(_ref3) {
    var uri = _ref3.uri,
      ...
      domProps = objectWithoutProperties(_ref3, [
        "uri",
        "location",
        "component",
      ]);
  ...
  var FocusHandlerImpl = (function (_React$Component2) {
    ...
    function FocusHandlerImpl() {
      ...
      return (
        (_ret2 =
          ...
          _temp2)),
        possibleConstructorReturn(_this4, _ret2)
      );
    }

    FocusHandlerImpl.getDerivedStateFromProps =
    ...
    FocusHandlerImpl.prototype.componentDidMount =
      function componentDidMount() {
        focusHandlerCount++;
        this.focus();
      };
    ...
    FocusHandlerImpl.prototype.render = function render() {
      ...
      var _props2 = this.props,
        ...
        domProps = objectWithoutProperties(_props2, [
          "children",
          "style",
          "requestFocus",
          "component",
      ...
      function (_ref5) {
        ...
        return React__default.createElement(Location, null, function (_ref6) {
          ...
          var to = props.to,
            ...
            anchorProps = objectWithoutProperties(props, [
              "to",
              "state",
              "replace",
              "getProps",
                  ...
                  if (shouldNavigate(event)) {
                    ...
                    if (typeof replace !== "boolean" && isCurrent) {
                      var _location$state = _extends({}, location.state),
                        ...
                        restState = objectWithoutProperties(_location$state, [
                          "key",
                        ]);
  ...
  var RedirectImpl = (function (_React$Component3) {
    ...
    RedirectImpl.prototype.componentDidMount = function componentDidMount() {
      var _props3 = this.props,
        ...
        props = objectWithoutProperties(_props3, [
          "navigate",
          "to",
          "from",
          "replace",
      ...
      Promise.resolve().then(function () {
        ...
        navigate$$1(insertParams(resolvedTo, props), {
          replace: replace,
          state: state,
        });
      });
    ...
    RedirectImpl.prototype.render = function render() {
      var _props4 = this.props,
        ...
        props = objectWithoutProperties(_props4, [
          "navigate",
          "to",
          "from",
          "replace",
  ...
  var Match = function Match(_ref8) {
    ...
    return React__default.createElement(
      ...
      function (_ref9) {
        ...
        return React__default.createElement(Location, null, function (_ref10) {
