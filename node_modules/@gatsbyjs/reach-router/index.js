...
exports.useMatch =
  ...
  exports.navigate =
  exports.isRedirect =
  exports.createMemorySource =
  exports.createHistory =
  exports.ServerLocation =
  exports.Router =
  exports.Redirect =
  exports.Match =
...
var Location = function Location(_ref) {
  ...
  return _react2.default.createElement(
    ...
    function (context) {
      return context
        ? children(context)
        : _react2.default.createElement(LocationProvider, null, children);
    }
  );
};
...
var RouterImpl = (function (_React$PureComponent) {
  ...
  RouterImpl.prototype.render = function render() {
    ...
    var routes = _react2.default.Children.toArray(children).reduce(function (
      array,
      child
    ) {
    ...
    if (match) {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(FocusWrapper, wrapperProps, clone)
      );
    } else {
              ...
              onClick: function onClick(event) {
                ...
                if (shouldNavigate(event)) {
                  ...
                  if (typeof replace !== "boolean" && isCurrent) {
                    ...
                    shouldReplace = (0, _utils.shallowCompare)(
                      _extends({}, state),
                      restState
                    );
                  }
...
var Match = function Match(_ref8) {
  ...
  return _react2.default.createElement(
    ...
    function (_ref9) {
      ...
      return _react2.default.createElement(Location, null, function (_ref10) {
...
var createRoute = function createRoute(basepath) {
  return function (element) {
    ...
    !!(
      ...
      !(0, _utils.validateRedirect)(element.props.from, element.props.to)
    )
      ? process.env.NODE_ENV !== "production"
        ? (0, _invariant2.default)(
            false,
