 ...
 * @returns A 402 Payment Required error
 */
export function paymentRequired<Data>(
  message?: string,
  data?: Data
): Boom<Data>;
 ...
 * @returns A 407 Proxy Authentication error
 */
export function proxyAuthRequired<Data>(
  message?: string,
  data?: Data
): Boom<Data>;
 ...
 * @returns A 412 Precondition Failed error
 */
export function preconditionFailed<Data>(
  message?: string,
  data?: Data
): Boom<Data>;
 ...
 * @returns A 415 Unsupported Media Type error
 */
export function unsupportedMediaType<Data>(
  message?: string,
  data?: Data
): Boom<Data>;
 ...
 * @returns A 416 Request Range Not Satisfiable error
 */
export function rangeNotSatisfiable<Data>(
  message?: string,
  data?: Data
): Boom<Data>;
 ...
 * @returns A 417 Expectation Failed error
 */
export function expectationFailed<Data>(
  message?: string,
  data?: Data
): Boom<Data>;
 ...
 * @returns A 424 Failed Dependency error
 */
export function failedDependency<Data>(
  message?: string,
  data?: Data
): Boom<Data>;
 ...
 * @returns A 428 Precondition Required error
 */
export function preconditionRequired<Data>(
  message?: string,
  data?: Data
): Boom<Data>;
 ...
 * @returns A 429 Too Many Requests error
 */
export function tooManyRequests<Data>(
  message?: string,
  data?: Data
): Boom<Data>;
 ...
 * @returns A 500 Internal Server error
 */
export function badImplementation<Data>(
  message?: string,
  data?: Data
): Boom<Data>;
 ...
 * @returns A 503 Service Unavailable error
 */
export function serverUnavailable<Data>(
  message?: string,
  data?: Data
): Boom<Data>;
