...
export let __assign = function(...args) {
...
export function __awaiter(thisArg, _arguments, P, generator) {
    ...
    return new (P || (P = Promise))((resolve, reject) => {
        ...
        function step({done, value}) { done ? resolve(value) : adopt(value).then(fulfilled, rejected); }
        step((generator = generator.apply(thisArg, _arguments || [])).next());
    });
}

export function __generator(thisArg, body) {
    let _ = { label: 0, sent() { if (t[0] & 1) throw t[1]; return t[1]; }, trys: [], ops: [] };
    let f;
    let y;
    let t;
    let g;
...
export const __createBinding = Object.create ? ((o, m, k, k2) => {
...
export function __spread(...args) {
    for (var ar = [], i = 0; i < args.length; i++)
        ar = ar.concat(__read(args[i]));
    return ar;
}

export function __spreadArrays(...args) {
...
export function __asyncGenerator(thisArg, _arguments, generator) {
    ...
    function verb(n) { if (g[n]) i[n] = v => { return new Promise((a, b) => { q.push([n, v, a, b]) > 1 || resume(n, v); }); }; }
...
export function __asyncValues(o) {
    ...
    function verb(n) { i[n] = o[n] && (v => { return new Promise((resolve, reject) => { v = o[n](v), settle(resolve, reject, v.done, v.value); }); }); }
