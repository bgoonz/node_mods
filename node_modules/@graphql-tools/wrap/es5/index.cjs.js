...
function generateProxyingResolvers(subschemaConfig) {
  ...
  var createProxyingResolver =
    (_a = subschemaConfig.createProxyingResolver) !== null && _a !== void 0
      ? _a
      : defaultCreateProxyingResolver;
  var transformedSchema = delegate.applySchemaTransforms(
    targetSchema,
    subschemaConfig
  );
  var operationTypes = {
  ...
  Object.keys(operationTypes).forEach(function (operation) {
    ...
    if (rootType != null) {
      ...
      Object.keys(fields).forEach(function (fieldName) {
        ...
        var finalResolver = createPossiblyNestedProxyingResolver(
          subschemaConfig,
          proxyingResolver
        );
...
function defaultCreateProxyingResolver(_a) {
  var subschemaConfig = _a.subschemaConfig,
    ...
    transformedSchema = _a.transformedSchema;
...
function wrapSchema(subschemaConfig) {
  ...
  return delegate.applySchemaTransforms(
    schema,
    subschemaConfig,
    transformedSchema
  );
  ...
  return utils.mapSchema(
    ...
    (_a[utils.MapperKind.ROOT_OBJECT] = function (type) {
      ...
      Object.keys(fieldConfigMap).forEach(function (fieldName) {
        fieldConfigMap[fieldName] = tslib.__assign(
          tslib.__assign({}, fieldConfigMap[fieldName]),
...
var RenameTypes = /** @class */ (function () {
  ...
  RenameTypes.prototype.transformSchema = function (
  ...
  RenameTypes.prototype.transformRequest = function (
    originalRequest,
    _delegationContext,
    ...
    return tslib.__assign(tslib.__assign({}, originalRequest), {
      document: document,
    });
  };
  RenameTypes.prototype.transformResult = function (
    originalResult,
    _delegationContext,
    _transformationContext
  ) {
    var _this = this;
    return tslib.__assign(tslib.__assign({}, originalResult), {
      data: utils.visitData(originalResult.data, function (object) {
        var typeName =
          object === null || object === void 0 ? void 0 : object.__typename;
...
var FilterTypes = /** @class */ (function () {
  ...
  FilterTypes.prototype.transformSchema = function (
    originalWrappingSchema,
    _subschemaConfig,
    _transformedSchema
  ) {
...
var RenameRootTypes = /** @class */ (function () {
  ...
  RenameRootTypes.prototype.transformSchema = function (
    originalWrappingSchema,
    _subschemaConfig,
    _transformedSchema
  ) {
  ...
  RenameRootTypes.prototype.transformRequest = function (
    originalRequest,
    _delegationContext,
    _transformationContext
  ) {
  ...
  RenameRootTypes.prototype.transformResult = function (
    originalResult,
    _delegationContext,
    _transformationContext
  ) {
...
var TransformCompositeFields = /** @class */ (function () {
  function TransformCompositeFields(
    fieldTransformer,
  ...
  TransformCompositeFields.prototype.transformSchema = function (
    originalWrappingSchema,
    _subschemaConfig,
    _transformedSchema
  ) {
    ...
    var _this = this;
    var _b;
    this.transformedSchema = utils.mapSchema(
      originalWrappingSchema,
      ((_a = {}),
      (_a[utils.MapperKind.COMPOSITE_FIELD] = function (
        fieldConfig,
        fieldName,
        typeName
      ) {
        var transformedField = _this.fieldTransformer(
          typeName,
          fieldName,
          fieldConfig
        );
    ...
    this.subscriptionTypeName =
      (_b = originalWrappingSchema.getSubscriptionType()) === null ||
      _b === void 0
        ? void 0
        : _b.name;
    return this.transformedSchema;
  };
  TransformCompositeFields.prototype.transformRequest = function (
    originalRequest,
    _delegationContext,
  ...
  TransformCompositeFields.prototype.transformResult = function (
    result,
    _delegationContext,
    transformationContext
  ) {
    ...
    if (this.dataTransformer != null) {
      result.data = utils.visitData(result.data, function (value) {
        return _this.dataTransformer(value, transformationContext);
      });
    }
  ...
  TransformCompositeFields.prototype.transformDocument = function (
    document,
    fragments,
    transformationContext
  ) {
      ...
      graphql.visitWithTypeInfo(this.typeInfo, {
        leave:
          ...
          (_a[graphql.Kind.SELECTION_SET] = function (node) {
            return _this.transformSelectionSet(
              node,
              _this.typeInfo,
              fragments,
              transformationContext
  ...
  TransformCompositeFields.prototype.transformSelectionSet = function (
    node,
    typeInfo,
    fragments,
    transformationContext
    ...
    node.selections.forEach(function (selection) {
      ...
      if (
        (_this.dataTransformer != null || _this.errorsTransformer != null) &&
        (_this.subscriptionTypeName == null ||
          parentTypeName !== _this.subscriptionTypeName)
      ) {
        newSelections.push({
      ...
      if (_this.fieldNodeTransformer == null) {
        ...
        transformedSelection = _this.fieldNodeTransformer(
          parentTypeName,
          newName,
          selection,
          fragments,
      ...
      newSelections.push(
        tslib.__assign(tslib.__assign({}, transformedSelection), {
          name: {
            kind: graphql.Kind.NAME,
            value: oldName,
          },
          alias: {
            ...
            value:
              (_b =
                (_a = transformedSelection.alias) === null || _a === void 0
                  ? void 0
...
var TransformObjectFields = /** @class */ (function () {
  ...
  TransformObjectFields.prototype.transformSchema = function (
    originalWrappingSchema,
    subschemaConfig,
    transformedSchema
  ) {
    var _this = this;
    var compositeToObjectFieldTransformer = function (
      typeName,
      fieldName,
      fieldConfig
    ) {
  ...
  TransformObjectFields.prototype.transformRequest = function (
    originalRequest,
    delegationContext,
    transformationContext
  ) {
  ...
  TransformObjectFields.prototype.transformResult = function (
    originalResult,
    delegationContext,
    transformationContext
  ) {
...
var TransformRootFields = /** @class */ (function () {
  ...
  TransformRootFields.prototype.transformSchema = function (
    originalWrappingSchema,
    subschemaConfig,
    transformedSchema
  ) {
    ...
    var _a, _b, _c;
    var queryTypeName =
      (_a = originalWrappingSchema.getQueryType()) === null || _a === void 0
        ? void 0
        : _a.name;
    var mutationTypeName =
      (_b = originalWrappingSchema.getMutationType()) === null || _b === void 0
        ? void 0
        : _b.name;
    var subscriptionTypeName =
      (_c = originalWrappingSchema.getSubscriptionType()) === null ||
      _c === void 0
        ? void 0
        : _c.name;
    var rootToObjectFieldTransformer = function (
      typeName,
      fieldName,
      fieldConfig
    ) {
      ...
      if (typeName === subscriptionTypeName) {
        return _this.rootFieldTransformer(
          "Subscription",
          fieldName,
          fieldConfig
        );
  ...
  TransformRootFields.prototype.transformRequest = function (
    originalRequest,
    delegationContext,
    transformationContext
  ) {
  ...
  TransformRootFields.prototype.transformResult = function (
    originalResult,
    delegationContext,
    transformationContext
  ) {
...
var RenameRootFields = /** @class */ (function () {
  function RenameRootFields(renamer) {
    this.transformer = new TransformRootFields(function (
      operation,
      fieldName,
      fieldConfig
    ) {
      return [renamer(operation, fieldName, fieldConfig), fieldConfig];
    });
  }
  RenameRootFields.prototype.transformSchema = function (
    originalWrappingSchema,
    subschemaConfig,
    transformedSchema
  ) {
  ...
  RenameRootFields.prototype.transformRequest = function (
    originalRequest,
    delegationContext,
    transformationContext
  ) {
...
var FilterRootFields = /** @class */ (function () {
  ...
  FilterRootFields.prototype.transformSchema = function (
    originalWrappingSchema,
    subschemaConfig,
    transformedSchema
  ) {
...
var RenameObjectFields = /** @class */ (function () {
  function RenameObjectFields(renamer) {
    this.transformer = new TransformObjectFields(function (
      typeName,
      fieldName,
      fieldConfig
    ) {
      return [renamer(typeName, fieldName, fieldConfig), fieldConfig];
    });
  }
  RenameObjectFields.prototype.transformSchema = function (
    originalWrappingSchema,
    subschemaConfig,
    transformedSchema
  ) {
  ...
  RenameObjectFields.prototype.transformRequest = function (
    originalRequest,
    delegationContext,
    transformationContext
  ) {
...
var FilterObjectFields = /** @class */ (function () {
  ...
  FilterObjectFields.prototype.transformSchema = function (
    originalWrappingSchema,
    subschemaConfig,
    transformedSchema
  ) {
...
var TransformInterfaceFields = /** @class */ (function () {
  function TransformInterfaceFields(
  ...
  TransformInterfaceFields.prototype.transformSchema = function (
    originalWrappingSchema,
    subschemaConfig,
    transformedSchema
  ) {
    ...
    var compositeToObjectFieldTransformer = function (
      ...
      if (graphql.isInterfaceType(originalWrappingSchema.getType(typeName))) {
        return _this.interfaceFieldTransformer(
          typeName,
          fieldName,
          fieldConfig
        );
  ...
  TransformInterfaceFields.prototype.transformRequest = function (
    originalRequest,
    delegationContext,
    transformationContext
  ) {
  ...
  TransformInterfaceFields.prototype.transformResult = function (
    originalResult,
    delegationContext,
    transformationContext
  ) {
...
var RenameInterfaceFields = /** @class */ (function () {
  function RenameInterfaceFields(renamer) {
    this.transformer = new TransformInterfaceFields(function (
      typeName,
      fieldName,
      fieldConfig
    ) {
  ...
  RenameInterfaceFields.prototype.transformSchema = function (
    originalWrappingSchema,
    subschemaConfig,
    transformedSchema
  ) {
  ...
  RenameInterfaceFields.prototype.transformRequest = function (
    originalRequest,
    delegationContext,
    transformationContext
  ) {
...
var FilterInterfaceFields = /** @class */ (function () {
  ...
  FilterInterfaceFields.prototype.transformSchema = function (
    originalWrappingSchema,
    subschemaConfig,
    transformedSchema
  ) {
...
var TransformInputObjectFields = /** @class */ (function () {
  function TransformInputObjectFields(
  ...
  TransformInputObjectFields.prototype.transformSchema = function (
    originalWrappingSchema,
    _subschemaConfig,
    _transformedSchema
  ) {
    ...
    this.transformedSchema = utils.mapSchema(
      originalWrappingSchema,
      ((_a = {}),
      (_a[utils.MapperKind.INPUT_OBJECT_FIELD] = function (
        inputFieldConfig,
        fieldName,
        typeName
      ) {
        var transformedInputField = _this.inputFieldTransformer(
          typeName,
          fieldName,
          inputFieldConfig
        );
  ...
  TransformInputObjectFields.prototype.transformRequest = function (
    originalRequest,
    delegationContext,
    _transformationContext
  ) {
    ...
    operations.forEach(function (def) {
      ...
      if (variableDefs != null) {
        variableDefs.forEach(function (variableDef) {
          ...
          var varType = graphql.typeFromAST(
          ...
          variableValues[varName] = utils.transformInputValue(
            ...
            function (type, originalValue) {
              ...
              Object.keys(originalValue).forEach(function (key) {
                ...
                if (field != null) {
                  var newFieldName =
                    (_a = _this.mapping[type.name]) === null || _a === void 0
                      ? void 0
                      : _a[field.name];
    ...
    var document = this.transformDocument(
      originalRequest.document,
      this.mapping,
  ...
  TransformInputObjectFields.prototype.transformDocument = function (
    document,
    mapping,
    inputFieldNodeTransformer,
    inputObjectNodeTransformer,
              ...
              node.fields.forEach(function (inputField) {
                ...
                var transformedInputField =
                  inputFieldNodeTransformer != null
                    ...
                    : inputField;
                if (Array.isArray(transformedInputField)) {
                  transformedInputField.forEach(function (
                    ...
                    newInputFields_1.push(
                      tslib.__assign(
                        tslib.__assign({}, individualTransformedInputField),
                        {
                          name: tslib.__assign(
                            tslib.__assign(
                              {},
                ...
                newInputFields_1.push(
                  tslib.__assign(tslib.__assign({}, transformedInputField), {
                    name: tslib.__assign(
                      tslib.__assign({}, transformedInputField.name),
                      { value: oldName }
                    ),
                  })
                );
              });
              var newNode = tslib.__assign(tslib.__assign({}, node), {
                fields: newInputFields_1,
              });
...
var RenameInputObjectFields = /** @class */ (function () {
  function RenameInputObjectFields(renamer) {
    ...
    this.transformer = new TransformInputObjectFields(
      ...
      function (typeName, inputFieldName, inputFieldNode) {
        ...
        return tslib.__assign(tslib.__assign({}, inputFieldNode), {
          name: tslib.__assign(tslib.__assign({}, inputFieldNode.name), {
  ...
  RenameInputObjectFields.prototype.transformSchema = function (
    originalWrappingSchema,
    subschemaConfig,
    transformedSchema
  ) {
  ...
  RenameInputObjectFields.prototype.transformRequest = function (
    originalRequest,
    delegationContext,
    transformationContext
  ) {
...
var FilterInputObjectFields = /** @class */ (function () {
  function FilterInputObjectFields(filter, inputObjectNodeTransformer) {
    this.transformer = new TransformInputObjectFields(
      function (typeName, fieldName, inputFieldConfig) {
  ...
  FilterInputObjectFields.prototype.transformSchema = function (
    originalWrappingSchema,
    subschemaConfig,
    transformedSchema
  ) {
  ...
  FilterInputObjectFields.prototype.transformRequest = function (
    originalRequest,
    delegationContext,
    transformationContext
  ) {
...
var MapLeafValues = /** @class */ (function () {
  ...
  MapLeafValues.prototype.transformSchema = function (
    originalWrappingSchema,
    _subschemaConfig,
    _transformedSchema
  ) {
    ...
    Object.keys(typeMap).forEach(function (typeName) {
      ...
      if (!typeName.startsWith("__")) {
        if (graphql.isLeafType(type)) {
          _this.resultVisitorMap[typeName] = function (value) {
            return _this.outputValueTransformer(typeName, value);
          };
        }
      }
    });
  ...
  MapLeafValues.prototype.transformRequest = function (
    originalRequest,
    _delegationContext,
    transformationContext
  ) {
    ...
    var transformedRequest = tslib.__assign(
      tslib.__assign({}, originalRequest),
      {
        document: tslib.__assign(tslib.__assign({}, document), {
          definitions: tslib.__spreadArray(
            tslib.__spreadArray([], tslib.__read(newOperations)),
            tslib.__read(fragments)
          ),
        }),
        variables: variableValues,
      }
  ...
  MapLeafValues.prototype.transformResult = function (
    originalResult,
    _delegationContext,
    transformationContext
  ) {
  ...
  MapLeafValues.prototype.transformOperations = function (
    operations,
    variableValues
  ) {
    var _this = this;
    return operations.map(function (operation) {
      var _a;
      var variableDefinitionMap = operation.variableDefinitions.reduce(
        function (prev, def) {
          var _a;
          return tslib.__assign(
            tslib.__assign({}, prev),
            ((_a = {}), (_a[def.variable.name.value] = def), _a)
          );
        },
        {}
      );
      var newOperation = graphql.visit(
        operation,
        graphql.visitWithTypeInfo(
          _this.typeInfo,
          ((_a = {}),
          (_a[graphql.Kind.FIELD] = function (node) {
            return _this.transformFieldNode(
              node,
      ...
      return tslib.__assign(tslib.__assign({}, newOperation), {
        variableDefinitions: Object.keys(variableDefinitionMap).map(function (
          varName
        ) {
  ...
  MapLeafValues.prototype.transformFieldNode = function (
    field,
    variableDefinitionMap,
    variableValues
  ) {
    ...
    if (!targetField.name.startsWith("__")) {
      ...
      if (argumentNodes != null) {
        var argumentNodeMap_1 = argumentNodes.reduce(function (prev, argument) {
          ...
          return tslib.__assign(
            tslib.__assign({}, prev),
            ((_a = {}), (_a[argument.name.value] = argument), _a)
          );
        }, Object.create(null));
        targetField.args.forEach(function (argument) {
          ...
          var argValue =
            argumentNode === null || argumentNode === void 0
              ? void 0
              : argumentNode.value;
          var value;
          if (argValue != null) {
          ...
          utils.updateArgument(
            ...
            variableDefinitionMap,
            variableValues,
            utils.transformInputValue(argType, value, function (t, v) {
              var newValue = _this.inputValueTransformer(t.name, v);
              return newValue === undefined ? v : newValue;
            })
          );
        });
        return tslib.__assign(tslib.__assign({}, field), {
...
var TransformEnumValues = /** @class */ (function () {
  ...
  TransformEnumValues.prototype.transformSchema = function (
    originalWrappingSchema,
    subschemaConfig,
    transformedSchema
  ) {
    var _a;
    var _this = this;
    var mappingSchema = this.transformer.transformSchema(
      originalWrappingSchema,
      subschemaConfig,
      transformedSchema
    );
    this.transformedSchema = utils.mapSchema(
      mappingSchema,
      ((_a = {}),
      (_a[utils.MapperKind.ENUM_VALUE] = function (
        valueConfig,
        typeName,
        _schema,
        externalValue
  ...
  TransformEnumValues.prototype.transformRequest = function (
    originalRequest,
    delegationContext,
    transformationContext
  ) {
  ...
  TransformEnumValues.prototype.transformResult = function (
    originalResult,
    delegationContext,
    transformationContext
  ) {
  ...
  TransformEnumValues.prototype.transformEnumValue = function (
    typeName,
    externalValue,
    enumValueConfig
  ) {
    var transformedEnumValue = this.enumValueTransformer(
      typeName,
      externalValue,
      enumValueConfig
    );
...
function mapEnumValues(typeName, value, mapping) {
  var _a;
  var newExternalValue =
    (_a = mapping[typeName]) === null || _a === void 0 ? void 0 : _a[value];
...
function generateValueTransformer(valueTransformer, mapping) {
  if (valueTransformer == null) {
    return function (typeName, value) {
      return mapEnumValues(typeName, value, mapping);
    };
  } else {
    return function (typeName, value) {
      return mapEnumValues(
        typeName,
        valueTransformer(typeName, value),
        mapping
      );
    };
  }
...
var TransformQuery = /** @class */ (function () {
  ...
  TransformQuery.prototype.transformRequest = function (
    originalRequest,
    delegationContext,
    transformationContext
  ) {
    ...
    var document = graphql.visit(
      ...
      (_a[graphql.Kind.FIELD] = {
        enter: function (node) {
          ...
          index++;
          if (index === pathLength) {
            var selectionSet = _this.queryTransformer(
              node.selectionSet,
              _this.fragments,
              delegationContext,
              transformationContext
  ...
  TransformQuery.prototype.transformResult = function (
    originalResult,
    delegationContext,
    transformationContext
  ) {
  ...
  TransformQuery.prototype.transformData = function (
    data,
    delegationContext,
    transformationContext
  ) {
...
var FilterObjectFieldDirectives = /** @class */ (function () {
  ...
  FilterObjectFieldDirectives.prototype.transformSchema = function (
    originalWrappingSchema,
    subschemaConfig,
    transformedSchema
  ) {
    var _this = this;
    var transformer = new TransformObjectFields(function (
      _typeName,
      _fieldName,
      fieldConfig
    ) {
      var keepDirectives = fieldConfig.astNode.directives.filter(function (
        dir
      ) {
        var directiveDef = originalWrappingSchema.getDirective(dir.name.value);
        var directiveValue = directiveDef
          ? utils.getArgumentValues(directiveDef, dir)
          : undefined;
        return _this.filter(dir.name.value, directiveValue);
      });
      if (keepDirectives.length !== fieldConfig.astNode.directives.length) {
        fieldConfig = tslib.__assign(tslib.__assign({}, fieldConfig), {
          astNode: tslib.__assign(tslib.__assign({}, fieldConfig.astNode), {
...
var RemoveObjectFieldDirectives = /** @class */ (function () {
  function RemoveObjectFieldDirectives(directiveName, args) {
    ...
    this.transformer = new FilterObjectFieldDirectives(function (
      dirName,
      dirValue
    ) {
      return !(
        utils.valueMatchesCriteria(dirName, directiveName) &&
        utils.valueMatchesCriteria(dirValue, args)
      );
    });
  }
  RemoveObjectFieldDirectives.prototype.transformSchema = function (
    originalWrappingSchema,
    subschemaConfig,
    transformedSchema
  ) {
...
var RemoveObjectFieldsWithDirective = /** @class */ (function () {
  ...
  RemoveObjectFieldsWithDirective.prototype.transformSchema = function (
    originalWrappingSchema,
    subschemaConfig,
    transformedSchema
  ) {
    var _this = this;
    var transformer = new FilterObjectFields(function (
      _typeName,
      _fieldName,
      fieldConfig
    ) {
      ...
      return !Object.keys(valueMap).some(function (directiveName) {
        return (
          utils.valueMatchesCriteria(directiveName, _this.directiveName) &&
          ((Array.isArray(valueMap[directiveName]) &&
            valueMap[directiveName].some(function (value) {
              return utils.valueMatchesCriteria(value, _this.args);
            })) ||
...
var RemoveObjectFieldDeprecations = /** @class */ (function () {
  function RemoveObjectFieldDeprecations(reason) {
    ...
    this.removeDirectives = new FilterObjectFieldDirectives(function (
      dirName,
      dirValue
    ) {
      return !(
        dirName === "deprecated" && utils.valueMatchesCriteria(dirValue, args)
      );
    });
    this.removeDeprecations = new TransformObjectFields(function (
      _typeName,
      _fieldName,
      fieldConfig
    ) {
      if (
        ...
        utils.valueMatchesCriteria(fieldConfig.deprecationReason, reason)
      ) {
  ...
  RemoveObjectFieldDeprecations.prototype.transformSchema = function (
    originalWrappingSchema,
    subschemaConfig,
    transformedSchema
  ) {
...
var RemoveObjectFieldsWithDeprecation = /** @class */ (function () {
  function RemoveObjectFieldsWithDeprecation(reason) {
    this.transformer = new FilterObjectFields(function (
      _typeName,
      _fieldName,
      fieldConfig
    ) {
      if (fieldConfig.deprecationReason) {
        return !utils.valueMatchesCriteria(
          fieldConfig.deprecationReason,
          reason
        );
      }
  ...
  RemoveObjectFieldsWithDeprecation.prototype.transformSchema = function (
    originalWrappingSchema,
    subschemaConfig,
    transformedSchema
  ) {
...
var PruneTypes = /** @class */ (function () {
  ...
  PruneTypes.prototype.transformSchema = function (
    originalWrappingSchema,
    _subschemaConfig,
    _transformedSchema
  ) {
...
var MapFields = /** @class */ (function () {
  ...
  MapFields.prototype.transformSchema = function (
    originalWrappingSchema,
    subschemaConfig,
    transformedSchema
  ) {
    ...
    var _a;
    var subscriptionTypeName =
      (_a = originalWrappingSchema.getSubscriptionType()) === null ||
      _a === void 0
        ? void 0
        : _a.name;
    this.transformer = new TransformCompositeFields(
  ...
  MapFields.prototype.transformRequest = function (
    originalRequest,
    delegationContext,
    transformationContext
  ) {
  ...
  MapFields.prototype.transformResult = function (
    originalResult,
    delegationContext,
    transformationContext
  ) {
...
var WrapFields = /** @class */ (function () {
  function WrapFields(
    ...
    this.transformer = new MapFields(
      ...
      (_a[outerTypeName] =
        ((_b = {}),
        (_b[outerMostWrappingFieldName] = function (
          fieldNode,
          fragments,
          transformationContext
        ) {
      ...
      _a),
      ((_c = {}),
      (_c[outerTypeName] = function (value, context) {
        return dehoistValue(value, context);
      }),
      _c),
      function (errors, context) {
        return dehoistErrors(errors, context);
      }
    );
  }
  WrapFields.prototype.transformSchema = function (
    originalWrappingSchema,
    subschemaConfig,
    transformedSchema
  ) {
    ...
    var _this = this;
    var _d, _e, _f;
    var targetFieldConfigMap = utils.selectObjectFields(
      originalWrappingSchema,
      this.outerTypeName,
      !this.fieldNames
        ? function () {
    ...
    Object.keys(targetFieldConfigMap).forEach(function (fieldName) {
      ...
      var newField = tslib.__assign(tslib.__assign({}, field), {
    ...
    var newSchema = utils.appendObjectFields(
      originalWrappingSchema,
      wrappingTypeName,
    ...
    for (wrapIndex--; wrapIndex > -1; wrapIndex--) {
      ...
      newSchema = utils.appendObjectFields(
        newSchema,
        nextWrappingTypeName,
        ((_a = {}),
    ...
    var wrappingRootField =
      this.outerTypeName ===
        ((_d = originalWrappingSchema.getQueryType()) === null || _d === void 0
          ? void 0
          : _d.name) ||
      this.outerTypeName ===
        ((_e = originalWrappingSchema.getMutationType()) === null ||
        _e === void 0
          ? void 0
          : _e.name);
    var resolve;
    if (transformedSchema) {
      if (wrappingRootField) {
        var targetSchema = subschemaConfig.schema;
        var operation =
          this.outerTypeName === targetSchema.getQueryType().name
            ? "query"
            : "mutation";
        var createProxyingResolver =
          (_f = subschemaConfig.createProxyingResolver) !== null &&
          _f !== void 0
            ? _f
            : defaultCreateProxyingResolver;
  ...
  WrapFields.prototype.transformRequest = function (
    originalRequest,
    delegationContext,
    transformationContext
  ) {
  ...
  WrapFields.prototype.transformResult = function (
    originalResult,
    delegationContext,
    transformationContext
  ) {
...
function aliasFieldNode(fieldNode, str) {
  return tslib.__assign(tslib.__assign({}, fieldNode), {
    alias: {
      kind: graphql.Kind.NAME,
      value: str,
    },
...
function hoistFieldNodes(_a) {
  var fieldNode = _a.fieldNode,
    ...
    transformationContext = _a.transformationContext,
    prefix = _a.prefix,
    _b = _a.index,
    index = _b === void 0 ? 0 : _b,
    _c = _a.wrappingPath,
    wrappingPath = _c === void 0 ? [] : _c;
  var alias =
    fieldNode.alias != null ? fieldNode.alias.value : fieldNode.name.value;
  var newFieldNodes = [];
  if (index < path.length) {
    var pathSegment_1 = path[index];
    collectFields(fieldNode.selectionSet, fragments).forEach(function (
      possibleFieldNode
    ) {
...
var WrapType = /** @class */ (function () {
  ...
  WrapType.prototype.transformSchema = function (
    originalWrappingSchema,
    subschemaConfig,
    transformedSchema
  ) {
  ...
  WrapType.prototype.transformRequest = function (
    originalRequest,
    delegationContext,
    transformationContext
  ) {
  ...
  WrapType.prototype.transformResult = function (
    originalResult,
    delegationContext,
    transformationContext
  ) {
...
var HoistField = /** @class */ (function () {
  function HoistField(typeName, pathConfig, newFieldName, alias) {
    ...
    var path = pathConfig.map(function (segment) {
      return typeof segment === "string" ? segment : segment.fieldName;
    });
    this.argFilters = pathConfig.map(function (segment, index) {
      if (typeof segment === "string" || segment.argFilter == null) {
        return index === pathConfig.length - 1
          ? function () {
              return true;
            }
          : function () {
    ...
    this.transformer = new MapFields(
      ...
      _a),
      ((_c = {}),
      (_c[typeName] = function (value) {
        return unwrapValue(value, alias);
      }),
      _c),
      function (errors) {
        return unwrapErrors(errors, alias);
      }
    );
    this.argLevels = argLevels;
  }
  HoistField.prototype.transformSchema = function (
    originalWrappingSchema,
    subschemaConfig,
    transformedSchema
  ) {
    ...
    var _e = tslib.__read(
      ...
      newSchema = _e[0],
      targetFieldConfigMap = _e[1];
    var targetField = targetFieldConfigMap[this.oldFieldName];
    var resolve;
    if (transformedSchema) {
      var hoistingToRootField =
        this.typeName ===
          ((_b = originalWrappingSchema.getQueryType()) === null ||
          _b === void 0
            ? void 0
            : _b.name) ||
        this.typeName ===
          ((_c = originalWrappingSchema.getMutationType()) === null ||
          _c === void 0
            ? void 0
            : _c.name);
      if (hoistingToRootField) {
        var targetSchema = subschemaConfig.schema;
        var operation =
          this.typeName === targetSchema.getQueryType().name
            ? "query"
            : "mutation";
        var createProxyingResolver =
          (_d = subschemaConfig.createProxyingResolver) !== null &&
          _d !== void 0
            ? _d
            : defaultCreateProxyingResolver;
        resolve = createProxyingResolver({
    ...
    var newTargetField = tslib.__assign(tslib.__assign({}, targetField), {
      resolve: resolve,
    });
    ...
    Object.keys(targetField.args).forEach(function (argName) {
      ...
      var arg = tslib.__assign(tslib.__assign({}, argConfig), {
        name: argName,
    ...
    newSchema = utils.appendObjectFields(
      newSchema,
      this.typeName,
      ((_a = {}), (_a[this.newFieldName] = newTargetField), _a)
    );
    return this.transformer.transformSchema(
      newSchema,
      subschemaConfig,
  ...
  HoistField.prototype.transformRequest = function (
    originalRequest,
    delegationContext,
    transformationContext
  ) {
  ...
  HoistField.prototype.transformResult = function (
    originalResult,
    delegationContext,
    transformationContext
  ) {
  ...
  return path.reduceRight(
    function (acc, fieldName, index) {
      return {
        ...
        arguments: fieldNode.arguments.filter(function (arg) {
          return argLevels[arg.name.value] === index;
        }),
      };
    },
    tslib.__assign(tslib.__assign({}, fieldNode), {
      arguments: fieldNode.arguments.filter(function (arg) {
        return argLevels[arg.name.value] === path.length;
      }),
    })
  );
}
...
function unwrapErrors(errors, alias) {
  ...
  return errors.map(function (error) {
    ...
    var newPath = originalPath.filter(function (pathSegment) {
      return pathSegment !== alias;
    });
    return utils.relocatedError(error, newPath);
  });
}
...
var WrapQuery = /** @class */ (function () {
  ...
  WrapQuery.prototype.transformRequest = function (
    originalRequest,
    _delegationContext,
    _transformationContext
  ) {
      ...
      (_a[graphql.Kind.FIELD] = {
        enter: function (node) {
          ...
          if (ourPath === JSON.stringify(fieldPath)) {
            ...
            var selectionSet =
              wrapResult != null &&
              wrapResult.kind === graphql.Kind.SELECTION_SET
                ? wrapResult
                : {
                    kind: graphql.Kind.SELECTION_SET,
  ...
  WrapQuery.prototype.transformResult = function (
    originalResult,
    _delegationContext,
    _transformationContext
  ) {
...
var ExtractField = /** @class */ (function () {
  ...
  ExtractField.prototype.transformRequest = function (
    originalRequest,
    _delegationContext,
    _transformationContext
  ) {
...
function makeRemoteExecutableSchema(_a) {
  ...
  var targetSchema =
    typeof schemaOrTypeDefs === "string"
      ? graphql.buildSchema(schemaOrTypeDefs, buildSchemaOptions)
      : schemaOrTypeDefs;
  return wrapSchema({
    schema: targetSchema,
    createProxyingResolver: function () {
      return createResolver(executor, subscriber);
    },
  });
}
...
function getSchemaFromIntrospection(introspectionResult) {
  ...
  if (
    (_a =
      introspectionResult === null || introspectionResult === void 0
        ? void 0
        : introspectionResult.data) === null || _a === void 0
      ? void 0
      : _a.__schema
  ) {
    ...
    (_b =
      introspectionResult === null || introspectionResult === void 0
        ? void 0
        : introspectionResult.errors) === null || _b === void 0
      ? void 0
      : _b.length
  ) {
...
function introspectSchema(executor, context, options) {
  var parsedIntrospectionQuery = graphql.parse(
