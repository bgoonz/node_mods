...
function mergeResolvers(resolversDefinitions, options) {
  ...
  try {
    for (
      var resolversDefinitions_1 = tslib.__values(resolversDefinitions),
        resolversDefinitions_1_1 = resolversDefinitions_1.next();
      !resolversDefinitions_1_1.done;
      resolversDefinitions_1_1 = resolversDefinitions_1.next()
    ) {
    ...
    try {
      if (
        resolversDefinitions_1_1 &&
        !resolversDefinitions_1_1.done &&
        (_a = resolversDefinitions_1.return)
      )
        _a.call(resolversDefinitions_1);
    } finally {
  ...
  if (resolversFactories.length) {
    result = function () {
      ...
      var resultsOfFactories = resolversFactories.map(function (factory) {
        return factory.apply(
          void 0,
          tslib.__spreadArray([], tslib.__read(args))
        );
      });
  ...
  if (options && options.exclusions) {
    try {
      for (
        var _c = tslib.__values(options.exclusions), _d = _c.next();
        !_d.done;
        _d = _c.next()
      ) {
        var exclusion = _d.value;
        var _e = tslib.__read(exclusion.split("."), 2),
          typeName = _e[0],
          fieldName = _e[1];
...
function mergeArguments(args1, args2, config) {
  var result = deduplicateArguments(
    [].concat(args2, args1).filter(function (a) {
      return a;
    })
  );
...
function addDescription(cb) {
  return function (node, _key, _parent, path, ancestors) {
    ...
    var key = tslib
      .__spreadArray(tslib.__spreadArray([], tslib.__read(keys)), [
        parent.name.value,
      ])
      .join(".");
    var items = [];
    if (commentsRegistry[key]) {
      items.push.apply(
        items,
        tslib.__spreadArray([], tslib.__read(commentsRegistry[key]))
      );
    }
    return join(
      tslib.__spreadArray(
        tslib.__spreadArray([], tslib.__read(items.map(printComment))),
        [node.description, cb(node)]
      ),
      "\n"
    );
  };
...
function printWithComments(ast) {
  return graphql.visit(ast, {
    leave: {
      ...
      OperationTypeDefinition: function (node) {
        return node.operation + ": " + node.type;
      },
...
function mergeArguments$1(a1, a2) {
    ...
    if (existingIndex > -1) {
      ...
      if (existingArg.value.kind === "ListValue") {
        ...
        existingArg.value.values = deduplicateLists(
          source,
          target,
          function (targetVal, source) {
            var value = targetVal.value;
            return (
              !value ||
              !source.some(function (sourceVal) {
  ...
  try {
    for (
      var a1_1 = tslib.__values(a1), a1_1_1 = a1_1.next();
      !a1_1_1.done;
      a1_1_1 = a1_1.next()
    ) {
...
function mergeDirectives(d1, d2, config) {
  ...
  var result = deduplicateDirectives(
    tslib.__spreadArray([], tslib.__read(asNext))
  );
  ...
  try {
    for (
      var asFirst_1 = tslib.__values(asFirst), asFirst_1_1 = asFirst_1.next();
      !asFirst_1_1.done;
      asFirst_1_1 = asFirst_1.next()
    ) {
    ...
    try {
      if (asFirst_1_1 && !asFirst_1_1.done && (_a = asFirst_1.return))
        _a.call(asFirst_1);
    } finally {
      if (e_2) throw e_2.error;
    }
...
function validateInputs(node, existingNode) {
  ...
  if (!sameArguments) {
    throw new Error(
      'Unable to merge GraphQL directive "' +
        node.name.value +
        '". \nExisting directive:  \n\t' +
        printedExistingNode +
        " \nReceived directive: \n\t" +
...
function mergeDirective(node, existingNode) {
  if (existingNode) {
    ...
    return tslib.__assign(tslib.__assign({}, node), {
      locations: tslib.__spreadArray(
        tslib.__spreadArray([], tslib.__read(existingNode.locations)),
        tslib.__read(
          node.locations.filter(function (name) {
...
function mergeEnumValues(first, second, config) {
  var e_1, _a, e_2, _b;
  if (
    config === null || config === void 0 ? void 0 : config.consistentEnumMerge
  ) {
    var reversed = first;
    first = second;
    second = reversed;
  ...
  try {
    for (
      var first_1 = tslib.__values(first), first_1_1 = first_1.next();
      !first_1_1.done;
      first_1_1 = first_1.next()
    ) {
    ...
    try {
      if (first_1_1 && !first_1_1.done && (_a = first_1.return))
        _a.call(first_1);
    } finally {
      if (e_1) throw e_1.error;
    }
  ...
  try {
    for (
      var second_1 = tslib.__values(second), second_1_1 = second_1.next();
      !second_1_1.done;
    ...
    try {
      if (second_1_1 && !second_1_1.done && (_b = second_1.return))
        _b.call(second_1);
    } finally {
      if (e_2) throw e_2.error;
    }
...
function mergeEnum(e1, e2, config) {
  ...
  return config && config.convertExtensions
    ? tslib.__assign(tslib.__assign({}, e1), { kind: "EnumTypeDefinition" })
    : e1;
}
    ...
    if (t1.name.value !== t2.name.value) {
      throw new Error(
        'Field "' +
          ...
          '" already defined with a different type. Declared as "' +
          t1.name.value +
          '", but you tried to override with "' +
          t2.name.value +
          '"'
      );
    }
...
function mergeFields(type, f1, f2, config) {
  ...
  var _loop_1 = function (field) {
    if (fieldAlreadyExists(result, field, config)) {
      ...
      if (
        ...
        if (
          config === null || config === void 0 ? void 0 : config.throwOnConflict
        ) {
  ...
  try {
    for (
      var f1_1 = tslib.__values(f1), f1_1_1 = f1_1.next();
      !f1_1_1.done;
      f1_1_1 = f1_1.next()
    ) {
  ...
  if (config && config.exclusions) {
    return result.filter(function (field) {
      return !config.exclusions.includes(
...
function mergeInputType(node, existingNode, config) {
  if (existingNode) {
    try {
      ...
      throw new Error(
        'Unable to merge GraphQL input type "' +
          node.name.value +
          '": ' +
          e.message
      );
...
function mergeInterface(node, existingNode, config) {
  if (existingNode) {
    try {
      ...
      throw new Error(
        'Unable to merge GraphQL interface "' +
          node.name.value +
          '": ' +
          e.message
      );
...
function mergeNamedTypeArray(first, second, config) {
  ...
  var result = tslib.__spreadArray(
    tslib.__spreadArray([], tslib.__read(second)),
    tslib.__read(
      first.filter(function (d) {
...
function mergeType(node, existingNode, config) {
  ...
  return config && config.convertExtensions
    ? tslib.__assign(tslib.__assign({}, node), { kind: "ObjectTypeDefinition" })
    : node;
}
...
function mergeScalar(node, existingNode, config) {
  ...
  return config && config.convertExtensions
    ? tslib.__assign(tslib.__assign({}, node), { kind: "ScalarTypeDefinition" })
    : node;
}
...
function mergeUnion(first, second, config) {
  ...
  return config && config.convertExtensions
    ? tslib.__assign(tslib.__assign({}, first), { kind: "UnionTypeDefinition" })
    : first;
}
...
function mergeSchemaDefs(node, existingNode, config) {
  ...
  return (
    config === null || config === void 0 ? void 0 : config.convertExtensions
  )
    ? tslib.__assign(tslib.__assign({}, node), {
...
function mergeGraphQLNodes(nodes, config) {
  ...
  try {
    for (
      var nodes_1 = tslib.__values(nodes), nodes_1_1 = nodes_1.next();
      !nodes_1_1.done;
      ...
      if (isNamedDefinitionNode(nodeDefinition)) {
        ...
        if (
          ...
          ((_c =
            config === null || config === void 0
              ? void 0
              : config.exclusions) === null || _c === void 0
            ? void 0
            : _c.includes(name_1))
        ) {
          ...
          switch (nodeDefinition.kind) {
            ...
            case graphql.Kind.OBJECT_TYPE_EXTENSION:
              mergedResultMap[name_1] = mergeType(
                nodeDefinition,
                mergedResultMap[name_1],
                config
              );
              break;
            case graphql.Kind.ENUM_TYPE_DEFINITION:
            case graphql.Kind.ENUM_TYPE_EXTENSION:
              mergedResultMap[name_1] = mergeEnum(
                nodeDefinition,
                mergedResultMap[name_1],
                config
              );
            ...
            case graphql.Kind.UNION_TYPE_EXTENSION:
              mergedResultMap[name_1] = mergeUnion(
                nodeDefinition,
                mergedResultMap[name_1],
                config
              );
            ...
            case graphql.Kind.SCALAR_TYPE_EXTENSION:
              mergedResultMap[name_1] = mergeScalar(
                nodeDefinition,
                mergedResultMap[name_1],
                config
              );
            ...
            case graphql.Kind.INPUT_OBJECT_TYPE_EXTENSION:
              mergedResultMap[name_1] = mergeInputType(
                nodeDefinition,
                mergedResultMap[name_1],
                config
              );
            ...
            case graphql.Kind.INTERFACE_TYPE_EXTENSION:
              mergedResultMap[name_1] = mergeInterface(
                nodeDefinition,
                mergedResultMap[name_1],
                config
              );
            ...
            case graphql.Kind.DIRECTIVE_DEFINITION:
              mergedResultMap[name_1] = mergeDirective(
                nodeDefinition,
                mergedResultMap[name_1]
              );
              break;
...
function visitTypeSources(types, allNodes) {
  ...
  try {
    for (
      var types_1 = tslib.__values(types), types_1_1 = types_1.next();
      !types_1_1.done;
...
function mergeGraphQLTypes(types, config) {
  ...
  if (
    config === null || config === void 0 ? void 0 : config.useSchemaDefinition
  ) {
  ...
  if (config === null || config === void 0 ? void 0 : config.sort) {
    var sortFn_1 =
      typeof config.sort === "function" ? config.sort : defaultStringComparator;
...
function travelSchemaPossibleExtensions(schema, hooks) {
  ...
  try {
    for (
      var _h = tslib.__values(Object.entries(typesMap)), _j = _h.next();
      !_j.done;
      _j = _h.next()
    ) {
      var _k = tslib.__read(_j.value, 2),
        type = _k[1];
      var isPredefinedScalar =
      ...
      if (graphql.isObjectType(type)) {
        ...
        try {
          for (
            var _l = ((e_2 = void 0), tslib.__values(Object.entries(fields))),
              _m = _l.next();
            !_m.done;
            _m = _l.next()
          ) {
            var _o = tslib.__read(_m.value, 2),
              field = _o[1];
            hooks.onObjectField(type, field);
            var args = field.args || [];
            try {
              for (
                var args_1 = ((e_3 = void 0), tslib.__values(args)),
              ...
              try {
                if (args_1_1 && !args_1_1.done && (_c = args_1.return))
                  _c.call(args_1);
              } finally {
        ...
        try {
          for (
            var _p = ((e_4 = void 0), tslib.__values(Object.entries(fields))),
              _q = _p.next();
            !_q.done;
            _q = _p.next()
          ) {
            var _r = tslib.__read(_q.value, 2),
              field = _r[1];
            hooks.onInterfaceField(type, field);
            var args = field.args || [];
            try {
              for (
                var args_2 = ((e_5 = void 0), tslib.__values(args)),
              ...
              try {
                if (args_2_1 && !args_2_1.done && (_e = args_2.return))
                  _e.call(args_2);
              } finally {
        ...
        try {
          for (
            var _s = ((e_6 = void 0), tslib.__values(Object.entries(fields))),
              _t = _s.next();
            !_t.done;
            _t = _s.next()
          ) {
            var _u = tslib.__read(_t.value, 2),
              field = _u[1];
        ...
        try {
          for (
            var _v = ((e_7 = void 0), tslib.__values(type.getValues())),
              _w = _v.next();
            !_w.done;
            _w = _v.next()
          ) {
...
function mergeExtensions(extensions) {
  return extensions.reduce(function (result, extensionObj) {
    return [result, extensionObj].reduce(utils.mergeDeep, {});
  }, {});
}
...
function applyExtensions(schema, extensions) {
  ...
  try {
    for (
      var _f = tslib.__values(Object.entries(extensions.types || {})),
        _g = _f.next();
      !_g.done;
      _g = _f.next()
    ) {
      ...
      if (type) {
        ...
        if (data.type === "object" || data.type === "interface") {
          try {
            for (
              var _j =
                  ((e_9 = void 0), tslib.__values(Object.entries(data.fields))),
                _k = _j.next();
              !_k.done;
              _k = _j.next()
            ) {
              var _l = tslib.__read(_k.value, 2),
                fieldName = _l[0],
                fieldData = _l[1];
              ...
              if (field) {
                ...
                try {
                  for (
                    var _m =
                        ((e_10 = void 0),
                        tslib.__values(Object.entries(fieldData.arguments))),
                      _o = _m.next();
                    !_o.done;
                    _o = _m.next()
                  ) {
                    var _p = tslib.__read(_o.value, 2),
                      arg = _p[0],
                      argData = _p[1];
                    _loop_1(arg, argData);
                  }
          ...
          try {
            for (
              var _q =
                  ((e_11 = void 0),
                  tslib.__values(Object.entries(data.fields))),
                _r = _q.next();
              !_r.done;
              _r = _q.next()
            ) {
              var _s = tslib.__read(_r.value, 2),
                fieldName = _s[0],
                fieldData = _s[1];
              var field = type.getFields()[fieldName];
              applyExtensionObject(field, fieldData.extensions);
          ...
          try {
            for (
              var _t =
                  ((e_12 = void 0),
                  tslib.__values(Object.entries(data.values))),
                _u = _t.next();
              !_u.done;
              _u = _t.next()
            ) {
              var _v = tslib.__read(_u.value, 2),
                valueName = _v[0],
                valueData = _v[1];
...
function extractExtensionsFromSchema(schema) {
  ...
  travelSchemaPossibleExtensions(schema, {
    onSchema: function (schema) {
      return (result.schemaExtensions = schema.extensions || {});
    },
    onObjectType: function (type) {
    ...
    onEnumValue: function (type, value) {
      return (result.types[type.name].values[value.name] =
        value.extensions || {});
    },
    onScalar: function (type) {
      return (result.types[type.name] = {
        type: "scalar",
        extensions: type.extensions || {},
      });
    },
    onUnion: function (type) {
      return (result.types[type.name] = {
        type: "union",
        extensions: type.extensions || {},
      });
    },
    onInputType: function (type) {
      return (result.types[type.name] = {
        fields: {},
        type: "input",
        extensions: type.extensions || {},
...
function mergeSchemas(config) {
  ...
  try {
    for (
      var _b = tslib.__values(config.schemas), _c = _b.next();
      !_c.done;
      _c = _b.next()
    ) {
      var schema = _c.value;
  ...
  extractedResolvers.push.apply(
    extractedResolvers,
    tslib.__spreadArray([], tslib.__read(ensureResolvers(config)))
  );
  var resolvers = mergeResolvers(extractedResolvers, config);
  var extensions = mergeExtensions(extractedExtensions);
  return makeSchema(
    { resolvers: resolvers, typeDefs: typeDefs, extensions: extensions },
    config
  );
}
/**
  ...
  return tslib.__awaiter(this, void 0, void 0, function () {
    ...
    return tslib.__generator(this, function (_b) {
      switch (_b.label) {
            ...
            Promise.all([
              ...
              Promise.all(
                ...
                return mergeResolvers(
                  tslib.__spreadArray(
                    tslib.__spreadArray([], tslib.__read(extractedResolvers)),
                    tslib.__read(ensureResolvers(config))
                  ),
                  config
                );
              }),
        ...
        case 1:
          (_a = tslib.__read.apply(void 0, [_b.sent(), 3])),
            (typeDefs = _a[0]),
            (resolvers = _a[1]),
            (extensions = _a[2]);
          return [
...
function mergeTypes(_a) {
  var schemas = _a.schemas,
    ...
    config = tslib.__rest(_a, ["schemas", "typeDefs"]);
  return mergeTypeDefs(
    tslib.__spreadArray(
      tslib.__spreadArray([], tslib.__read(schemas)),
      tslib.__read(typeDefs ? utils.asArray(typeDefs) : [])
    ),
    config
  );
}
...
function makeSchema(_a, config) {
  ...
  if (resolvers) {
    schema$1 = schema.addResolversToSchema({
      schema: schema$1,
      resolvers: resolvers,
      resolverValidationOptions: tslib.__assign(
        tslib.__assign({}, defaultResolverValidationOptions),
