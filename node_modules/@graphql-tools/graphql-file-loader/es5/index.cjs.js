...
var GraphQLFileLoader = /** @class */ (function () {
      ...
      return tslib.__generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            if (
              !FILE_EXTENSIONS.find(function (extension) {
                return pointer.endsWith(extension);
              })
            )
              return [3 /*break*/, 4];
            normalizedFilePath = path.isAbsolute(pointer)
              ? pointer
              : path.resolve(options.cwd || process.cwd(), pointer);
            _b.label = 1;
          case 1:
            _b.trys.push([1, 3, , 4]);
  ...
  GraphQLFileLoader.prototype.canLoadSync = function (pointer, options) {
    if (utils.isValidPath(pointer)) {
      if (
        ...
        var normalizedFilePath = path.isAbsolute(pointer)
          ? pointer
          : path.resolve(options.cwd || process.cwd(), pointer);
        try {
      ...
      return tslib.__generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              readFile(normalizedFilePath, { encoding: "utf8" }),
            ];
          case 1:
            rawSDL = _a.sent();
            return [
              2 /*return*/,
              this.handleFileContent(rawSDL, pointer, options),
            ];
        }
      });
    });
  ...
  GraphQLFileLoader.prototype.handleFileContent = function (
    rawSDL,
    pointer,
    options
  ) {
