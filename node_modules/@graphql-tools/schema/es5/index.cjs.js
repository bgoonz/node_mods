...
function addSchemaLevelResolver(schema, fn) {
  ...
  return utils.mapSchema(
    schema,
    ((_a = {}),
    (_a[utils.MapperKind.ROOT_FIELD] = function (
      fieldConfig,
      _fieldName,
      typeName,
      schema
      ...
      if (subscription != null && subscription.name === typeName) {
        return tslib.__assign(tslib.__assign({}, fieldConfig), {
...
function wrapResolver(innerResolver, outerResolver) {
  return function (obj, args, ctx, info) {
    return new valueOrPromise.ValueOrPromise(function () {
      return outerResolver(obj, args, ctx, info);
    })
      .then(function (root) {
...
function assertResolversPresent(schema, resolverValidationOptions) {
  ...
  var requireResolversForArgs =
      resolverValidationOptions.requireResolversForArgs,
    requireResolversForNonScalar =
      resolverValidationOptions.requireResolversForNonScalar,
    requireResolversForAllFields =
      resolverValidationOptions.requireResolversForAllFields;
  if (
    requireResolversForAllFields &&
...
function attachDirectiveResolvers(schema, directiveResolvers) {
  ...
  if (typeof directiveResolvers !== "object") {
    throw new Error(
      "Expected directiveResolvers to be of type object, got " +
        typeof directiveResolvers
    );
  }
    ...
    (_a[utils.MapperKind.OBJECT_FIELD] = function (fieldConfig) {
      ...
      Object.keys(directives).forEach(function (directiveName) {
        if (directiveResolvers[directiveName]) {
          ...
          newFieldConfig.resolve = function (
            source,
            originalArgs,
            context,
            info
...
function filterAndExtractExtensionDefinitions(ast) {
  ...
  return {
    typesAst: tslib.__assign(tslib.__assign({}, ast), {
      definitions: typesDefs,
    }),
    extensionsAst: tslib.__assign(tslib.__assign({}, ast), {
...
function concatenateTypeDefs(typeDefinitionsAry, calledFunctionRefs) {
  ...
  typeDefinitionsAry.forEach(function (typeDef) {
    if (typeof typeDef === "function") {
      ...
      throw new Error(
        "typeDef array must contain only strings, documents, or functions, got " +
          type
      );
    }
  });
  return tslib
    .__spreadArray([], tslib.__read(resolvedTypeDefinitions))
    .join("\n");
}
...
function buildSchemaFromTypeDefinitions(
  ...
  var document = buildDocumentFromTypeDefinitions(
    typeDefinitions,
    parseOptions
  );
  ...
  var _a = filterAndExtractExtensionDefinitions(document),
    typesAst = _a.typesAst,
    extensionsAst = _a.extensionsAst;
    ...
    (_a[utils.MapperKind.ABSTRACT_TYPE] = function (type) {
      if (!type.resolveType) {
        var message =
          'Type "' +
          type.name +
          '" is missing a "__resolveType" resolver. Pass \'ignore\' into ' +
...
function extendResolversFromInterfaces(schema, resolvers) {
  var typeNames = Object.keys(
    tslib.__assign(tslib.__assign({}, schema.getTypeMap()), resolvers)
  );
  ...
  typeNames.forEach(function (typeName) {
    ...
    if (type && "getInterfaces" in type) {
      var allInterfaceResolvers = type
        ...
        .filter(function (interfaceResolvers) {
          return interfaceResolvers != null;
        });
      ...
      extendedResolvers[typeName] = tslib.__assign(
        tslib.__assign({}, extendedResolvers[typeName]),
        typeResolvers
      );
    } else {
      var typeResolvers = resolvers[typeName];
...
function addResolversToSchema(
  ...
  var schema = options.schema,
    ...
    _c = options.updateResolversInPlace,
    updateResolversInPlace = _c === void 0 ? false : _c;
  var _d = resolverValidationOptions.requireResolversToMatchSchema,
    requireResolversToMatchSchema = _d === void 0 ? "error" : _d,
          ...
          if (
            ...
            throw new Error(
              type_1.name +
                "." +
                fieldName +
                " was defined in resolvers, but not present within " +
                type_1.name
            );
          }
        });
          ...
          if (
            ...
            throw new Error(
              type_1.name +
                "." +
                fieldName +
                " was defined in resolvers, but " +
                type_1.name +
                " is not an object or interface type"
            );
          }
        });
      } else if (
        graphql.isObjectType(type_1) ||
        graphql.isInterfaceType(type_1)
      ) {
        Object.keys(resolverValue).forEach(function (fieldName) {
          if (!fieldName.startsWith("__")) {
            ...
            if (
              ...
              throw new Error(
                typeName +
                  "." +
                  fieldName +
                  " defined in resolvers, but not in schema"
              );
            }
  ...
  Object.keys(resolvers).forEach(function (typeName) {
    if (typeName !== "__schema") {
      ...
      if (graphql.isScalarType(type_2)) {
        Object.keys(resolverValue_1).forEach(function (fieldName) {
          ...
          if (fieldName.startsWith("__")) {
            ...
            type_2.astNode = tslib.__assign(
              tslib.__assign({}, type_2.astNode),
              {
                description:
                  (_c =
                    (_b =
                      (_a = resolverValue_1) === null || _a === void 0
                        ? void 0
                        : _a.astNode) === null || _b === void 0
                      ? void 0
                      : _b.description) !== null && _c !== void 0
                    ? _c
                    : type_2.astNode.description,
                directives: ((_d = type_2.astNode.directives) !== null &&
                _d !== void 0
                  ? _d
                  : []
                ).concat(
                  (_g =
                    (_f =
                      (_e = resolverValue_1) === null || _e === void 0
                        ? void 0
            ...
            type_2.extensionASTNodes != null
          ) {
            type_2.extensionASTNodes = (
              (_h = []) !== null && _h !== void 0
                ? _h
                : type_2.extensionASTNodes
            ).concat(
              (_k =
                (_j = resolverValue_1) === null || _j === void 0
                  ? void 0
            ...
            type_2.extensions = Object.assign(
              {},
              type_2.extensions,
              resolverValue_1.extensions
            );
          } else {
        ...
        Object.keys(resolverValue_1).forEach(function (fieldName) {
          ...
          if (fieldName.startsWith("__")) {
            ...
            config_1.astNode = tslib.__assign(
              tslib.__assign({}, config_1.astNode),
              {
                description:
                  (_c =
                    (_b =
                      ...
                      : _b.description) !== null && _c !== void 0
                    ? _c
                    : config_1.astNode.description,
                directives: ((_d = config_1.astNode.directives) !== null &&
                _d !== void 0
                  ? _d
                  : []
                ).concat(
            ...
            fieldName === "extensionASTNodes" &&
            config_1.extensionASTNodes != null
          ) {
            config_1.extensionASTNodes = config_1.extensionASTNodes.concat(
              (_j =
                (_h = resolverValue_1) === null || _h === void 0
                  ? void 0
        ...
        graphql.isObjectType(type_2) ||
        graphql.isInterfaceType(type_2)
      ) {
        Object.keys(resolverValue_1).forEach(function (fieldName) {
          if (fieldName.startsWith("__")) {
...
function addErrorLoggingToSchema(schema, logger) {
  ...
  return utils.mapSchema(
    schema,
    ((_a = {}),
    (_a[utils.MapperKind.OBJECT_FIELD] = function (
      fieldConfig,
      fieldName,
      typeName
    ) {
...
function makeExecutableSchema(_a) {
  var typeDefs = _a.typeDefs,
    ...
    userProvidedSchemaTransforms = _a.schemaTransforms,
    _e = _a.parseOptions,
    parseOptions = _e === void 0 ? {} : _e,
    _f = _a.inheritResolversFromInterfaces,
    inheritResolversFromInterfaces = _f === void 0 ? false : _f,
    pruningOptions = _a.pruningOptions,
    _g = _a.updateResolversInPlace,
    updateResolversInPlace = _g === void 0 ? false : _g,
    _h = _a.noExtensionExtraction,
    noExtensionExtraction = _h === void 0 ? false : _h;
  ...
  if (logger != null) {
    schemaTransforms.push(function (schema) {
      return addErrorLoggingToSchema(schema, logger);
    });
  }
  ...
  if (userProvidedSchemaTransforms) {
    schemaTransforms.push(function (schema) {
      return userProvidedSchemaTransforms.reduce(function (s, schemaTransform) {
        return schemaTransform(s);
      }, schema);
    });
  }
  ...
  if (directiveResolvers != null) {
    schemaTransforms.push(function (schema) {
      return attachDirectiveResolvers(schema, directiveResolvers);
    });
  }
  ...
  var schemaFromTypeDefs = buildSchemaFromTypeDefinitions(
    typeDefs,
    parseOptions,
    noExtensionExtraction
  );
  return schemaTransforms.reduce(function (schema, schemaTransform) {
    return schemaTransform(schema);
  }, schemaFromTypeDefs);
}
...
exports.filterAndExtractExtensionDefinitions =
