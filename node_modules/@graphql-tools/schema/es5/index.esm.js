...
function addSchemaLevelResolver(schema, fn) {
  ...
  return mapSchema(
    schema,
    ((_a = {}),
    (_a[MapperKind.ROOT_FIELD] = function (
      fieldConfig,
      _fieldName,
      typeName,
      schema
      ...
      if (subscription != null && subscription.name === typeName) {
        return __assign(__assign({}, fieldConfig), {
...
function filterAndExtractExtensionDefinitions(ast) {
  ...
  return {
    typesAst: __assign(__assign({}, ast), { definitions: typesDefs }),
    extensionsAst: __assign(__assign({}, ast), { definitions: extensionDefs }),
  };
}
...
function concatenateTypeDefs(typeDefinitionsAry, calledFunctionRefs) {
  ...
  return __spreadArray([], __read(resolvedTypeDefinitions)).join("\n");
}
...
function extendResolversFromInterfaces(schema, resolvers) {
  var typeNames = Object.keys(
    __assign(__assign({}, schema.getTypeMap()), resolvers)
  );
  ...
  typeNames.forEach(function (typeName) {
    ...
    if (type && "getInterfaces" in type) {
      ...
      extendedResolvers[typeName] = __assign(
        __assign({}, extendedResolvers[typeName]),
        typeResolvers
      );
    } else {
      var typeResolvers = resolvers[typeName];
      ...
      if (isScalarType(type_2)) {
        Object.keys(resolverValue_1).forEach(function (fieldName) {
          ...
          if (fieldName.startsWith("__")) {
            ...
            type_2.astNode = __assign(__assign({}, type_2.astNode), {
              description:
                (_c =
                  (_b =
        ...
        Object.keys(resolverValue_1).forEach(function (fieldName) {
          ...
          if (fieldName.startsWith("__")) {
            ...
            config_1.astNode = __assign(__assign({}, config_1.astNode), {
              description:
                (_c =
                  (_b =
                    (_a = resolverValue_1) === null || _a === void 0
