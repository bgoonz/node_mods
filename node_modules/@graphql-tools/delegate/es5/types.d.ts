...
export declare type SchemaTransform = (
  originalWrappingSchema: GraphQLSchema,
  subschemaConfig: SubschemaConfig,
  transformedSchema?: GraphQLSchema
) => GraphQLSchema;
export declare type RequestTransform<T = Record<string, any>> = (
  originalRequest: Request,
  delegationContext: DelegationContext,
  transformationContext: T
) => Request;
export declare type ResultTransform<T = Record<string, any>> = (
...
export declare type DelegationBinding = (
  delegationContext: DelegationContext
) => Array<Transform>;
...
export declare type CreateProxyingResolverFn<TContext = Record<string, any>> = (
...
export interface MergedTypeEntryPoint<
  K = any,
  V = any,
  TContext = Record<string, any>
...
export declare type MergedTypeResolver<TContext = Record<string, any>> = (
  originalResult: any,
  context: TContext,
  info: GraphQLResolveInfo,
