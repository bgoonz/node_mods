...
export declare type ResultVisitorMap = Record<
  string,
  ValueVisitor | ObjectValueVisitor
>;
export declare type ErrorVisitor = (
  error: GraphQLError,
  pathIndex: number
) => GraphQLError;
...
export declare function visitData(
  data: any,
  enter?: ValueVisitor,
  leave?: ValueVisitor
): any;
export declare function visitErrors(
  errors: ReadonlyArray<GraphQLError>,
  visitor: (error: GraphQLError) => GraphQLError
): Array<GraphQLError>;
export declare function visitResult(
