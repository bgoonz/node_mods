...
var fixWindowsPath = function (path) {
...
function formatObjectValue(value, previouslySeenValues) {
  ...
  var seenValues = tslib.__spreadArray(
    tslib.__spreadArray([], tslib.__read(previouslySeenValues)),
    [value]
  );
...
function getArgumentValues(def, node, variableValues) {
  ...
  var argNodeMap = argumentNodes.reduce(function (prev, arg) {
    ...
    return tslib.__assign(
      tslib.__assign({}, prev),
      ((_a = {}), (_a[arg.name.value] = arg), _a)
    );
  }, {});
  try {
    for (
      var _c = tslib.__values(def.args), _d = _c.next();
      !_d.done;
      _d = _c.next()
    ) {
      var argDef = _d.value;
      ...
      var coercedValue = graphql.valueFromAST(
        valueNode,
        argType,
        variableValues
      );
...
function getDirectivesInExtensions(node, pathToDirectivesInExtensions) {
  ...
  var directivesInExtensions = pathToDirectivesInExtensions.reduce(
...
function getDirectives(schema, node, pathToDirectivesInExtensions) {
  ...
  var directivesInExtensions = getDirectivesInExtensions(
    node,
  ...
  var schemaDirectiveMap = schemaDirectives.reduce(function (
    schemaDirectiveMap,
    schemaDirective
  ) {
  ...
  if ("extensionASTNodes" in node && node.extensionASTNodes) {
    astNodes = tslib.__spreadArray(
      tslib.__spreadArray([], tslib.__read(astNodes)),
      tslib.__read(node.extensionASTNodes)
    );
  }
  var result = {};
        ...
        if (schemaDirective) {
          if (schemaDirective.isRepeatable) {
            result[schemaDirective.name] =
              (_a = result[schemaDirective.name]) !== null && _a !== void 0
                ? _a
                : [];
  ...
  switch (value.kind) {
    ...
    case graphql.Kind.OBJECT:
      return value.fields.reduce(function (prev, v) {
        ...
        return tslib.__assign(
          tslib.__assign({}, prev),
          ((_a = {}), (_a[v.name.value] = parseDirectiveValue(v.value)), _a)
        );
      }, {});
...
function getFieldsWithDirectives(documentNode, options) {
  ...
  if (options.includeInputTypes) {
    selected = tslib.__spreadArray(
      tslib.__spreadArray([], tslib.__read(selected)),
  ...
  try {
    for (
      var allTypes_1 = tslib.__values(allTypes),
        allTypes_1_1 = allTypes_1.next();
      !allTypes_1_1.done;
      allTypes_1_1 = allTypes_1.next()
    ) {
      ...
      try {
        for (
          var _c = ((e_2 = void 0), tslib.__values(type.fields)),
            _d = _c.next();
          !_d.done;
          _d = _c.next()
        ) {
              ...
              return {
                ...
                args: (d.arguments || []).reduce(function (prev, arg) {
                  ...
                  return tslib.__assign(
                    tslib.__assign({}, prev),
                    ((_a = {}),
                    (_a[arg.name.value] = parseDirectiveValue(arg.value)),
                    _a)
                  );
                }, {}),
              };
    ...
    try {
      if (allTypes_1_1 && !allTypes_1_1.done && (_a = allTypes_1.return))
        _a.call(allTypes_1);
    } finally {
      if (e_1) throw e_1.error;
    }
...
function getImplementingTypes(interfaceName, schema) {
  ...
  for (var graphqlTypeName in allTypesMap) {
    ...
    if (graphql.isObjectType(graphqlType)) {
      ...
      if (
        allInterfaces.find(function (int) {
...
function getDocumentNodeFromSchema(schema, options) {
  ...
  try {
    for (
      var directives_1 = tslib.__values(directives),
        directives_1_1 = directives_1.next();
      !directives_1_1.done;
      directives_1_1 = directives_1.next()
    ) {
    ...
    try {
      if (directives_1_1 && !directives_1_1.done && (_a = directives_1.return))
        _a.call(directives_1);
    } finally {
      if (e_1) throw e_1.error;
    }
  }
...
function astFromSchema(schema, pathToDirectivesInExtensions) {
  ...
  nodes.forEach(function (node) {
    if (node.operationTypes) {
      node.operationTypes.forEach(function (operationTypeDefinitionNode) {
        operationTypeMap[operationTypeDefinitionNode.operation] =
  ...
  var operationTypes = Object.values(operationTypeMap).filter(function (
    operationTypeDefinitionNode
  ) {
    return operationTypeDefinitionNode != null;
  });
  var directives = getDirectiveNodes(
    schema,
    schema,
    pathToDirectivesInExtensions
  );
...
function astFromDirective(directive, schema, pathToDirectivesInExtensions) {
  ...
  return {
    ...
    arguments: (
      directive === null || directive === void 0 ? void 0 : directive.args
    )
    ...
    locations: (
      directive === null || directive === void 0 ? void 0 : directive.locations
    )
      ? directive.locations.map(function (location) {
          return {
            kind: graphql.Kind.NAME,
            value: location,
          };
...
function getDeprecatableDirectiveNodes(
  ...
  if (directivesInExtensions != null) {
    ...
    directives =
      (_a = entity.astNode) === null || _a === void 0 ? void 0 : _a.directives;
  }
  if (directives != null) {
    ...
    if (entity.deprecationReason != null) {
      deprecatedDirectiveNode =
        (_b = directives.filter(function (directive) {
          return directive.name.value === "deprecated";
        })) === null || _b === void 0
          ? void 0
          : _b[0];
...
function astFromScalarType(type, schema, pathToDirectivesInExtensions) {
  ...
  if (allDirectives != null) {
    directiveNodesBesidesSpecifiedBy = allDirectives.filter(function (
      directive
    ) {
      return directive.name.value !== "specifiedBy";
    });
    if (type.specifiedByUrl != null) {
      specifiedByDirectiveNode =
        (_b = allDirectives.filter(function (directive) {
          return directive.name.value === "specifiedBy";
        })) === null || _b === void 0
          ? void 0
          : _b[0];
        ...
        case 0:
          ...
          documentFiles.forEach(function (documentFile) {
            ...
            if (documentFile.document) {
              try {
                for (
                  var _b = tslib.__values(documentFile.document.definitions),
                    _c = _b.next();
                  !_c.done;
                  _c = _b.next()
                ) {
          ...
          return [
            4 /*yield*/,
            Promise.all(
              documentFiles.map(function (documentFile) {
                return tslib.__awaiter(_this, void 0, void 0, function () {
                  ...
                  return tslib.__generator(this, function (_a) {
                    documentToValidate = {
                      ...
                      definitions: tslib
                        .__spreadArray(
                          tslib.__spreadArray([], tslib.__read(allFragments)),
                          tslib.__read(documentFile.document.definitions)
                        )
                        .filter(function (definition, index, list) {
                          if (
                            definition.kind === graphql.Kind.FRAGMENT_DEFINITION
                          ) {
                            var firstIndex = list.findIndex(function (def) {
                              return (
  ...
  if (loadDocumentErrors.length > 0) {
    ...
    var _loop_1 = function (loadDocumentError) {
      ...
      var _loop_2 = function (graphQLError) {
        ...
        graphQLError.locations.forEach(function (location) {
          return (error.stack +=
            "\n    at " +
      ...
      try {
        for (
          var _c = ((e_3 = void 0), tslib.__values(loadDocumentError.errors)),
            _d = _c.next();
          !_d.done;
          _d = _c.next()
        ) {
    ...
    try {
      for (
        var loadDocumentErrors_1 = tslib.__values(loadDocumentErrors),
          loadDocumentErrors_1_1 = loadDocumentErrors_1.next();
        !loadDocumentErrors_1_1.done;
        loadDocumentErrors_1_1 = loadDocumentErrors_1.next()
      ) {
      ...
      try {
        if (
          loadDocumentErrors_1_1 &&
          !loadDocumentErrors_1_1.done &&
          (_a = loadDocumentErrors_1.return)
        )
          _a.call(loadDocumentErrors_1);
      } finally {
        if (e_2) throw e_2.error;
      }
    }
...
function createDefaultRules() {
  ...
  return graphql.specifiedRules.filter(function (f) {
...
function buildFixedSchema(schema, options) {
  return graphql.buildSchema(
    ...
    tslib.__assign({ noLocation: true }, options || {})
  );
}
...
function transformCommentsToDescriptions(sourceSdl, options) {
  ...
  var parsedDoc = graphql.parse(
    sourceSdl,
    tslib.__assign(tslib.__assign({}, options), { noLocation: false })
  );
      ...
      if (isDescribable(node)) {
        ...
        if (rawValue !== undefined) {
          ...
          if (!node.description) {
            ...
            return tslib.__assign(tslib.__assign({}, node), {
              description: tslib.__assign(
                tslib.__assign({}, node.description),
                {
...
function createSchemaDefinition(def, config) {
  ...
  var fields = Object.keys(schemaRoot)
    .map(function (rootType) {
      return schemaRoot[rootType]
...
function buildOperationNodeForField(_a) {
  var schema = _a.schema,
    ...
    models = _a.models,
    ignore = _a.ignore,
    depthLimit = _a.depthLimit,
    circularReferenceDepth = _a.circularReferenceDepth,
    argNames = _a.argNames,
    _b = _a.selectedFields,
    selectedFields = _b === void 0 ? true : _b;
  ...
  // attach variables
  operationNode.variableDefinitions = tslib.__spreadArray(
    [],
    tslib.__read(operationVariables)
  );
  resetOperationVariables();
  resetFieldMap();
...
function buildOperationAndCollectVariables(_a) {
  var schema = _a.schema,
    ...
    circularReferenceDepth = _a.circularReferenceDepth,
    argNames = _a.argNames,
    selectedFields = _a.selectedFields;
  var typeMap = {
    query: schema.getQueryType(),
    mutation: schema.getMutationType(),
    subscription: schema.getSubscriptionType(),
...
function resolveSelectionSet(_a) {
      ...
      selections: types
        .filter(function (t) {
          return !hasCircularRef(
            tslib.__spreadArray(
              tslib.__spreadArray([], tslib.__read(ancestors)),
              [t]
            ),
            {
  ...
  if (graphql.isInterfaceType(type)) {
    var types = Object.values(schema.getTypeMap()).filter(function (t) {
      return graphql.isObjectType(t) && t.getInterfaces().includes(type);
    });
    return {
      kind: graphql.Kind.SELECTION_SET,
      selections: types
      ...
      selections: Object.keys(fields_1)
        .filter(function (fieldName) {
          return !hasCircularRef(
            tslib.__spreadArray(
              tslib.__spreadArray([], tslib.__read(ancestors)),
              [graphql.getNamedType(fields_1[fieldName].type)]
            ),
            {
              depth: circularReferenceDepth,
            }
        ...
        .map(function (fieldName) {
          ...
          if (selectedSubFields) {
            return resolveField({
              ...
              models: models,
              path: tslib.__spreadArray(
                tslib.__spreadArray([], tslib.__read(path)),
                [fieldName]
              ),
              ancestors: ancestors,
              ignore: ignore,
...
function getArgumentName(name, path) {
  return camelCase.camelCase(
    tslib
      .__spreadArray(tslib.__spreadArray([], tslib.__read(path)), [name])
      .join("_")
  );
}
function resolveField(_a) {
  ...
  var fieldPath = tslib.__spreadArray(
    tslib.__spreadArray([], tslib.__read(path)),
    [field.name]
  );
...
function rewireTypes(originalTypeMap, directives) {
  ...
  function rewireNamedType(type) {
    if (graphql.isObjectType(type)) {
      ...
      var newConfig = tslib.__assign(tslib.__assign({}, config_1), {
        fields: function () {
      ...
      var newConfig = tslib.__assign(tslib.__assign({}, config_2), {
        fields: function () {
      ...
      var newConfig = tslib.__assign(tslib.__assign({}, config_3), {
        types: function () {
      ...
      var newConfig = tslib.__assign(tslib.__assign({}, config_4), {
        fields: function () {
...
function transformInputValue(
  ...
  if (graphql.isLeafType(nullableType)) {
    ...
    Object.keys(value).forEach(function (key) {
      ...
      if (field != null) {
        newValue_1[key] = transformInputValue(
          field.type,
          value[key],
          inputLeafValueTransformer,
          inputObjectValueTransformer
    ...
    return inputObjectValueTransformer != null
      ? inputObjectValueTransformer(nullableType, newValue_1)
      : newValue_1;
  }
...
function mapSchema(schema, schemaMapper) {
  ...
  var newTypeMap = mapDefaultValues(
    originalTypeMap,
    schema,
    serializeInputValue
  );
  newTypeMap = mapTypes(newTypeMap, schema, schemaMapper, function (type) {
  ...
  return new graphql.GraphQLSchema(
    tslib.__assign(tslib.__assign({}, schema.toConfig()), {
  ...
  return mapTypes(
    ...
    (_a[exports.MapperKind.ENUM_TYPE] = function (type) {
      ...
      Object.keys(originalEnumValueConfigMap).forEach(function (externalValue) {
        ...
        var mappedEnumValue = enumValueMapper(
        ...
        if (mappedEnumValue === undefined) {
          ...
          var _a = tslib.__read(mappedEnumValue, 2),
            newExternalValue = _a[0],
            newEnumValueConfig = _a[1];
    ...
    _a),
    function (type) {
      return graphql.isEnumType(type);
    }
  );
}
function mapDefaultValues(originalTypeMap, schema, fn) {
  var _a, _b;
  var newTypeMap = mapArguments(
    originalTypeMap,
    schema,
    ((_a = {}),
    (_a[exports.MapperKind.ARGUMENT] = function (argumentConfig) {
      ...
      if (maybeNewType != null) {
        return tslib.__assign(tslib.__assign({}, argumentConfig), {
  ...
  return mapFields(
    ...
    (_b[exports.MapperKind.INPUT_OBJECT_FIELD] = function (inputFieldConfig) {
      ...
      if (maybeNewType != null) {
        return tslib.__assign(tslib.__assign({}, inputFieldConfig), {
    ...
    if (!typeName.startsWith("__")) {
      ...
      Object.keys(originalFieldConfigMap_1).forEach(function (fieldName) {
        ...
        if (mappedField === undefined) {
          ...
          var _a = tslib.__read(mappedField, 2),
            newFieldName = _a[0],
            newFieldConfig = _a[1];
          if (newFieldConfig.astNode != null) {
            newFieldConfig.astNode = tslib.__assign(
              tslib.__assign({}, newFieldConfig.astNode),
              {
                name: tslib.__assign(
                  tslib.__assign({}, newFieldConfig.astNode.name),
                  { value: newFieldName }
                ),
              }
            );
          }
          newFieldConfigMap_1[newFieldName] =
    ...
    if (!typeName.startsWith("__")) {
      ...
      Object.keys(originalFieldConfigMap_2).forEach(function (fieldName) {
        ...
        argumentNames.forEach(function (argumentName) {
          ...
          var mappedArgument = argumentMapper_1(
          ...
          if (mappedArgument === undefined) {
            ...
            var _a = tslib.__read(mappedArgument, 2),
              newArgumentName = _a[0],
              newArgumentConfig = _a[1];
            newArgumentConfigMap[newArgumentName] = newArgumentConfig;
          } else if (mappedArgument !== null) {
            newArgumentConfigMap[argumentName] = mappedArgument;
          }
        });
        newFieldConfigMap_2[fieldName] = tslib.__assign(
          tslib.__assign({}, originalFieldConfig),
...
function correctASTNodes(type) {
  if (graphql.isObjectType(type)) {
    ...
    if (config.astNode != null) {
      ...
      config.astNode = tslib.__assign(tslib.__assign({}, config.astNode), {
        kind: graphql.Kind.OBJECT_TYPE_DEFINITION,
        fields: fields_1,
      });
    }
    ...
    if (config.extensionASTNodes != null) {
      config.extensionASTNodes = config.extensionASTNodes.map(function (node) {
        return tslib.__assign(tslib.__assign({}, node), { values: undefined });
      });
    }
  ...
  var schema = _a.schema,
    ...
    typeFilter =
      _c === void 0
        ...
        : _c,
    _d = _a.fieldFilter,
    fieldFilter = _d === void 0 ? undefined : _d,
    _e = _a.rootFieldFilter,
    rootFieldFilter = _e === void 0 ? undefined : _e,
    _f = _a.objectFieldFilter,
    objectFieldFilter = _f === void 0 ? undefined : _f,
    _g = _a.interfaceFieldFilter,
    interfaceFieldFilter = _g === void 0 ? undefined : _g,
    _h = _a.inputObjectFieldFilter,
    inputObjectFieldFilter = _h === void 0 ? undefined : _h,
    _j = _a.argumentFilter,
    argumentFilter = _j === void 0 ? undefined : _j;
  var filteredSchema = mapSchema(
    schema,
    ((_b = {}),
...
function filterRootFields(type, operation, rootFieldFilter, argumentFilter) {
  if (rootFieldFilter || argumentFilter) {
    ...
    Object.entries(config_1.fields).forEach(function (_a) {
      ...
      if (
        rootFieldFilter &&
        !rootFieldFilter(operation, fieldName, config_1.fields[fieldName])
      ) {
        delete config_1.fields[fieldName];
      } else if (argumentFilter) {
        try {
          for (
            var _d = tslib.__values(Object.keys(field.args)), _e = _d.next();
            !_e.done;
            _e = _d.next()
          ) {
...
function filterElementFields(
  ...
  if (fieldFilter || argumentFilter) {
    ...
    Object.entries(config_2.fields).forEach(function (_a) {
      ...
      if (
        fieldFilter &&
        !fieldFilter(type.name, fieldName, config_2.fields[fieldName])
      ) {
...
function cloneType(type) {
  if (graphql.isObjectType(type)) {
    ...
    var config = type.toConfig();
    var newConfig = tslib.__assign(tslib.__assign({}, config), {
      interfaces: tslib.__spreadArray(
        [],
        tslib.__read(
          (typeof config.interfaces === "function"
            ? config.interfaces()
...
function healTypes(originalTypeMap, directives) {
  ...
  try {
    for (
      var _b = tslib.__values(Object.keys(originalTypeMap)), _c = _b.next();
      !_c.done;
      _c = _b.next()
    ) {
  ...
  function healFields(type) {
    ...
    try {
      for (
        var _b = tslib.__values(Object.entries(fieldMap)), _c = _b.next();
        !_c.done;
        _c = _b.next()
      ) {
...
var SchemaVisitor = /** @class */ (function () {
  ...
  SchemaVisitor.prototype.visitScalar = function (
    _scalar
    // eslint-disable-next-line @typescript-eslint/no-empty-function
  ) {};
  SchemaVisitor.prototype.visitObject = function (
    _object
    // eslint-disable-next-line @typescript-eslint/no-empty-function
  ) {};
  SchemaVisitor.prototype.visitFieldDefinition = function (
    _field,
    _details
    // eslint-disable-next-line @typescript-eslint/no-empty-function
  ) {};
  SchemaVisitor.prototype.visitArgumentDefinition = function (
    _argument,
    _details
    // eslint-disable-next-line @typescript-eslint/no-empty-function
  ) {};
  SchemaVisitor.prototype.visitInterface = function (
    _iface
    // eslint-disable-next-line @typescript-eslint/no-empty-function
  ) {};
  // eslint-disable-next-line @typescript-eslint/no-empty-function
  ...
  SchemaVisitor.prototype.visitEnumValue = function (
    _value,
    _details
    // eslint-disable-next-line @typescript-eslint/no-empty-function
  ) {};
  SchemaVisitor.prototype.visitInputObject = function (
    _object
    // eslint-disable-next-line @typescript-eslint/no-empty-function
  ) {};
  SchemaVisitor.prototype.visitInputFieldDefinition = function (
    _field,
    _details
    // eslint-disable-next-line @typescript-eslint/no-empty-function
  ) {};
...
function visitSchema(
  ...
  function callMethod(methodName, type) {
    ...
    visitors.every(function (visitorOrVisitorDef) {
      ...
      if (isSchemaVisitor(visitorOrVisitorDef)) {
        newType = visitorOrVisitorDef[methodName].apply(
          visitorOrVisitorDef,
          tslib.__spreadArray([finalType], tslib.__read(args))
        );
      } else if (
  ...
  function visit(type) {
    ...
    if (graphql.isInputObjectType(type)) {
      ...
      if (newInputObject != null) {
        ...
        try {
          for (
            var _b = tslib.__values(Object.keys(fieldMap)), _c = _b.next();
            !_c.done;
            _c = _b.next()
          ) {
            var key = _c.value;
    ...
    if (graphql.isEnumType(type)) {
      ...
      if (newEnum_1 != null) {
        ...
        var valuesUpdated = newValues.some(function (value, index) {
          return value !== newEnum_1.getValues()[index];
        });
        if (valuesUpdated) {
          newEnum_1 = new graphql.GraphQLEnumType(
            tslib.__assign(tslib.__assign({}, newEnum_1.toConfig()), {
              values: newValues.reduce(function (prev, value) {
                var _a;
                return tslib.__assign(
                  tslib.__assign({}, prev),
                  ((_a = {}),
  ...
  function visitFields(type) {
    ...
    var _loop_1 = function (key, field) {
      ...
      if (
        (newField === null || newField === void 0 ? void 0 : newField.args) !=
        null
      ) {
...
var SchemaDirectiveVisitor = /** @class */ (function (_super) {
  ...
  SchemaDirectiveVisitor.getDirectiveDeclaration = function (
    directiveName,
    schema
  ) {
  ...
  SchemaDirectiveVisitor.visitSchemaDirectives = function (
    schema,
    ...
    var declaredDirectives = this.getDeclaredDirectives(
      schema,
      directiveVisitors
    );
    // Map from directive names to lists of SchemaDirectiveVisitor instances
    // created while visiting the schema.
    var createdVisitors = Object.keys(directiveVisitors).reduce(function (
      prev,
      item
    ) {
      var _a;
    ...
    {});
    var directiveVisitorMap = Object.entries(directiveVisitors).reduce(
      function (prev, _a) {
        var _b;
        var _c = tslib.__read(_a, 2),
          key = _c[0],
    ...
    function visitorSelector(type, methodName) {
      ...
      if (directivesInExtensions != null) {
        ...
        var directiveNodes_1 =
          (_b =
            (_a = type === null || type === void 0 ? void 0 : type.astNode) ===
              null || _a === void 0
              ? void 0
        ...
        if (extensionASTNodes != null) {
          extensionASTNodes.forEach(function (extensionASTNode) {
            if (extensionASTNode.directives != null) {
              directiveNodes_1 = directiveNodes_1.concat(
  ...
  SchemaDirectiveVisitor.getDeclaredDirectives = function (
    schema,
    directiveVisitors
  ) {
    var declaredDirectives = schema
      .getDirectives()
      .reduce(function (prev, curr) {
        var _a;
        return tslib.__assign(
          tslib.__assign({}, prev),
          ((_a = {}), (_a[curr.name] = curr), _a)
        );
      }, {});
...
function addTypes(schema, newTypesOrDirectives) {
  ...
  var _a = rewireTypes(
      originalTypeMap,
      Object.keys(originalDirectiveMap).map(function (directiveName) {
        return originalDirectiveMap[directiveName];
      })
    ),
    typeMap = _a.typeMap,
    directives = _a.directives;
...
function visitOutputType(visitedTypes, pruningContext, type) {
  ...
  if (graphql.isObjectType(type) || graphql.isInterfaceType(type)) {
    ...
    types.forEach(function (type) {
      return visitOutputType(visitedTypes, pruningContext, type);
    });
  }
}
/**
...
function visitTypes(pruningContext, schema) {
  ...
  rootTypes.forEach(function (rootType) {
    return visitOutputType(visitedTypes, pruningContext, rootType);
  });
...
function mergeDeep(target) {
  ...
  try {
    for (
      var sources_1 = tslib.__values(sources), sources_1_1 = sources_1.next();
      !sources_1_1.done;
...
function renameType(type, newTypeName) {
  if (graphql.isObjectType(type)) {
    return new graphql.GraphQLObjectType(
      tslib.__assign(tslib.__assign({}, type.toConfig()), {
        name: newTypeName,
        astNode:
          type.astNode == null
            ? type.astNode
            : tslib.__assign(tslib.__assign({}, type.astNode), {
                name: tslib.__assign(tslib.__assign({}, type.astNode.name), {
                  value: newTypeName,
                }),
              }),
        extensionASTNodes:
          type.extensionASTNodes == null
            ...
            : type.extensionASTNodes.map(function (node) {
                return tslib.__assign(tslib.__assign({}, node), {
                  name: tslib.__assign(tslib.__assign({}, node.name), {
                    value: newTypeName,
                  }),
                });
              }),
...
function collectFields(
  ...
  try {
    for (
      var _b = tslib.__values(selectionSet.selections), _c = _b.next();
      !_c.done;
      _c = _b.next()
    ) {
...
function shouldIncludeNode(exeContext, node) {
  var skip = graphql.getDirectiveValues(
  ...
  var include = graphql.getDirectiveValues(
...
function doesFragmentConditionMatch(exeContext, fragment, type) {
  ...
  var conditionalType = graphql.typeFromAST(
    exeContext.schema,
    typeConditionNode
  );
...
function visitRoot(
  ...
  var operationRootType = graphql.getOperationRootType(
    exeContext.schema,
    operation
  );
  var collectedFields = collectFields(
    exeContext,
    operationRootType,
...
function visitObjectValue(
  ...
  if (errors != null) {
    ...
    sortedErrors.unpathedErrors.forEach(function (error) {
      return errorInfo.unpathedErrors.add(error);
    });
  }
  ...
  if (errors != null) {
    Object.keys(errorMap).forEach(function (unknownResponseKey) {
      errorMap[unknownResponseKey].forEach(function (error) {
        return errorInfo.unpathedErrors.add(error);
      });
    });
  }
...
function visitFieldValue(
  ...
  if (graphql.isListType(nullableType)) {
    ...
    var collectedFields = collectSubFields(
      exeContext,
      nullableType,
      fieldNodes
    );
...
function sortErrorsByPathSegment(errors, pathIndex) {
  ...
  errors.forEach(function (error) {
    var _a;
    var pathSegment =
      (_a = error.path) === null || _a === void 0 ? void 0 : _a[pathIndex];
    if (pathSegment == null) {
...
function valueMatchesCriteria(value, criteria) {
  if (value == null) {
    ...
    return (
      ...
      value.every(function (val, index) {
    ...
    return (
      ...
      criteria &&
      Object.keys(criteria).every(function (propertyName) {
        return valueMatchesCriteria(
          value[propertyName],
