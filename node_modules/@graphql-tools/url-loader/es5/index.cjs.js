...
var asyncImport = function (moduleName) {
  return new Promise(function (resolve) {
    resolve(_interopNamespace(require(moduleName)));
  });
};
var syncImport = function (moduleName) {
...
var UrlLoader = /** @class */ (function () {
      ...
      return tslib.__generator(this, function (_c) {
        switch (_c.label) {
          case 0:
            ...
            (_b = extractFiles.extractFiles(vars, "variables", function (v) {
              return (
                extractFiles.isExtractableFile(v) ||
              ...
              (clone = _b.clone),
              (files = _b.files);
            map = Array.from(files.values()).reduce(function (
              prev,
              curr,
              currIndex
            ) {
            ...
            {});
            uploads = new Map(
              Array.from(files.keys()).map(function (u, i) {
                return [i, u];
              })
            );
            form = new FormData();
            ...
            return [
              4 /*yield*/,
              Promise.all(
                Array.from(uploads.entries()).map(function (_a) {
                  ...
                  return tslib.__awaiter(_this, void 0, void 0, function () {
                    ...
                    return tslib.__generator(this, function (_c) {
                      switch (_c.label) {
                        ...
                        case 2:
                          if (
                            !(u === null || u === void 0 ? void 0 : u.promise)
                          )
                            return [3 /*break*/, 4];
  ...
  UrlLoader.prototype.buildExecutor = function (_a) {
    ...
    var pointer = _a.pointer,
      fetch = _a.fetch,
      extraHeaders = _a.extraHeaders,
      defaultMethod = _a.defaultMethod,
      useGETForQueries = _a.useGETForQueries,
      multipart = _a.multipart;
    ...
    var executor = function (_a) {
      ...
      var document = _a.document,
        variables = _a.variables,
        rest = tslib.__rest(_a, ["document", "variables"]);
      ...
      if (useGETForQueries) {
        ...
        try {
          for (
            var _c = tslib.__values(document.definitions), _d = _c.next();
            !_d.done;
            _d = _c.next()
          ) {
      ...
      var headers = _this.getHeadersFromOptions(
        extraHeaders,
        tslib.__assign({ document: document, variables: variables }, rest)
      );
      var fetchResult;
      var query = graphql.print(document);
      switch (method) {
        case "GET":
          var finalUrl = _this.prepareGETUrl({
            baseUrl: pointer,
            query: query,
            variables: variables,
          });
      ...
      if (isPromise(fetchResult)) {
        return fetchResult.then(function (res) {
          return tslib.__awaiter(_this, void 0, void 0, function () {
                ...
                case 1:
                  ...
                  if (utils.isAsyncIterable(maybeStream)) {
                    return [
                      2 /*return*/,
                      utils.withCancel(
                        utils.mapAsyncIterator(maybeStream, function (part) {
                          if (part.json) {
                            var chunk = part.body;
                            if (chunk.path) {
                              if (chunk.data) {
  ...
  UrlLoader.prototype.buildWSSubscriber = function (
    ...
    return function (_a) {
      ...
      return tslib.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib.__generator(this, function (_b) {
          ...
          return [
            2 /*return*/,
            utils.observableToAsyncIterable({
  ...
  UrlLoader.prototype.buildWSLegacySubscriber = function (
    subscriptionsEndpoint,
    webSocketImpl,
    connectionParams
  ) {
  ...
  UrlLoader.prototype.buildSSESubscriber = function (
    pointer,
    extraHeaders,
    fetch,
    options
    ...
    return function (_a) {
      return tslib.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib.__generator(this, function (_b) {
          ...
          query = graphql.print(document);
          finalUrl = this.prepareGETUrl({
            baseUrl: pointer,
            query: query,
            variables: variables,
          });
          headers = this.getHeadersFromOptions(
            extraHeaders,
            tslib.__assign({ document: document, variables: variables }, rest)
          );
          return [
  ...
  UrlLoader.prototype.getFetch = function (customFetch, importFn, async) {
    if (customFetch) {
      if (typeof customFetch === "string") {
        var _a = tslib.__read(customFetch.split("#"), 2),
          moduleName = _a[0],
          fetchFnName_1 = _a[1];
        var moduleResult = importFn(moduleName);
        if (isPromise(moduleResult)) {
          return moduleResult.then(function (module) {
            return fetchFnName_1 ? module[fetchFnName_1] : module;
          });
        } else {
  ...
  UrlLoader.prototype.getHeadersFromOptions = function (
    customHeaders,
    executionParams
  ) {
    var headers = {};
    if (customHeaders) {
      ...
      if (Array.isArray(customHeaders)) {
        headers = customHeaders.reduce(function (prev, v) {
          return tslib.__assign(tslib.__assign({}, prev), v);
        }, {});
  ...
  UrlLoader.prototype.getDefaultMethodFromOptions = function (
    method,
    defaultMethod
  ) {
    if (method) {
  ...
  UrlLoader.prototype.getWebSocketImpl = function (options, importFn) {
    if (
      typeof (options === null || options === void 0
        ? void 0
        : options.webSocketImpl) === "string"
    ) {
      var _a = tslib.__read(options.webSocketImpl.split("#"), 2),
        moduleName = _a[0],
        webSocketImplName = _a[1];
      var importedModule = importFn(moduleName);
      if (isPromise(importedModule)) {
        return importedModule.then(
          webSocketImplName ? importedModule[webSocketImplName] : importedModule
        );
      } else {
        return webSocketImplName
          ? importedModule[webSocketImplName]
          : importedModule;
      }
    } else {
  ...
  UrlLoader.prototype.getExecutorAndSubscriberAsync = function (
    pointer,
    options
  ) {
    if (options === void 0) {
      ...
      return tslib.__generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              this.getFetch(options.customFetch, asyncImport, true),
            ];
          case 1:
            fetch = _a.sent();
            defaultMethod = this.getDefaultMethodFromOptions(
              options.method,
              "POST"
            );
            ...
            return [3 /*break*/, 4];
          case 2:
            return [4 /*yield*/, this.getWebSocketImpl(options, asyncImport)];
          case 3:
            webSocketImpl = _a.sent();
            connectionParams = function () {
              return {
                headers: _this.getHeadersFromOptions(options.headers, {}),
              };
            };
            if (options.useWebSocketLegacyProtocol) {
              subscriber = this.buildWSLegacySubscriber(
                subscriptionsEndpoint,
                webSocketImpl,
                connectionParams
              );
            } else {
              subscriber = this.buildWSSubscriber(
                subscriptionsEndpoint,
                webSocketImpl,
                connectionParams
              );
  ...
  UrlLoader.prototype.getExecutorAndSubscriberSync = function (
    pointer,
    options
  ) {
    var _this = this;
    var fetch = this.getFetch(
      options === null || options === void 0 ? void 0 : options.customFetch,
      syncImport,
      false
    );
    var defaultMethod = this.getDefaultMethodFromOptions(
      options === null || options === void 0 ? void 0 : options.method,
      "POST"
    );
    ...
    if (options.useSSEForSubscription) {
      var asyncFetchFn = function () {
        ...
        return _this
          ...
          .then(function (asyncFetch) {
            return asyncFetch.apply(
              void 0,
      ...
      var connectionParams = function () {
        return { headers: _this.getHeadersFromOptions(options.headers, {}) };
      };
      if (options.useWebSocketLegacyProtocol) {
        subscriber = this.buildWSLegacySubscriber(
          subscriptionsEndpoint,
      ...
      return tslib.__generator(this, function (_c) {
        switch (_c.label) {
          case 0:
            return [
              4 /*yield*/,
              this.getExecutorAndSubscriberAsync(pointer, options),
            ];
          case 1:
            (_a = _c.sent()),
            ...
            return [
              4 /*yield*/,
              wrap.introspectSchema(executor, undefined, options),
            ];
          case 2:
            return [
              2 /*return*/,
  ...
  UrlLoader.prototype.getSubschemaConfigSync = function (pointer, options) {
    var _a = this.getExecutorAndSubscriberSync(pointer, options),
      executor = _a.executor,
      subscriber = _a.subscriber;
    return {
  ...
  UrlLoader.prototype.handleSDLSync = function (pointer, options) {
    ...
    var headers = this.getHeadersFromOptions(
      options === null || options === void 0 ? void 0 : options.headers,
      {}
    );
    var defaultMethod = this.getDefaultMethodFromOptions(
          ...
          case 0:
            if (
              (options === null || options === void 0
                ? void 0
                : options.handleAsSDL) ||
              pointer.endsWith(".graphql")
            ) {
              return [2 /*return*/, this.handleSDLAsync(pointer, options)];
            }
            return [
              4 /*yield*/,
              this.getSubschemaConfigAsync(pointer, options),
            ];
          case 1:
  ...
  UrlLoader.prototype.loadSync = function (pointer, options) {
    if (
      (options === null || options === void 0 ? void 0 : options.handleAsSDL) ||
      pointer.endsWith(".graphql")
    ) {
...
function switchProtocols(pointer, protocolMap) {
  var protocols = Object.keys(protocolMap).map(function (source) {
    return [source, protocolMap[source]];
  });
