...
describe("documentToReactComponents", function () {
    ...
    var options = {
      renderMark:
        ...
        (_a[rich_text_types_1.MARKS.BOLD] = function (text) {
          return react_1.default.createElement(Strong_1.default, null, text);
        }),
        _a),
    };
  ...
  it("renders text with the passed custom text renderer", function () {
    var options = {
      renderText: function (text) {
        return text.replace(/world/, "Earth");
      },
    };
    var document = documents_1.paragraphDoc;
    expect(__1.documentToReactComponents(document, options)).toMatchSnapshot();
  ...
  it("renders asset hyperlink", function () {
    ...
    var document = documents_1.inlineEntityDoc(
      asset,
      rich_text_types_1.INLINES.ASSET_HYPERLINK
    );
    expect(__1.documentToReactComponents(document)).toMatchSnapshot();
  });
...
describe("appendKeyToValidElement", function () {
  it("appends keys to default React components", function () {
    expect(
      appendKeyToValidElement_1.appendKeyToValidElement(
        react_1.default.createElement("div", null),
        0
      )
    ).toHaveProperty("key", "0");
  });
  it("appends keys to custom React components", function () {
    expect(
      appendKeyToValidElement_1.appendKeyToValidElement(
        react_1.default.createElement(Paragraph_1.default, null, "hello world"),
        0
      )
    ).toHaveProperty("key", "0");
  });
  it("does not overwrite user specified keys", function () {
    expect(
      appendKeyToValidElement_1.appendKeyToValidElement(
        react_1.default.createElement("div", { key: "xyz" }),
        0
      )
    ).toHaveProperty("key", "xyz");
  });
  it("does not add keys to text nodes", function () {
    expect(
      appendKeyToValidElement_1.appendKeyToValidElement("hello world", 0)
  ...
  it("does not add keys to node arrays", function () {
    expect(
      appendKeyToValidElement_1.appendKeyToValidElement(
        [
          react_1.default.createElement("div", { key: 0 }),
  ...
  it("does not add keys to null", function () {
    expect(
      appendKeyToValidElement_1.appendKeyToValidElement(null, 0)
    ).toBeNull();
  });
});
describe("nodeToReactComponent", function () {
  ...
  var createBlockNode = function (nodeType) {
    return {
      nodeType: nodeType,
      data: {},
      content: [
  ...
  var createTextNode = function (type) {
    return {
      nodeType: "text",
      value: "hello world",
      marks: [{ type: type }],
  ...
  it("renders valid nodes", function () {
    expect(
      nodeListToReactComponents_1.nodeToReactComponent(
        createBlockNode(rich_text_types_1.BLOCKS.PARAGRAPH),
        options
      )
    ).toMatchSnapshot();
  });
  it("renders invalid node types in React fragments", function () {
    expect(
      nodeListToReactComponents_1.nodeToReactComponent(
        createBlockNode(rich_text_types_1.BLOCKS.HEADING_1),
        options
      )
    ).toMatchSnapshot();
  });
  it("renders valid marks", function () {
    expect(
      nodeListToReactComponents_1.nodeToReactComponent(
        createTextNode(rich_text_types_1.MARKS.BOLD),
        options
      )
    ).toMatchSnapshot();
  });
  it("does not add additional tags on invalid marks", function () {
    expect(
      nodeListToReactComponents_1.nodeToReactComponent(
        createTextNode(rich_text_types_1.MARKS.ITALIC),
        options
      )
    ).toMatchSnapshot();
  });
  ...
  it("does not render altered text with default text renderer", function () {
    expect(
      nodeListToReactComponents_1.nodeToReactComponent(customTextNode, options)
    ).toMatchSnapshot();
  });
            ...
            return text
              ...
              .reduce(function (children, textSegment, index) {
                return children.concat([
                  index > 0 &&
                    react_1.default.createElement("br", { key: index }),
                  textSegment,
                ]);
              }, []);
          },
...
describe("nodeListToReactComponents", function () {
  ...
  it("renders children as an array with keys from its index", function () {
    var renderedNodes = nodeListToReactComponents_1.nodeListToReactComponents(
      nodes,
      options
    );
