...
const instrumentVisitor = {
  ...
  coverageGlobalScopeFunc: {
    description:
      "avoid potentially replaced `Function` when finding global scope",
    type: "boolean",
    default: true,
    nycCommands: nycCommands.instrument,
  },
...
const instrumentOnly = {
  ...
  delete: {
    description:
      "should the output folder be deleted before instrumenting files?",
    type: "boolean",
    default: false,
    nycCommands: nycCommands.instrumentOnly,
  },
  completeCopy: {
    description:
      "should nyc copy all files from input to output as well as instrumented files?",
    type: "boolean",
    default: false,
    nycCommands: nycCommands.instrumentOnly,
  },
