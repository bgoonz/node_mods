...
export abstract class Recognizer<TRecognizerOptions> {
  ...
  private readonly modelFactory: ModelFactory<TRecognizerOptions> =
    new ModelFactory<TRecognizerOptions>();

  protected constructor(
    targetCulture: string,
    options: TRecognizerOptions,
  ...
  registerModel(
    modelTypeName: string,
    culture: string,
    modelCreator: (options: TRecognizerOptions) => IModel
  ) {
