...
export declare function recognizeCurrency(
  query: string,
  culture: string,
  options?: NumberWithUnitOptions,
  fallbackToDefaultCulture?: boolean
): Array<ModelResult>;
export declare function recognizeTemperature(
  query: string,
  culture: string,
  options?: NumberWithUnitOptions,
  fallbackToDefaultCulture?: boolean
): Array<ModelResult>;
export declare function recognizeDimension(
  query: string,
  culture: string,
  options?: NumberWithUnitOptions,
  fallbackToDefaultCulture?: boolean
): Array<ModelResult>;
export declare function recognizeAge(
  query: string,
  culture: string,
  options?: NumberWithUnitOptions,
  fallbackToDefaultCulture?: boolean
