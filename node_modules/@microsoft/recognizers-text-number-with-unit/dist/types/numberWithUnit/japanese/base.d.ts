...
export declare abstract class JapaneseNumberWithUnitExtractorConfiguration
  implements INumberWithUnitExtractorConfiguration
{
  ...
  abstract readonly extractType: string;
...
export declare class JapaneseNumberWithUnitParserConfiguration extends BaseNumberWithUnitParserConfiguration {
