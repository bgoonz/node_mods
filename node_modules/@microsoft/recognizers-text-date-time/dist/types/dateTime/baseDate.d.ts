...
export declare class BaseDateExtractor implements IDateTimeExtractor {
  ...
  protected durationWithBeforeAndAfter(
    source: string,
    refDate: Date
  ): Array<Token>;
}
...
export declare class BaseDateParser implements IDateTimeParser {
  ...
  protected parseBasicRegexMatch(
    source: string,
    referenceDate: Date
  ): DateTimeResolutionResult;
  ...
  protected parserDurationWithAgoAndLater(
    source: string,
    referenceDate: Date
  ): DateTimeResolutionResult;
  protected parseWeekdayOfMonth(
    source: string,
    referenceDate: Date
  ): DateTimeResolutionResult;
  protected matchToDate(
    match: Match,
    referenceDate: Date
  ): DateTimeResolutionResult;
