...
export declare class AgoLaterUtil {
  static extractorDurationWithBeforeAndAfter(
    source: string,
    er: ExtractResult,
    ret: Token[],
    config: IDateTimeUtilityConfiguration
  ): Array<Token>;
  static parseDurationWithAgoAndLater(
    source: string,
    referenceDate: Date,
  ...
  static getAgoLaterResult(
    durationParseResult: DateTimeParseResult,
    num: number,
    unitMap: ReadonlyMap<string, string>,
    srcUnit: string,
    afterStr: string,
...
export declare class DateUtils {
  ...
  static safeCreateDateResolveOverflow(
    year: number,
    month: number,
    day: number
  ): Date;
