...
export declare class BaseMergedParser implements IDateTimeParser {
  ...
  setParseResult(
    slot: DateTimeParseResult,
    hasBefore: boolean,
    hasAfter: boolean,
    hasSince: boolean
  ): DateTimeParseResult;
  protected getParseResult(
    extractorResult: ExtractResult,
    referenceDate: Date
  ): DateTimeParseResult | null;
  protected determineDateTimeType(
    type: string,
    hasBefore: boolean,
    hasAfter: boolean,
    hasSince: boolean
  ): string;
  dateTimeResolutionForSplit(
    slot: DateTimeParseResult
  ): Array<DateTimeParseResult>;
  ...
  protected addResolutionFieldsAny(
    dic: Map<string, any>,
    key: string,
    value: any
  ): void;
  protected addResolutionFields(
    dic: StringMap,
    key: string,
    value: string
  ): void;
  protected generateFromResolution(
    type: string,
