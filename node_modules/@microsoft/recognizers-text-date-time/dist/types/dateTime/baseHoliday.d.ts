...
export declare class BaseHolidayParser implements IDateTimeParser {
  ...
  protected parseHolidayRegexMatch(
    text: string,
    referenceDate: Date
  ): DateTimeResolutionResult;
  protected match2Date(
    match: Match,
    referenceDate: Date
  ): DateTimeResolutionResult;
...
export declare abstract class BaseHolidayParserConfiguration
  implements IHolidayParserConfiguration
{
  variableHolidaysTimexDictionary: ReadonlyMap<string, string>;
  holidayFuncDictionary: ReadonlyMap<string, (year: number) => Date>;
  holidayNames: ReadonlyMap<string, string[]>;
  ...
  protected static getDay(
    year: number,
    month: number,
    week: number,
    dayOfWeek: DayOfWeek
  ): number;
  protected static getLastDay(
    year: number,
    month: number,
    dayOfWeek: DayOfWeek
  ): number;
