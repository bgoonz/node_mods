...
export declare abstract class BaseDateTimeExtractor<T>
  implements IDateTimeExtractor
{
...
export declare class TimeResolutionUtils {
  static addDescription(
    lowBoundMap: ReadonlyMap<string, number>,
    timeResult: TimeResult,
    description: string
  ): void;
  static normalizeDesc(description: string): string;
  static matchToValue(
    onlyDigitMatch: RegExp,
    numbersMap: ReadonlyMap<string, number>,
    source: string
  ): number;
}
