export {
  default as NumberRecognizer,
  NumberOptions,
  recognizeNumber,
  recognizeOrdinal,
  recognizePercentage,
} from "./number/numberRecognizer";
...
export {
  ...
  Match,
  RegExpUtility,
} from "@microsoft/recognizers-text";
...
} from "./number/agnosticNumberParser";
export {
  INumberParserConfiguration,
  BaseNumberParser,
  BasePercentageParser,
} from "./number/parsers";
export {
...
} from "./number/japanese/extractors";
