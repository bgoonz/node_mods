...
var utilities = createCommonjsModule(function (module, exports) {
  ...
  class RegExpUtility {
    ...
    static getNextRegex(source, startPos) {
      ...
      let next =
        startPos === closePos ? null : source.substring(startPos, closePos + 1);
      return next;
    }
  ...
  class BaseNumberParser {
      ...
      if (resultText.includes(this.config.fractionMarkerToken)) {
        ...
        for (let i = fracWords.length - 1; i >= 0; i--) {
          if (
            ...
            this.config.writtenFractionSeparatorTexts.indexOf(fracWords[i]) > -1
          ) {
    ...
    skipNonDecimalSeparator(ch, distance, culture) {
      ...
      return (
        ...
        !(distance <= decimalLength && cultureRegex.exec(culture.code) !== null)
      );
    }
  ...
  class EnglishDoubleExtractor extends extractors$4.BaseNumberExtractor {
    constructor(
      ...
      let regexes = new Array(
        {
          regExp: recognizersText.RegExpUtility.getSafeRegExp(
            englishNumeric.EnglishNumeric.DoubleDecimalPointRegex(placeholder),
            "gis"
          ),
          value: "DoubleNum",
        },
  ...
  class PortugueseIntegerExtractor extends extractors$4.BaseNumberExtractor {
    constructor(
      ...
      let regexes = new Array(
        ...
        {
          regExp: recognizersText.RegExpUtility.getSafeRegExp(
            portugueseNumeric.PortugueseNumeric.RoundNumberIntegerRegexWithLocks
          ),
          value: "IntegerNum",
        },
        {
        ...
        {
          regExp: recognizersText.RegExpUtility.getSafeRegExp(
            portugueseNumeric.PortugueseNumeric.AllIntRegexWithDozenSuffixLocks
          ),
          value: "IntegerPor",
        }
      );
  ...
  class PortugueseFractionExtractor extends extractors$4.BaseNumberExtractor {
    constructor() {
      ...
      let regexes = new Array(
        ...
        {
          regExp: recognizersText.RegExpUtility.getSafeRegExp(
            portugueseNumeric.PortugueseNumeric.FractionNotationWithSpacesRegex
          ),
          value: "FracNum",
        },
        {
  ...
  class FrenchDoubleExtractor extends extractors$4.BaseNumberExtractor {
    constructor(placeholder = frenchNumeric.FrenchNumeric.PlaceHolderDefault) {
      ...
      let regexes = new Array(
        ...
        {
          regExp: recognizersText.RegExpUtility.getSafeRegExp(
            frenchNumeric.FrenchNumeric.DoubleWithoutIntegralRegex(placeholder)
          ),
          value: "DoubleNum",
        },
        {
...
var extractors$12 = createCommonjsModule(function (module, exports) {
  ...
  (function (ChineseNumberExtractorMode) {
    ...
    ChineseNumberExtractorMode[(ChineseNumberExtractorMode["ExtractAll"] = 1)] =
      "ExtractAll";
  })(
  ...
  class ChinesePercentageExtractor extends extractors$4.BaseNumberExtractor {
    constructor() {
      ...
      let regexes = new Array(
        ...
        {
          regExp: recognizersText.RegExpUtility.getSafeRegExp(
            chineseNumeric.ChineseNumeric.NumbersPercentageWithMultiplierRegex,
            "gi"
          ),
          value: "PerNum",
        },
        ...
        {
          regExp: recognizersText.RegExpUtility.getSafeRegExp(
            chineseNumeric.ChineseNumeric.FractionPercentageWithSeparatorRegex,
            "gis"
          ),
          value: "PerNum",
        },
        {
          regExp: recognizersText.RegExpUtility.getSafeRegExp(
            chineseNumeric.ChineseNumeric.FractionPercentageWithMultiplierRegex,
            "gi"
          ),
          value: "PerNum",
        },
        ...
        {
          regExp: recognizersText.RegExpUtility.getSafeRegExp(
            chineseNumeric.ChineseNumeric.IntegerPercentageWithMultiplierRegex,
            "gi"
          ),
          value: "PerNum",
        },
...
var extractors$14 = createCommonjsModule(function (module, exports) {
  ...
  (function (JapaneseNumberExtractorMode) {
    // Number extraction with an allow list that filters what numbers to extract.
    JapaneseNumberExtractorMode[(JapaneseNumberExtractorMode["Default"] = 0)] =
      "Default";
    // Extract all number-related terms aggressively.
  ...
  class JapaneseFractionExtractor extends extractors$4.BaseNumberExtractor {
    constructor() {
      ...
      let regexes = new Array(
        {
          regExp: recognizersText.RegExpUtility.getSafeRegExp(
            japaneseNumeric.JapaneseNumeric.FractionNotationSpecialsCharsRegex,
            "gis"
          ),
          value: "FracNum",
        },
  ...
  class JapanesePercentageExtractor extends extractors$4.BaseNumberExtractor {
    constructor() {
      ...
      let regexes = new Array(
        ...
        {
          regExp: recognizersText.RegExpUtility.getSafeRegExp(
            japaneseNumeric.JapaneseNumeric.NumbersPercentageWithSeparatorRegex,
            "gis"
          ),
          value: "PerNum",
        },
...
var recognizersTextNumber_37 = recognizersTextNumber.EnglishPercentageExtractor;
...
var recognizersTextNumber_45 = recognizersTextNumber.SpanishPercentageExtractor;
...
var recognizersTextNumber_48 = recognizersTextNumber.PortugueseDoubleExtractor;
var recognizersTextNumber_49 =
  recognizersTextNumber.PortugueseFractionExtractor;
var recognizersTextNumber_50 = recognizersTextNumber.PortugueseIntegerExtractor;
var recognizersTextNumber_51 = recognizersTextNumber.PortugueseNumberExtractor;
var recognizersTextNumber_52 = recognizersTextNumber.PortugueseOrdinalExtractor;
...
var recognizersTextNumber_61 = recognizersTextNumber.FrenchPercentageExtractor;
...
var recognizersTextNumber_69 = recognizersTextNumber.ChinesePercentageExtractor;
var recognizersTextNumber_70 = recognizersTextNumber.ChineseNumberExtractorMode;
var recognizersTextNumber_71 =
  recognizersTextNumber.ChineseNumberParserConfiguration;
var recognizersTextNumber_72 = recognizersTextNumber.JapaneseCardinalExtractor;
var recognizersTextNumber_73 = recognizersTextNumber.JapaneseDoubleExtractor;
var recognizersTextNumber_74 = recognizersTextNumber.JapaneseFractionExtractor;
...
export {
  recognizersTextNumber_1 as NumberRecognizer,
  recognizersTextNumber_2 as NumberOptions,
  recognizersTextNumber_3 as recognizeNumber,
  recognizersTextNumber_4 as recognizeOrdinal,
  recognizersTextNumber_5 as recognizePercentage,
  recognizersTextNumber_6 as Culture,
  recognizersTextNumber_7 as CultureInfo,
  recognizersTextNumber_8 as FormatUtility,
  recognizersTextNumber_9 as StringUtility,
  recognizersTextNumber_10 as Match,
  recognizersTextNumber_11 as RegExpUtility,
  recognizersTextNumber_12 as BaseNumbers,
  recognizersTextNumber_13 as EnglishNumeric,
  recognizersTextNumber_14 as SpanishNumeric,
  recognizersTextNumber_15 as FrenchNumeric,
  recognizersTextNumber_16 as ChineseNumeric,
  recognizersTextNumber_17 as JapaneseNumeric,
  recognizersTextNumber_18 as Constants,
  recognizersTextNumber_19 as BaseNumberExtractor,
  recognizersTextNumber_20 as BasePercentageExtractor,
  recognizersTextNumber_21 as NumberMode,
  recognizersTextNumber_22 as LongFormatType,
  recognizersTextNumber_23 as AbstractNumberModel,
  recognizersTextNumber_24 as NumberModel,
  recognizersTextNumber_25 as OrdinalModel,
  recognizersTextNumber_26 as PercentModel,
  recognizersTextNumber_27 as AgnosticNumberParserType,
  recognizersTextNumber_28 as AgnosticNumberParserFactory,
  recognizersTextNumber_29 as BaseNumberParser,
  recognizersTextNumber_30 as BasePercentageParser,
  recognizersTextNumber_31 as EnglishCardinalExtractor,
  recognizersTextNumber_32 as EnglishDoubleExtractor,
  recognizersTextNumber_33 as EnglishFractionExtractor,
  recognizersTextNumber_34 as EnglishIntegerExtractor,
  recognizersTextNumber_35 as EnglishNumberExtractor,
  recognizersTextNumber_36 as EnglishOrdinalExtractor,
  recognizersTextNumber_37 as EnglishPercentageExtractor,
  recognizersTextNumber_38 as EnglishNumberParserConfiguration,
  recognizersTextNumber_39 as SpanishCardinalExtractor,
  recognizersTextNumber_40 as SpanishDoubleExtractor,
  recognizersTextNumber_41 as SpanishFractionExtractor,
  recognizersTextNumber_42 as SpanishIntegerExtractor,
  recognizersTextNumber_43 as SpanishNumberExtractor,
  recognizersTextNumber_44 as SpanishOrdinalExtractor,
  recognizersTextNumber_45 as SpanishPercentageExtractor,
  recognizersTextNumber_46 as SpanishNumberParserConfiguration,
  recognizersTextNumber_47 as PortugueseCardinalExtractor,
  recognizersTextNumber_48 as PortugueseDoubleExtractor,
  recognizersTextNumber_49 as PortugueseFractionExtractor,
  recognizersTextNumber_50 as PortugueseIntegerExtractor,
  recognizersTextNumber_51 as PortugueseNumberExtractor,
  recognizersTextNumber_52 as PortugueseOrdinalExtractor,
  recognizersTextNumber_53 as PortuguesePercentageExtractor,
  recognizersTextNumber_54 as PortugueseNumberParserConfiguration,
  recognizersTextNumber_55 as FrenchCardinalExtractor,
  recognizersTextNumber_56 as FrenchDoubleExtractor,
  recognizersTextNumber_57 as FrenchFractionExtractor,
  recognizersTextNumber_58 as FrenchIntegerExtractor,
  recognizersTextNumber_59 as FrenchNumberExtractor,
  recognizersTextNumber_60 as FrenchOrdinalExtractor,
  recognizersTextNumber_61 as FrenchPercentageExtractor,
  recognizersTextNumber_62 as FrenchNumberParserConfiguration,
  recognizersTextNumber_63 as ChineseCardinalExtractor,
  recognizersTextNumber_64 as ChineseDoubleExtractor,
  recognizersTextNumber_65 as ChineseFractionExtractor,
  recognizersTextNumber_66 as ChineseIntegerExtractor,
  recognizersTextNumber_67 as ChineseNumberExtractor,
  recognizersTextNumber_68 as ChineseOrdinalExtractor,
  recognizersTextNumber_69 as ChinesePercentageExtractor,
  recognizersTextNumber_70 as ChineseNumberExtractorMode,
  recognizersTextNumber_71 as ChineseNumberParserConfiguration,
  recognizersTextNumber_72 as JapaneseCardinalExtractor,
  recognizersTextNumber_73 as JapaneseDoubleExtractor,
  recognizersTextNumber_74 as JapaneseFractionExtractor,
  recognizersTextNumber_75 as JapaneseIntegerExtractor,
  recognizersTextNumber_76 as JapaneseNumberExtractor,
  recognizersTextNumber_77 as JapaneseOrdinalExtractor,
  recognizersTextNumber_78 as JapanesePercentageExtractor,
  recognizersTextNumber_79 as JapaneseNumberExtractorMode,
  recognizersTextNumber_80 as JapaneseNumberParserConfiguration,
};
export default recognizersTextNumber$1;
//# sourceMappingURL=recognizers-text-number.es5.js.map
