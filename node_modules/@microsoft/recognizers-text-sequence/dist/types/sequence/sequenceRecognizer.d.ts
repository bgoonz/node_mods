...
export declare function recognizePhoneNumber(
  query: string,
  culture: string,
  options?: SequenceOptions
): Array<ModelResult>;
export declare function recognizeIpAddress(
  query: string,
  culture: string,
  options?: SequenceOptions
): Array<ModelResult>;
export declare function recognizeMention(
  query: string,
  culture: string,
  options?: SequenceOptions
): Array<ModelResult>;
export declare function recognizeHashtag(
  query: string,
  culture: string,
  options?: SequenceOptions
): Array<ModelResult>;
export declare function recognizeEmail(
  query: string,
  culture: string,
  options?: SequenceOptions
): Array<ModelResult>;
export declare function recognizeURL(
  query: string,
  culture: string,
  options?: SequenceOptions
): Array<ModelResult>;
export declare function recognizeGUID(
  query: string,
  culture: string,
  options?: SequenceOptions
): Array<ModelResult>;
