export {
  ...
  recognizeURL,
  recognizeGUID,
} from "./sequence/sequenceRecognizer";
...
export {
  ...
  BaseIpExtractor,
  BaseMentionExtractor,
  BaseHashtagExtractor,
  BaseEmailExtractor,
  BaseURLExtractor,
  BaseGUIDExtractor,
} from "./sequence/extractors";
export {
  ...
  URLExtractor,
  GUIDExtractor,
} from "./sequence/english/extractors";
