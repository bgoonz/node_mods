var microsoftRecognizersTextSequence = (function (exports) {
  "use strict";
  ...
  var models$2 = createCommonjsModule(function (module, exports) {
    ...
    class PhoneNumberModel extends AbstractSequenceModel {
      constructor() {
        super(...arguments);
    ...
    class IpAddressModel extends AbstractSequenceModel {
      constructor() {
        super(...arguments);
    ...
    class MentionModel extends AbstractSequenceModel {
      constructor() {
        super(...arguments);
    ...
    class HashtagModel extends AbstractSequenceModel {
      constructor() {
        super(...arguments);
    ...
    class EmailModel extends AbstractSequenceModel {
      constructor() {
        super(...arguments);
    ...
    class URLModel extends AbstractSequenceModel {
      constructor() {
        super(...arguments);
    ...
    class GUIDModel extends AbstractSequenceModel {
      constructor() {
        super(...arguments);
  ...
  var basePhoneNumbers = createCommonjsModule(function (module, exports) {
    "use strict";
    // ------------------------------------------------------------------------------
    // <auto-generated>
    ...
    // ------------------------------------------------------------------------------
    Object.defineProperty(exports, "__esModule", { value: true });
    var BasePhoneNumbers;
    (function (BasePhoneNumbers) {
      BasePhoneNumbers.NumberReplaceToken = "@builtin.phonenumber";
      BasePhoneNumbers.GeneralPhoneNumberRegex = `(\\b(((\\d[\\s]?){7,15}\\d))(?!-)\\b)|(\\(\\d{5}\\)\\s?\\d{5,6})|\\+\\d{2}\\(\\d\\)\\d{10}`;
      BasePhoneNumbers.BRPhoneNumberRegex = `(((\\B\\(\\s?))\\d{2,3}(\\s?\\))|(\\b\\d{2,3}))\\s?\\d{4,5}-?\\d{3,5}(?!-)\\b`;
      BasePhoneNumbers.UKPhoneNumberRegex = `(((\\b(00)|\\B\\+)\\s?)?(\\b\\d{2}\\s?)?((\\s?\\(0\\)[-\\s]?|\\b|(?<=(\\b^#)\\d{2}))\\d{2,5}|\\(0\\d{3,4}\\))[/-]?\\s?(\\d{5,8}|\\d{3,4}[-\\s]?\\d{3,4})(?!-)\\b)`;
      BasePhoneNumbers.DEPhoneNumberRegex = `((\\+\\d{2}\\s?((\\(0\\))?\\d\\s?)?|\\b)(\\d{2,4}\\s?[-/]?[\\s\\d]{7,10}\\d)(?!-)\\b)`;
      BasePhoneNumbers.USPhoneNumberRegex = `((((\\B\\+)|\\b)1(\\s|-)?)|\\b)?(\\(\\d{3}\\)[-\\s]?|\\b\\d{3}\\s?[-\\.]?\\s?)\\d{3}\\s?[-\\.]?\\s?\\d{4}(\\s?(x|X|ext)\\s?\\d{3,5})?(?!-)\\b`;
      BasePhoneNumbers.CNPhoneNumberRegex = `((\\b00\\s?)?\\+?86\\s?-?\\s?)?(((\\b|(?<=86))\\d{2,5}\\s?-?\\s?|\\(\\d{2,5}\\)\\s?)\\d{4}\\s?-?\\s?\\d{4}(\\s?-?\\s?\\d{4})?|(\\b|(?<=86))\\d{3}\\s?-?\\s?\\d{4}\\s?-?\\s?\\d{4})(?!-)\\b`;
      BasePhoneNumbers.DKPhoneNumberRegex = `((\\(\\s?(\\+\\s?|00)45\\s?\\)\\s?)|(((?<!\\d)\\+\\s?|\\b00)45\\s?)|\\b)(\\s?\\(0\\)\\s?)?((\\d{8})|(\\d{4}\\s?-?\\s?\\d{4,6})|((\\d{2}[\\s-]){3}\\d{2})|(\\d{2}\\s?-?\\s?\\d{3}\\s?-?\\s?\\d{3}))(?!-)\\b`;
      BasePhoneNumbers.ITPhoneNumberRegex = `((\\(\\s?(\\+\\s?|00)39\\s?\\)\\s?)|(((?<!\\d)\\+\\s?|\\b00)39\\s?)|\\b)((0[\\d\\s-]{4,12}\\d)|(3[\\d\\s-]{7,12}\\d))(?!-)\\b`;
      BasePhoneNumbers.NLPhoneNumberRegex = `((((\\(\\s?(\\+\\s?|00)31\\s?\\)\\s?)|(((?<!\\d)\\+\\s?|\\b00)31\\s?))?(((\\b|(?<=31))0?\\d{1,3}|\\(\\s?0?\\d{1,3}\\s?\\)|\\(0\\)[-\\s]?\\d{1,3})\\s?-?[\\d\\s]{5,11}\\d))|\\b\\d{10,12})(?!-)\\b`;
      BasePhoneNumbers.SpecialPhoneNumberRegex = `\\b(\\d{3,4}[/-]\\d{1,4}[/-]\\d{3,4})\\b`;
      BasePhoneNumbers.TypicalDeductionRegexList = [
        "^\\d{3}-\\d{2}-\\d{4}$",
        "^\\d{5}-\\d{4}$",
      ];
      BasePhoneNumbers.PhoneNumberMaskRegex = `([0-9A-E]{2}(\\s[0-9A-E]{2}){7})`;
      BasePhoneNumbers.CountryCodeRegex = `^(\\(\\s?(\\+\\s?|00)\\d{1,3}\\s?\\)|(\\+\\s?|00)\\d{1,3})`;
      BasePhoneNumbers.AreaCodeIndicatorRegex = `\\(`;
      BasePhoneNumbers.FormatIndicatorRegex = `(\\s|-|/|\\.)+`;
      BasePhoneNumbers.SeparatorCharList = ["-", ".", "/", "+", "#", "*"];
    })(
      (BasePhoneNumbers =
  ...
  unwrapExports(basePhoneNumbers);
  ...
  var parsers$4 = createCommonjsModule(function (module, exports) {
    ...
    class BaseIpParser extends BaseSequenceParser {
      parse(extResult) {
        let result = new recognizersText.ParseResult(extResult);
  ...
  var parsers$2 = createCommonjsModule(function (module, exports) {
    ...
    class PhoneNumberParser extends parsers$4.BaseSequenceParser {
      constructor() {
        super(...arguments);
      ...
      ScorePhoneNumber(phoneNumberText) {
        ...
        let countryCodeRegex = new RegExp(
          basePhoneNumbers.BasePhoneNumbers.CountryCodeRegex
        );
        let areaCodeRegex = new RegExp(
          basePhoneNumbers.BasePhoneNumbers.AreaCodeIndicatorRegex
        );
        let formatIndicatorRegex = new RegExp(
          basePhoneNumbers.BasePhoneNumbers.FormatIndicatorRegex,
          "ig"
        );
        // Country code score or area code score
        score += countryCodeRegex.test(phoneNumberText)
          ? this.countryCodeAward
          : areaCodeRegex.test(phoneNumberText)
          ? this.areaCodeAward
          : 0;
        // Formatted score
        if (formatIndicatorRegex.test(phoneNumberText)) {
          ...
          score +=
            Math.min(formatIndicatorCount, this.maxFormatIndicatorNum) *
            this.formattedAward;
          score -= formatMathes.some((match) => match.length > 1)
            ? this.continueFormatIndicatorDeductionScore
            : 0;
        }
        // Same tailing digit deduction
        if (this.tailSameDigitRegex.test(phoneNumberText)) {
          score -=
            (phoneNumberText.match(this.tailSameDigitRegex)[0].length -
              this.tailSameLimit) *
            this.tailSameDeductionScore;
        }
        // Length score
        if (this.digitRegex.test(phoneNumberText)) {
          score +=
            Math.min(
              phoneNumberText.match(this.digitRegex).length -
                this.phoneNumberLengthBase,
        ...
        if (this.pureDigitRegex.test(phoneNumberText)) {
          score -=
            phoneNumberText.length > this.pureDigitLengthLimit
              ? (phoneNumberText.length - this.pureDigitLengthLimit) *
                this.lengthAward
              : 0;
        }
        ...
        score -=
          basePhoneNumbers.BasePhoneNumbers.TypicalDeductionRegexList.some(
            (o) => new RegExp(o).test(phoneNumberText)
          )
            ? this.typicalFormatDeductionScore
            : 0;
        // Continue digit deduction
        if (this.continueDigitRegex.test(phoneNumberText)) {
          score -=
            Math.max(
              phoneNumberText.match(this.continueDigitRegex).length - 1,
              0
            ) * this.continueDigitDeductionScore;
        }
        return (
          Math.max(
            Math.min(score, this.scoreUpperLimit),
            this.scoreLowerLimit
          ) /
          (this.scoreUpperLimit - this.scoreLowerLimit)
        );
      }
      parse(extResult) {
        let result = new recognizersText.ParseResult(extResult);
    ...
    class IpParser extends parsers$4.BaseIpParser {}
    exports.IpParser = IpParser;
    class MentionParser extends parsers$4.BaseSequenceParser {}
    exports.MentionParser = MentionParser;
    class HashtagParser extends parsers$4.BaseSequenceParser {}
    exports.HashtagParser = HashtagParser;
    class EmailParser extends parsers$4.BaseSequenceParser {}
    exports.EmailParser = EmailParser;
    class URLParser extends parsers$4.BaseSequenceParser {}
    exports.URLParser = URLParser;
    class GUIDParser extends parsers$4.BaseSequenceParser {}
    exports.GUIDParser = GUIDParser;
  });

  unwrapExports(parsers$2);

  var baseIp = createCommonjsModule(function (module, exports) {
    "use strict";
    // ------------------------------------------------------------------------------
    // <auto-generated>
    //     This code was generated by a tool.
    ...
    var BaseIp;
    (function (BaseIp) {
      BaseIp.Ipv4Regex = `\\b(1\\d{2}|2[0-4]\\d|25[0-5]|0?[1-9]\\d|0{0,2}\\d)((\\.(1\\d{2}|2[0-4]\\d|25[0-5]|0?[1-9]\\d|0{0,2}\\d)){3})\\b`;
      BaseIp.BasicIpv6Element = `([\\da-fA-F]{1,4})`;
      BaseIp.BasicIpv6Regex = `((${BaseIp.BasicIpv6Element}:){7}${BaseIp.BasicIpv6Element})`;
      BaseIp.Ipv6EllipsisRegex1 = `(:(:${BaseIp.BasicIpv6Element}){1,7})`;
      BaseIp.Ipv6EllipsisRegex2 = `((${BaseIp.BasicIpv6Element}:){1}((:${BaseIp.BasicIpv6Element}){1,6}))`;
      BaseIp.Ipv6EllipsisRegex3 = `((${BaseIp.BasicIpv6Element}:){2}((:${BaseIp.BasicIpv6Element}){1,5}))`;
      BaseIp.Ipv6EllipsisRegex4 = `((${BaseIp.BasicIpv6Element}:){3}((:${BaseIp.BasicIpv6Element}){1,4}))`;
      BaseIp.Ipv6EllipsisRegex5 = `((${BaseIp.BasicIpv6Element}:){4}((:${BaseIp.BasicIpv6Element}){1,3}))`;
      BaseIp.Ipv6EllipsisRegex6 = `((${BaseIp.BasicIpv6Element}:){5}((:${BaseIp.BasicIpv6Element}){1,2}))`;
      BaseIp.Ipv6EllipsisRegex7 = `((${BaseIp.BasicIpv6Element}:){6}((:${BaseIp.BasicIpv6Element}){1}))`;
      BaseIp.Ipv6EllipsisRegex8 = `((${BaseIp.BasicIpv6Element}:){7}(:))`;
      BaseIp.Ipv6EllipsisRegexOther = `\\B::\\B|\\B:(:${BaseIp.BasicIpv6Element}){1,7}\\b|\\b(${BaseIp.BasicIpv6Element}:){1,7}:\\B`;
      BaseIp.MergedIpv6Regex = `(${BaseIp.BasicIpv6Regex}|${BaseIp.Ipv6EllipsisRegex1}|${BaseIp.Ipv6EllipsisRegex2}|${BaseIp.Ipv6EllipsisRegex3}|${BaseIp.Ipv6EllipsisRegex4}|${BaseIp.Ipv6EllipsisRegex5}|${BaseIp.Ipv6EllipsisRegex6}|${BaseIp.Ipv6EllipsisRegex7}|${BaseIp.Ipv6EllipsisRegex8})`;
      BaseIp.Ipv6Regex = `(\\b${BaseIp.MergedIpv6Regex}\\b)|(${BaseIp.Ipv6EllipsisRegexOther})`;
    })((BaseIp = exports.BaseIp || (exports.BaseIp = {})));
  });

  unwrapExports(baseIp);

  var baseMention = createCommonjsModule(function (module, exports) {
    "use strict";
    // ------------------------------------------------------------------------------
    // <auto-generated>
    //     This code was generated by a tool.
    ...
    (function (BaseMention) {
      BaseMention.MentionRegex = `@([a-zA-Z0-9_]+)(?![.]\\w)\\b`;
    })((BaseMention = exports.BaseMention || (exports.BaseMention = {})));
  });

  unwrapExports(baseMention);

  var baseHashtag = createCommonjsModule(function (module, exports) {
    "use strict";
    // ------------------------------------------------------------------------------
    // <auto-generated>
    //     This code was generated by a tool.
    ...
    Object.defineProperty(exports, "__esModule", { value: true });
    var BaseHashtag;
    (function (BaseHashtag) {
      BaseHashtag.HashtagRegex = `((?<=\\s|^)#([a-zA-Z0-9_]+))`;
    })((BaseHashtag = exports.BaseHashtag || (exports.BaseHashtag = {})));
  });

  unwrapExports(baseHashtag);

  var baseEmail = createCommonjsModule(function (module, exports) {
    "use strict";
    // ------------------------------------------------------------------------------
    // <auto-generated>
    //     This code was generated by a tool.
    ...
    var BaseEmail;
    (function (BaseEmail) {
      BaseEmail.EmailRegex = `(([-a-zA-Z0-9_\\+\\.]+)@([-a-zA-Z\\d\\.]+)\\.([a-zA-Z\\.]{2,6}))`;
      BaseEmail.IPv4Regex = `(?<ipv4>(\\d{1,3}\\.){3}\\d{1,3})`;
      BaseEmail.NormalSuffixRegex = `(([0-9A-Za-z][-]*[0-9A-Za-z]*\\.)+(?<tld>[a-zA-Z][\\-a-zA-Z]{0,22}[a-zA-Z]))`;
      BaseEmail.EmailPrefix = `(?(\"\")(\"\".+?(?<!\\\\)\"\")|(([0-9A-Za-z]((\\.(?!\\.))|[-!#\\$%&'\\*\\+/=\\?\\^\\{\\}\\|~\\w])*)(?<=[0-9A-Za-z])))`;
      BaseEmail.EmailSuffix = `(?(\\[)(\\[${BaseEmail.IPv4Regex}\\])|${BaseEmail.NormalSuffixRegex})`;
      BaseEmail.EmailRegex2 = `((${BaseEmail.EmailPrefix})@(${BaseEmail.EmailSuffix}))`;
    })((BaseEmail = exports.BaseEmail || (exports.BaseEmail = {})));
  });

  unwrapExports(baseEmail);
  ...
  var baseURL = createCommonjsModule(function (module, exports) {
    ...
    var BaseURL;
    (function (BaseURL) {
      BaseURL.ProtocolRegex = `((https?|ftp):\\/\\/)`;
      BaseURL.PortRegex = `(:\\d{1,5})`;
      BaseURL.ExtractionRestrictionRegex = `(?<=\\s|[\\'\"\"\\(\\[:]|^)`;
      BaseURL.UrlPrefixRegex = `(${BaseURL.ExtractionRestrictionRegex}${BaseURL.ProtocolRegex}?|${BaseURL.ProtocolRegex})[a-zA-Z0-9][-a-zA-Z0-9:%._\\+~#=]{0,256}\\.`;
      BaseURL.UrlSuffixRegex = `${BaseURL.PortRegex}?([/#][-a-zA-Z0-9:%_\\+.~#?!&//=]*)?(?![-a-zA-Z0-9:%_\\+~#?!&//=@])`;
      BaseURL.UrlRegex = `${BaseURL.UrlPrefixRegex}(?<Tld>[a-zA-Z]{2,18})${BaseURL.UrlSuffixRegex}`;
      BaseURL.UrlRegex2 = `((ht|f)tp(s?)\\:\\/\\/|www\\.)[0-9a-zA-Z]([-.\\w]*[0-9a-zA-Z])*(\\.(?<Tld>[0-9a-zA-Z]+))+(:(0-9)*)*(\\/?)([a-zA-Z0-9\\-\\.\\?\\,\\'\\/\\\\\\+&amp;%\\$#_=@]*)?`;
      BaseURL.IpUrlRegex = `(?<IPurl>(${BaseURL.ExtractionRestrictionRegex}${BaseURL.ProtocolRegex}(${baseIp.BaseIp.Ipv4Regex}|localhost)${BaseURL.UrlSuffixRegex}))`;
      BaseURL.TldList = [
        "com",
        "org",
        "net",
  ...
  unwrapExports(baseURL);

  var baseGUID = createCommonjsModule(function (module, exports) {
    "use strict";
    // ------------------------------------------------------------------------------
    // <auto-generated>
    //     This code was generated by a tool.
    ...
    var BaseGUID;
    (function (BaseGUID) {
      BaseGUID.GUIDRegexElement = `([A-Fa-f0-9]{8}(-[A-Fa-f0-9]{4}){3}-[A-Fa-f0-9]{12})`;
      BaseGUID.GUIDRegex = `(${BaseGUID.GUIDRegexElement}|\\{${BaseGUID.GUIDRegexElement}\\}|urn:uuid:${BaseGUID.GUIDRegexElement})`;
    })((BaseGUID = exports.BaseGUID || (exports.BaseGUID = {})));
  });

  unwrapExports(baseGUID);
  ...
  var extractors$4 = createCommonjsModule(function (module, exports) {
    ...
    class BaseSequenceExtractor {
      extract(source) {
        ...
        var collections = this.regexes.forEach((typeExtracted, regex) => {
          recognizersText.RegExpUtility.getMatches(regex, source).forEach(
            (match) => {
    ...
    class BasePhoneNumberExtractor extends BaseSequenceExtractor {
      constructor() {
        super();
        this.regexes = new Map()
          .set(
            recognizersText.RegExpUtility.getSafeRegExp(
              basePhoneNumbers.BasePhoneNumbers.BRPhoneNumberRegex
            ),
            constants.Constants.PHONE_NUMBER_REGEX_BR
          )
          .set(
            recognizersText.RegExpUtility.getSafeRegExp(
              basePhoneNumbers.BasePhoneNumbers.GeneralPhoneNumberRegex
            ),
            constants.Constants.PHONE_NUMBER_REGEX_GENERAL
          )
          .set(
            recognizersText.RegExpUtility.getSafeRegExp(
              basePhoneNumbers.BasePhoneNumbers.UKPhoneNumberRegex
            ),
            constants.Constants.PHONE_NUMBER_REGEX_UK
          )
          .set(
            recognizersText.RegExpUtility.getSafeRegExp(
              basePhoneNumbers.BasePhoneNumbers.DEPhoneNumberRegex
            ),
            constants.Constants.PHONE_NUMBER_REGEX_DE
          )
          .set(
            recognizersText.RegExpUtility.getSafeRegExp(
              basePhoneNumbers.BasePhoneNumbers.USPhoneNumberRegex
            ),
            constants.Constants.PHONE_NUMBER_REGEX_US
          )
          .set(
            recognizersText.RegExpUtility.getSafeRegExp(
              basePhoneNumbers.BasePhoneNumbers.CNPhoneNumberRegex
            ),
            constants.Constants.PHONE_NUMBER_REGEX_CN
          )
          .set(
            recognizersText.RegExpUtility.getSafeRegExp(
              basePhoneNumbers.BasePhoneNumbers.DKPhoneNumberRegex
            ),
            constants.Constants.PHONE_NUMBER_REGEX_DK
          )
          .set(
            recognizersText.RegExpUtility.getSafeRegExp(
              basePhoneNumbers.BasePhoneNumbers.ITPhoneNumberRegex
            ),
            constants.Constants.PHONE_NUMBER_REGEX_IT
          )
          .set(
            recognizersText.RegExpUtility.getSafeRegExp(
              basePhoneNumbers.BasePhoneNumbers.NLPhoneNumberRegex
            ),
            constants.Constants.PHONE_NUMBER_REGEX_NL
          )
          .set(
            recognizersText.RegExpUtility.getSafeRegExp(
              basePhoneNumbers.BasePhoneNumbers.SpecialPhoneNumberRegex
            ),
            constants.Constants.PHONE_NUMBER_REGEX_SPECIAL
          );
      }
      extract(source) {
        ...
        for (let er of ers) {
          ...
          if (
            er.start === 0 ||
            basePhoneNumbers.BasePhoneNumbers.SeparatorCharList.indexOf(ch) ===
              -1
          ) {
            ret.push(er);
          }
    ...
    class BaseIpExtractor extends BaseSequenceExtractor {
      constructor() {
        super();
        this.regexes = new Map()
          .set(
            recognizersText.RegExpUtility.getSafeRegExp(
              baseIp.BaseIp.Ipv4Regex
            ),
            constants.Constants.IP_REGEX_IPV4
          )
          .set(
            recognizersText.RegExpUtility.getSafeRegExp(
              baseIp.BaseIp.Ipv6Regex
            ),
            constants.Constants.IP_REGEX_IPV6
          );
      }
      extract(source) {
        let results = new Array();
        ...
        for (var i = 0; i < source.length; i++) {
          if (matched[i]) {
            if (i + 1 == source.length || !matched[i + 1]) {
              ...
              let substr = source.substr(start, length);
              if (
                substr.startsWith(constants.Constants.IPV6_ELLIPSIS) &&
                start > 0 &&
                this.isLetterOrDigit(source[start - 1])
              ) {
                continue;
              } else if (
                substr.endsWith(constants.Constants.IPV6_ELLIPSIS) &&
                i + 1 < source.length &&
                this.isLetterOrDigit(source[i + 1])
              ) {
                continue;
              }
              let matchFunc = (o) => o.index == start && o.length == length;
    ...
    class BaseMentionExtractor extends BaseSequenceExtractor {
      constructor() {
        super();
        this.regexes = new Map().set(
          recognizersText.RegExpUtility.getSafeRegExp(
            baseMention.BaseMention.MentionRegex
          ),
          constants.Constants.MENTION_REGEX
        );
      }
    }
    exports.BaseMentionExtractor = BaseMentionExtractor;
    class BaseHashtagExtractor extends BaseSequenceExtractor {
      constructor() {
        super();
        this.regexes = new Map().set(
          recognizersText.RegExpUtility.getSafeRegExp(
            baseHashtag.BaseHashtag.HashtagRegex
          ),
          constants.Constants.HASHTAG_REGEX
        );
      }
    }
    exports.BaseHashtagExtractor = BaseHashtagExtractor;
    class BaseEmailExtractor extends BaseSequenceExtractor {
      constructor() {
        super();
        this.regexes = new Map().set(
          recognizersText.RegExpUtility.getSafeRegExp(
            baseEmail.BaseEmail.EmailRegex
          ),
          constants.Constants.EMAIL_REGEX
        );
    ...
    class BaseURLExtractor extends BaseSequenceExtractor {
      constructor() {
        super();
        this.regexes = new Map()
          .set(
            recognizersText.RegExpUtility.getSafeRegExp(
              baseURL.BaseURL.UrlRegex
            ),
            constants.Constants.URL_REGEX
          )
          .set(
            recognizersText.RegExpUtility.getSafeRegExp(
              baseURL.BaseURL.UrlRegex2
            ),
            constants.Constants.URL_REGEX
          )
          .set(
            recognizersText.RegExpUtility.getSafeRegExp(
              baseURL.BaseURL.IpUrlRegex
            ),
            constants.Constants.URL_REGEX
          );
      }
    ...
    class BaseGUIDExtractor extends BaseSequenceExtractor {
      constructor() {
        super();
        this.regexes = new Map().set(
          recognizersText.RegExpUtility.getSafeRegExp(
            baseGUID.BaseGUID.GUIDRegex
          ),
          constants.Constants.GUID_REGEX
        );
      }
    }
  ...
  var extractors$2 = createCommonjsModule(function (module, exports) {
    ...
    class PhoneNumberExtractor extends extractors$4.BasePhoneNumberExtractor {
      extract(source) {
        var result = super.extract(source);
        var maskRegex = new RegExp(
          basePhoneNumbers.BasePhoneNumbers.PhoneNumberMaskRegex,
          "g"
        );
        var m;
        while ((m = maskRegex.exec(source)) != null) {
          for (var i = result.length - 1; i >= 0; --i) {
            if (
              result[i].start >= m.index &&
              result[i].start + result[i].length <= m.index + m[0].length
            ) {
              result.splice(i, 1);
            }
          }
    ...
    class IpExtractor extends extractors$4.BaseIpExtractor {}
    exports.IpExtractor = IpExtractor;
    class MentionExtractor extends extractors$4.BaseMentionExtractor {}
    exports.MentionExtractor = MentionExtractor;
    class HashtagExtractor extends extractors$4.BaseHashtagExtractor {}
    exports.HashtagExtractor = HashtagExtractor;
    class EmailExtractor extends extractors$4.BaseEmailExtractor {}
    exports.EmailExtractor = EmailExtractor;
    class URLExtractor extends extractors$4.BaseURLExtractor {}
    exports.URLExtractor = URLExtractor;
    class GUIDExtractor extends extractors$4.BaseGUIDExtractor {}
    exports.GUIDExtractor = GUIDExtractor;
  });

  unwrapExports(extractors$2);

  var sequenceRecognizer = createCommonjsModule(function (module, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });

    var SequenceOptions;
    (function (SequenceOptions) {
      SequenceOptions[(SequenceOptions["None"] = 0)] = "None";
    })(
      (SequenceOptions =
        exports.SequenceOptions || (exports.SequenceOptions = {}))
    );
    function recognizePhoneNumber(
      query,
      culture,
      options = SequenceOptions.None
    ) {
      return recognizeByModel(
        (recognizer) => recognizer.getPhoneNumberModel(),
        query,
        culture,
        options
      );
    ...
    function recognizeIpAddress(
      query,
      culture,
      options = SequenceOptions.None
    ) {
      return recognizeByModel(
        (recognizer) => recognizer.getIpAddressModel(),
        query,
        culture,
        options
      );
    ...
    function recognizeMention(query, culture, options = SequenceOptions.None) {
      return recognizeByModel(
        (recognizer) => recognizer.getMentionModel(),
        query,
        culture,
        options
      );
    ...
    function recognizeHashtag(query, culture, options = SequenceOptions.None) {
      return recognizeByModel(
        (recognizer) => recognizer.getHashtagModel(),
        query,
        culture,
        options
      );
    ...
    function recognizeEmail(query, culture, options = SequenceOptions.None) {
      return recognizeByModel(
        (recognizer) => recognizer.getEmailModel(),
        query,
        culture,
        options
      );
    ...
    function recognizeURL(query, culture, options = SequenceOptions.None) {
      return recognizeByModel(
        (recognizer) => recognizer.getURLModel(),
        query,
        culture,
        options
      );
    ...
    function recognizeGUID(query, culture, options = SequenceOptions.None) {
      return recognizeByModel(
        (recognizer) => recognizer.getGUIDModel(),
        query,
        culture,
        options
      );
    ...
    class SequenceRecognizer extends recognizersText.Recognizer {
      constructor(
        culture,
        options = SequenceOptions.None,
      ...
      InitializeConfiguration() {
        this.registerModel(
          ...
          (options) =>
            new models$2.PhoneNumberModel(
              new parsers$2.PhoneNumberParser(),
              new extractors$2.PhoneNumberExtractor()
            )
        );
        this.registerModel(
          "IpAddressModel",
          recognizersText.Culture.English,
          (options) =>
            new models$2.IpAddressModel(
              new parsers$2.IpParser(),
              new extractors$2.IpExtractor()
            )
        );
        this.registerModel(
          "MentionModel",
          recognizersText.Culture.English,
          (options) =>
            new models$2.MentionModel(
              new parsers$2.MentionParser(),
              new extractors$2.MentionExtractor()
            )
        );
        this.registerModel(
          "HashtagModel",
          recognizersText.Culture.English,
          (options) =>
            new models$2.HashtagModel(
              new parsers$2.HashtagParser(),
              new extractors$2.HashtagExtractor()
            )
        );
        this.registerModel(
          "EmailModel",
          recognizersText.Culture.English,
          (options) =>
            new models$2.EmailModel(
              new parsers$2.EmailParser(),
              new extractors$2.EmailExtractor()
            )
        );
        this.registerModel(
          "URLModel",
          recognizersText.Culture.English,
          (options) =>
            new models$2.URLModel(
              new parsers$2.URLParser(),
              new extractors$2.URLExtractor()
            )
        );
        this.registerModel(
          "GUIDModel",
          recognizersText.Culture.English,
          (options) =>
            new models$2.GUIDModel(
              new parsers$2.GUIDParser(),
              new extractors$2.GUIDExtractor()
            )
        );
      }
    ...
    exports.default = SequenceRecognizer;
  });

  unwrapExports(sequenceRecognizer);

  var recognizersTextSequence = createCommonjsModule(function (
    module,
    exports
  ) {
    "use strict";
    ...
    exports.SequenceRecognizer = sequenceRecognizer.default;
    exports.SequenceOptions = sequenceRecognizer.SequenceOptions;
    exports.recognizePhoneNumber = sequenceRecognizer.recognizePhoneNumber;
    exports.recognizeIpAddress = sequenceRecognizer.recognizeIpAddress;
    exports.recognizeMention = sequenceRecognizer.recognizeMention;
    exports.recognizeHashtag = sequenceRecognizer.recognizeHashtag;
    exports.recognizeEmail = sequenceRecognizer.recognizeEmail;
    exports.recognizeURL = sequenceRecognizer.recognizeURL;
    exports.recognizeGUID = sequenceRecognizer.recognizeGUID;

    exports.Culture = recognizersText.Culture;

    exports.AbstractSequenceModel = models$2.AbstractSequenceModel;
    exports.PhoneNumberModel = models$2.PhoneNumberModel;
    exports.IpAddressModel = models$2.IpAddressModel;
    exports.MentionModel = models$2.MentionModel;
    exports.HashtagModel = models$2.HashtagModel;
    exports.EmailModel = models$2.EmailModel;
    exports.URLModel = models$2.URLModel;
    exports.GUIDModel = models$2.GUIDModel;

    exports.BaseSequenceExtractor = extractors$4.BaseSequenceExtractor;
    exports.BasePhoneNumberExtractor = extractors$4.BasePhoneNumberExtractor;
    exports.BaseIpExtractor = extractors$4.BaseIpExtractor;
    exports.BaseMentionExtractor = extractors$4.BaseMentionExtractor;
    exports.BaseHashtagExtractor = extractors$4.BaseHashtagExtractor;
    exports.BaseEmailExtractor = extractors$4.BaseEmailExtractor;
    exports.BaseURLExtractor = extractors$4.BaseURLExtractor;
    exports.BaseGUIDExtractor = extractors$4.BaseGUIDExtractor;

    exports.PhoneNumberExtractor = extractors$2.PhoneNumberExtractor;
    exports.IpExtractor = extractors$2.IpExtractor;
    exports.MentionExtractor = extractors$2.MentionExtractor;
    exports.HashtagExtractor = extractors$2.HashtagExtractor;
    exports.EmailExtractor = extractors$2.EmailExtractor;
    exports.URLExtractor = extractors$2.URLExtractor;
    exports.GUIDExtractor = extractors$2.GUIDExtractor;

    exports.BaseSequenceParser = parsers$4.BaseSequenceParser;
    exports.BaseIpParser = parsers$4.BaseIpParser;

    exports.PhoneNumberParser = parsers$2.PhoneNumberParser;
    exports.IpParser = parsers$2.IpParser;
    exports.MentionParser = parsers$2.MentionParser;
    exports.HashtagParser = parsers$2.HashtagParser;
    exports.EmailParser = parsers$2.EmailParser;
    exports.URLParser = parsers$2.URLParser;
    exports.GUIDParser = parsers$2.GUIDParser;

    exports.BasePhoneNumbers = basePhoneNumbers.BasePhoneNumbers;

    exports.BaseIp = baseIp.BaseIp;

    exports.BaseMention = baseMention.BaseMention;

    exports.BaseHashtag = baseHashtag.BaseHashtag;

    exports.BaseEmail = baseEmail.BaseEmail;

    exports.BaseURL = baseURL.BaseURL;

    exports.BaseGUID = baseGUID.BaseGUID;
  });

  var recognizersTextSequence$1 = unwrapExports(recognizersTextSequence);
  var recognizersTextSequence_1 = recognizersTextSequence.SequenceRecognizer;
  var recognizersTextSequence_2 = recognizersTextSequence.SequenceOptions;
  var recognizersTextSequence_3 = recognizersTextSequence.recognizePhoneNumber;
  var recognizersTextSequence_4 = recognizersTextSequence.recognizeIpAddress;
  var recognizersTextSequence_5 = recognizersTextSequence.recognizeMention;
  var recognizersTextSequence_6 = recognizersTextSequence.recognizeHashtag;
  var recognizersTextSequence_7 = recognizersTextSequence.recognizeEmail;
  var recognizersTextSequence_8 = recognizersTextSequence.recognizeURL;
  var recognizersTextSequence_9 = recognizersTextSequence.recognizeGUID;
  var recognizersTextSequence_10 = recognizersTextSequence.Culture;
  var recognizersTextSequence_11 =
    recognizersTextSequence.AbstractSequenceModel;
  var recognizersTextSequence_12 = recognizersTextSequence.PhoneNumberModel;
  var recognizersTextSequence_13 = recognizersTextSequence.IpAddressModel;
  var recognizersTextSequence_14 = recognizersTextSequence.MentionModel;
  var recognizersTextSequence_15 = recognizersTextSequence.HashtagModel;
  var recognizersTextSequence_16 = recognizersTextSequence.EmailModel;
  var recognizersTextSequence_17 = recognizersTextSequence.URLModel;
  var recognizersTextSequence_18 = recognizersTextSequence.GUIDModel;
  var recognizersTextSequence_19 =
    recognizersTextSequence.BaseSequenceExtractor;
  var recognizersTextSequence_20 =
    recognizersTextSequence.BasePhoneNumberExtractor;
  var recognizersTextSequence_21 = recognizersTextSequence.BaseIpExtractor;
  var recognizersTextSequence_22 = recognizersTextSequence.BaseMentionExtractor;
  var recognizersTextSequence_23 = recognizersTextSequence.BaseHashtagExtractor;
  var recognizersTextSequence_24 = recognizersTextSequence.BaseEmailExtractor;
  var recognizersTextSequence_25 = recognizersTextSequence.BaseURLExtractor;
  var recognizersTextSequence_26 = recognizersTextSequence.BaseGUIDExtractor;
  var recognizersTextSequence_27 = recognizersTextSequence.PhoneNumberExtractor;
  var recognizersTextSequence_28 = recognizersTextSequence.IpExtractor;
  var recognizersTextSequence_29 = recognizersTextSequence.MentionExtractor;
  var recognizersTextSequence_30 = recognizersTextSequence.HashtagExtractor;
  var recognizersTextSequence_31 = recognizersTextSequence.EmailExtractor;
  var recognizersTextSequence_32 = recognizersTextSequence.URLExtractor;
  var recognizersTextSequence_33 = recognizersTextSequence.GUIDExtractor;
  var recognizersTextSequence_34 = recognizersTextSequence.BaseSequenceParser;
  var recognizersTextSequence_35 = recognizersTextSequence.BaseIpParser;
  var recognizersTextSequence_36 = recognizersTextSequence.PhoneNumberParser;
  var recognizersTextSequence_37 = recognizersTextSequence.IpParser;
  var recognizersTextSequence_38 = recognizersTextSequence.MentionParser;
  var recognizersTextSequence_39 = recognizersTextSequence.HashtagParser;
  var recognizersTextSequence_40 = recognizersTextSequence.EmailParser;
  var recognizersTextSequence_41 = recognizersTextSequence.URLParser;
  var recognizersTextSequence_42 = recognizersTextSequence.GUIDParser;
  var recognizersTextSequence_43 = recognizersTextSequence.BasePhoneNumbers;
  var recognizersTextSequence_44 = recognizersTextSequence.BaseIp;
  var recognizersTextSequence_45 = recognizersTextSequence.BaseMention;
  var recognizersTextSequence_46 = recognizersTextSequence.BaseHashtag;
  var recognizersTextSequence_47 = recognizersTextSequence.BaseEmail;
  var recognizersTextSequence_48 = recognizersTextSequence.BaseURL;
  var recognizersTextSequence_49 = recognizersTextSequence.BaseGUID;

  exports["default"] = recognizersTextSequence$1;
  exports.SequenceRecognizer = recognizersTextSequence_1;
  exports.SequenceOptions = recognizersTextSequence_2;
  exports.recognizePhoneNumber = recognizersTextSequence_3;
  exports.recognizeIpAddress = recognizersTextSequence_4;
  exports.recognizeMention = recognizersTextSequence_5;
  exports.recognizeHashtag = recognizersTextSequence_6;
  exports.recognizeEmail = recognizersTextSequence_7;
  exports.recognizeURL = recognizersTextSequence_8;
  exports.recognizeGUID = recognizersTextSequence_9;
  exports.Culture = recognizersTextSequence_10;
  exports.AbstractSequenceModel = recognizersTextSequence_11;
  exports.PhoneNumberModel = recognizersTextSequence_12;
  exports.IpAddressModel = recognizersTextSequence_13;
  exports.MentionModel = recognizersTextSequence_14;
  exports.HashtagModel = recognizersTextSequence_15;
  exports.EmailModel = recognizersTextSequence_16;
  exports.URLModel = recognizersTextSequence_17;
  exports.GUIDModel = recognizersTextSequence_18;
  exports.BaseSequenceExtractor = recognizersTextSequence_19;
  exports.BasePhoneNumberExtractor = recognizersTextSequence_20;
  exports.BaseIpExtractor = recognizersTextSequence_21;
  exports.BaseMentionExtractor = recognizersTextSequence_22;
  exports.BaseHashtagExtractor = recognizersTextSequence_23;
  exports.BaseEmailExtractor = recognizersTextSequence_24;
  exports.BaseURLExtractor = recognizersTextSequence_25;
  exports.BaseGUIDExtractor = recognizersTextSequence_26;
  exports.PhoneNumberExtractor = recognizersTextSequence_27;
  exports.IpExtractor = recognizersTextSequence_28;
  exports.MentionExtractor = recognizersTextSequence_29;
  exports.HashtagExtractor = recognizersTextSequence_30;
  exports.EmailExtractor = recognizersTextSequence_31;
  exports.URLExtractor = recognizersTextSequence_32;
  exports.GUIDExtractor = recognizersTextSequence_33;
  exports.BaseSequenceParser = recognizersTextSequence_34;
  exports.BaseIpParser = recognizersTextSequence_35;
  exports.PhoneNumberParser = recognizersTextSequence_36;
  exports.IpParser = recognizersTextSequence_37;
  exports.MentionParser = recognizersTextSequence_38;
  exports.HashtagParser = recognizersTextSequence_39;
  exports.EmailParser = recognizersTextSequence_40;
  exports.URLParser = recognizersTextSequence_41;
  exports.GUIDParser = recognizersTextSequence_42;
  exports.BasePhoneNumbers = recognizersTextSequence_43;
  exports.BaseIp = recognizersTextSequence_44;
  exports.BaseMention = recognizersTextSequence_45;
  exports.BaseHashtag = recognizersTextSequence_46;
  exports.BaseEmail = recognizersTextSequence_47;
  exports.BaseURL = recognizersTextSequence_48;
  exports.BaseGUID = recognizersTextSequence_49;

  return exports;
})({});
//# sourceMappingURL=recognizers-text-sequence.browser.js.map
