...
var parsers$2 = createCommonjsModule(function (module, exports) {
  ...
  class PhoneNumberParser extends parsers$4.BaseSequenceParser {
    ...
    ScorePhoneNumber(phoneNumberText) {
      ...
      score -= basePhoneNumbers.BasePhoneNumbers.TypicalDeductionRegexList.some(
      ...
      return (
        Math.max(Math.min(score, this.scoreUpperLimit), this.scoreLowerLimit) /
...
var extractors$4 = createCommonjsModule(function (module, exports) {
  ...
  class BasePhoneNumberExtractor extends BaseSequenceExtractor {
    ...
    extract(source) {
      ...
      for (let er of ers) {
        ...
        if (
          er.start === 0 ||
          basePhoneNumbers.BasePhoneNumbers.SeparatorCharList.indexOf(ch) === -1
        ) {
          ret.push(er);
        }
      }
  ...
  class BaseIpExtractor extends BaseSequenceExtractor {
    constructor() {
      ...
      this.regexes = new Map()
        .set(
          recognizersText.RegExpUtility.getSafeRegExp(baseIp.BaseIp.Ipv4Regex),
          constants.Constants.IP_REGEX_IPV4
        )
        .set(
          recognizersText.RegExpUtility.getSafeRegExp(baseIp.BaseIp.Ipv6Regex),
  ...
  class BaseURLExtractor extends BaseSequenceExtractor {
    constructor() {
      ...
      this.regexes = new Map()
        .set(
          recognizersText.RegExpUtility.getSafeRegExp(baseURL.BaseURL.UrlRegex),
...
var sequenceRecognizer = createCommonjsModule(function (module, exports) {
  ...
  function recognizeIpAddress(query, culture, options = SequenceOptions.None) {
    return recognizeByModel(
...
var recognizersTextSequence = createCommonjsModule(function (module, exports) {
  "use strict";
  Object.defineProperty(exports, "__esModule", { value: true });
...
var recognizersTextSequence_11 = recognizersTextSequence.AbstractSequenceModel;
...
var recognizersTextSequence_19 = recognizersTextSequence.BaseSequenceExtractor;
...
export {
  recognizersTextSequence_1 as SequenceRecognizer,
  recognizersTextSequence_2 as SequenceOptions,
  recognizersTextSequence_3 as recognizePhoneNumber,
  recognizersTextSequence_4 as recognizeIpAddress,
  recognizersTextSequence_5 as recognizeMention,
  recognizersTextSequence_6 as recognizeHashtag,
  recognizersTextSequence_7 as recognizeEmail,
  recognizersTextSequence_8 as recognizeURL,
  recognizersTextSequence_9 as recognizeGUID,
  recognizersTextSequence_10 as Culture,
  recognizersTextSequence_11 as AbstractSequenceModel,
  recognizersTextSequence_12 as PhoneNumberModel,
  recognizersTextSequence_13 as IpAddressModel,
  recognizersTextSequence_14 as MentionModel,
  recognizersTextSequence_15 as HashtagModel,
  recognizersTextSequence_16 as EmailModel,
  recognizersTextSequence_17 as URLModel,
  recognizersTextSequence_18 as GUIDModel,
  recognizersTextSequence_19 as BaseSequenceExtractor,
  recognizersTextSequence_20 as BasePhoneNumberExtractor,
  recognizersTextSequence_21 as BaseIpExtractor,
  recognizersTextSequence_22 as BaseMentionExtractor,
  recognizersTextSequence_23 as BaseHashtagExtractor,
  recognizersTextSequence_24 as BaseEmailExtractor,
  recognizersTextSequence_25 as BaseURLExtractor,
  recognizersTextSequence_26 as BaseGUIDExtractor,
  recognizersTextSequence_27 as PhoneNumberExtractor,
  recognizersTextSequence_28 as IpExtractor,
  recognizersTextSequence_29 as MentionExtractor,
  recognizersTextSequence_30 as HashtagExtractor,
  recognizersTextSequence_31 as EmailExtractor,
  recognizersTextSequence_32 as URLExtractor,
  recognizersTextSequence_33 as GUIDExtractor,
  recognizersTextSequence_34 as BaseSequenceParser,
  recognizersTextSequence_35 as BaseIpParser,
  recognizersTextSequence_36 as PhoneNumberParser,
  recognizersTextSequence_37 as IpParser,
  recognizersTextSequence_38 as MentionParser,
  recognizersTextSequence_39 as HashtagParser,
  recognizersTextSequence_40 as EmailParser,
  recognizersTextSequence_41 as URLParser,
  recognizersTextSequence_42 as GUIDParser,
  recognizersTextSequence_43 as BasePhoneNumbers,
  recognizersTextSequence_44 as BaseIp,
  recognizersTextSequence_45 as BaseMention,
  recognizersTextSequence_46 as BaseHashtag,
  recognizersTextSequence_47 as BaseEmail,
  recognizersTextSequence_48 as BaseURL,
  recognizersTextSequence_49 as BaseGUID,
};
export default recognizersTextSequence$1;
//# sourceMappingURL=recognizers-text-sequence.es5.js.map
