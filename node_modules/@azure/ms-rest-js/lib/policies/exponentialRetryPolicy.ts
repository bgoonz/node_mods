...
export class ExponentialRetryPolicy extends BaseRequestPolicy {
  ...
  constructor(
    ...
    this.retryCount = isNumber(retryCount)
      ? retryCount
      : DEFAULT_CLIENT_RETRY_COUNT;
    this.retryInterval = isNumber(retryInterval)
      ? retryInterval
...
function retry(
  ...
  const isAborted: boolean | undefined =
    request.abortSignal && request.abortSignal.aborted;
  if (
    !isAborted &&
