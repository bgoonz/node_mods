...
export class URLQuery {
  private readonly _rawQuery: {
    [queryParameterName: string]: string | string[];
  } = {};
...
function readWhileLetterOrDigit(tokenizer: URLTokenizer): string {
  return readWhile(tokenizer, (character: string) =>
