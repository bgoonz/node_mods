 ...
 */
export declare function urlIsHTTPS(urlToCheck: { protocol: string }): boolean;
/**
 * Encodes an URI.
 *
 ...
 */
export declare function objectValues(obj: { [key: string]: any }): any[];
/**
 * Generated UUID
 *
 ...
 */
export declare function executePromisesSequentially(
 ...
 */
export declare function promiseToServiceCallback<T>(
  promise: Promise<HttpOperationResponse>
): Function;
export declare function prepareXMLRootList(
  obj: any,
  elementName: string
): {
  [x: string]: any;
