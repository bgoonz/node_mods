...
class FormData {
  ...
  _trackLength(header, value, {knownLength}) {
    let valueLength = 0;
  ...
  _lengthRetriever(value, callback) {
    ...
    if (value.hasOwnProperty('fd')) {
      ...
      // not that fast snoopy
        ...
        fs.stat(value.path, (err, {size}) => {
          ...
          fileSize = size - (value.start ? value.start : 0);
    ...
    // or request stream http://github.com/mikeal/request
      ...
      value.on('response', ({headers}) => {
        value.pause();
        callback(null, +headers['content-length']);
      });
      value.resume();
  ...
  getBuffer() {
    let dataBuffer = new Buffer.alloc( 0 );
