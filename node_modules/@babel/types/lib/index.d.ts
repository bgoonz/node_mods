...
declare type Terminatorless =
  ...
  | YieldExpression
  | AwaitExpression;
declare type CompletionStatement =
  | BreakStatement
  | ContinueStatement
  | ReturnStatement
  | ThrowStatement;
...
declare type ExpressionWrapper =
  | ExpressionStatement
  | ParenthesizedExpression
  | TypeCastExpression;
...
declare type Immutable =
  ...
  | JSXClosingFragment
  | DecimalLiteral;
declare type UserWhitespacable =
  | ObjectMethod
  | ObjectProperty
  | ObjectTypeInternalSlot
  | ObjectTypeCallProperty
...
declare type FlowType =
  ...
  | IndexedAccessType
  | OptionalIndexedAccessType;
declare type FlowBaseAnnotation =
  | AnyTypeAnnotation
  | BooleanTypeAnnotation
  | NullLiteralTypeAnnotation
  | MixedTypeAnnotation
...
declare function createTSUnionType(
  typeAnnotations: Array<TSTypeAnnotation>
): TSType;
...
declare function removeTypeDuplicates(
  nodes: ReadonlyArray<FlowType | false | null | undefined>
): FlowType[];
 ...
 * and processing.
 */
declare function traverseFast(
  node: Node | null | undefined,
  enter: (node: Node, opts?: any) => void,
  opts?: any
): void;
