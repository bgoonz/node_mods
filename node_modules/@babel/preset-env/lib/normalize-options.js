...
exports.validateUseBuiltInsOption =
  ...
  exports.checkDuplicateIncludeExcludes =
...
const selectPlugins = (regexp, type, corejs) =>
...
const validateModulesOption = (modulesOpt = _options.ModulesOption.auto) => {
  v.invariant(
    _options.ModulesOption[modulesOpt.toString()] ||
      modulesOpt === _options.ModulesOption.false,
...
function normalizeOptions(opts) {
  ...
  return {
    bugfixes: v.validateBooleanOption(
      _options.TopLevelOptions.bugfixes,
      opts.bugfixes,
      false
    ),
