...
class Client {
  ...
  getVersion() {
    ...
    return (_classPrivateFieldGet2 = _classPrivateFieldGet(this, _vCache)) !=
      null
      ? _classPrivateFieldGet2
      : _classPrivateFieldSet(
          this,
          _vCache,
          _classPrivateFieldGet(this, _send).call(
            this,
            ACTIONS.GET_VERSION,
            undefined
          )
  ...
  getTypesInfo() {
    ...
    return (_classPrivateFieldGet3 = _classPrivateFieldGet(this, _tiCache)) !=
      null
  ...
  getVisitorKeys() {
    ...
    return (_classPrivateFieldGet4 = _classPrivateFieldGet(this, _vkCache)) !=
      null
  ...
  getTokLabels() {
    ...
    return (_classPrivateFieldGet5 = _classPrivateFieldGet(this, _tlCache)) !=
      null
    ...
    (_class = class WorkerClient extends Client {
      constructor() {
        super((action, payload) => {
          ...
          if (message.error)
            throw Object.assign(message.error, message.errorData);
          else return message.result;
        });

        _worker.set(this, {
          writable: true,
          value: new (_classStaticPrivateFieldSpecGet(
            WorkerClient,
            _class,
            _worker_threads
          ).Worker)(path.resolve(__dirname, "../lib/worker/index.cjs"), {
            env: _classStaticPrivateFieldSpecGet(
              WorkerClient,
              _class,
              _worker_threads
            ).SHARE_ENV,
...
function _get_worker_threads() {
  ...
  return (_classStaticPrivateFi2 = _classStaticPrivateFieldSpecGet(
    _class,
    _class,
    _worker_threads_cache
  )) != null
    ? _classStaticPrivateFi2
        ...
        constructor() {
          ...
          (_classStaticPrivateFi = _classStaticPrivateFieldSpecGet(
            ...
            : _classStaticPrivateFieldSpecSet(
                ...
                _class2,
                _handleMessage,
                require("./worker/handle-message.cjs")
              );
          super((action, payload) => {
            return _classStaticPrivateFieldSpecGet(
              ...
              LocalClient,
              action === ACTIONS.MAYBE_PARSE
                ? ACTIONS.MAYBE_PARSE_SYNC
                : action,
              payload
            );
          });
