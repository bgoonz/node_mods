...
function team([cmd, entity = "", user = ""], cb) {
  ...
  otplease(npmConfig(), (opts) => {
    ...
    switch (cmd) {
      case "create":
        return teamCreate(entity, opts);
      case "destroy":
        return teamDestroy(entity, opts);
      case "add":
        return teamAdd(entity, user, opts);
      case "rm":
        return teamRm(entity, user, opts);
      case "ls": {
