...
function errorMessage(er) {
  ...
  switch (er.code) {
    ...
    case "E404":
      ...
      if (er.pkgid && er.pkgid !== "-") {
        ...
        detail.push([
          "404",
          "",
          "'" + er.pkgid + "' is not in the npm registry.",
        ]);
        ...
        if (valResult.validForNewPackages) {
          ...
          var errorsArray = (valResult.errors || []).concat(
            valResult.warnings || []
          );
    ...
    case "ECYCLE":
      short.push([
        "cycle",
        [er.message, "While installing: " + er.pkgid].join("\n"),
      ]);
      detail.push([
        "cycle",
        [
    ...
    case "ENOPACKAGEJSON":
      ...
      detail.push([
        "package.json",
        ["npm can't find a package.json file in your current directory."].join(
          "\n"
        ),
      ]);
      break;
