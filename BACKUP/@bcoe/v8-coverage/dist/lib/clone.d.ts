 ...
 */
export declare function cloneProcessCov(
  processCov: Readonly<ProcessCov>
): ProcessCov;
/**
 ...
 */
export declare function cloneScriptCov(
  scriptCov: Readonly<ScriptCov>
): ScriptCov;
/**
 ...
 */
export declare function cloneFunctionCov(
