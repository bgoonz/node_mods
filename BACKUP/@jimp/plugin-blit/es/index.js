  ...
  return {
    ...
    blit: function blit(src, x, y, srcx, srcy, srcw, srch, cb) {
      ...
      if (typeof srcx === "function") {
        ...
        (0, _typeof2["default"])(srcx) === (0, _typeof2["default"])(srcy) &&
        (0, _typeof2["default"])(srcy) === (0, _typeof2["default"])(srcw) &&
        (0, _typeof2["default"])(srcw) === (0, _typeof2["default"])(srch)
      ) {
        srcx = srcx || 0;
        srcy = srcy || 0;
      ...
      src.scanQuiet(srcx, srcy, srcw, srch, function (sx, sy, idx) {
        ...
        if (
          ...
          baseImage.bitmap.data[dstIdx] =
            ((_src.a * (_src.r - dst.r) - dst.r + 255) >> 8) + dst.r;
          baseImage.bitmap.data[dstIdx + 1] =
            ((_src.a * (_src.g - dst.g) - dst.g + 255) >> 8) + dst.g;
          baseImage.bitmap.data[dstIdx + 2] =
            ((_src.a * (_src.b - dst.b) - dst.b + 255) >> 8) + dst.b;
