...
function processImport(filePath, cwd$1, predefinedImports, visitedFiles) {
  ...
  try {
    for (
      var _c = __values(set.values()), _d = _c.next();
      !_d.done;
      _d = _c.next()
    ) {
      var defs = _d.value;
      try {
        for (
          var defs_1 = ((e_2 = void 0), __values(defs)),
...
function visitFile(filePath, cwd, visitedFiles, predefinedImports) {
  ...
  if (!visitedFiles.has(filePath)) {
    ...
    try {
      for (
        var _l = __values(fileContent.split("\n")), _m = _l.next();
        !_m.done;
        _m = _l.next()
      ) {
        var line = _m.value;
    ...
    if (otherLines) {
      ...
      try {
        for (
          var _o = __values(document_1.definitions), _p = _o.next();
          !_p.done;
          _p = _o.next()
        ) {
          ...
          if (
            ...
            if ("fields" in definition) {
              try {
                for (
                  var _q = ((e_5 = void 0), __values(definition.fields)),
                    _r = _q.next();
                  !_r.done;
                  _r = _q.next()
                ) {
                  ...
                  definitionsSet_1.add(
                    __assign(__assign({}, definition), { fields: [field] })
                  );
      ...
      var _loop_1 = function (definitionName, definitions) {
        ...
        try {
          for (
            var definitions_1 = ((e_13 = void 0), __values(definitions)),
        ...
        try {
          for (
            var dependenciesOfDefinition_1 =
                ((e_14 = void 0), __values(dependenciesOfDefinition)),
      ...
      try {
        for (
          var definitionsByName_1 = __values(definitionsByName),
            definitionsByName_1_1 = definitionsByName_1.next();
          !definitionsByName_1_1.done;
          definitionsByName_1_1 = definitionsByName_1.next()
        ) {
          var _s = __read(definitionsByName_1_1.value, 2),
            definitionName = _s[0],
            definitions = _s[1];
    ...
    try {
      for (
        var importLines_1 = __values(importLines),
        ...
        if (imports.includes("*")) {
              ...
              try {
                for (
                  var importedDefinitions_1 =
                      ((e_9 = void 0), __values(importedDefinitions)),
          ...
          try {
            for (
              var imports_1 = ((e_10 = void 0), __values(imports)),
              ...
              var _w = __read(importedDefinitionName.split("."), 1),
              ...
              try {
                for (
                  var importedDefinitions_2 =
                      ((e_11 = void 0), __values(importedDefinitions)),
    ...
    if (!otherLines) {
      ...
      var addDefinition_1 = function (
        ...
        if (!definitionSet.has(definition)) {
          ...
          if ("fields" in definition) {
            ...
            try {
              for (
                var _b = __values(definition.fields), _c = _b.next();
                !_c.done;
                _c = _b.next()
              ) {
                var field = _c.value;
        ...
        try {
          for (
            var dependenciesOfDefinition_2 =
                ((e_16 = void 0), __values(dependenciesOfDefinition)),
      ...
      try {
        for (
          var definitionsByName_2 = __values(definitionsByName),
            definitionsByName_2_1 = definitionsByName_2.next();
          !definitionsByName_2_1.done;
          definitionsByName_2_1 = definitionsByName_2.next()
        ) {
          var _x = __read(definitionsByName_2_1.value, 1),
            definitionName = _x[0];
...
function parseImportLine(importLine) {
  if (IMPORT_FROM_REGEX.test(importLine)) {
    ...
    var _a = __read(importLine.match(IMPORT_FROM_REGEX), 5),
      wildcard = _a[1],
      importsString = _a[2],
      from = _a[4];
    if (from) {
    ...
    var _b = __read(importLine.match(IMPORT_DEFAULT_REGEX), 3),
      from = _b[2];
    if (from) {
