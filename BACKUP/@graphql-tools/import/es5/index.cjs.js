...
function processImport(filePath, cwd, predefinedImports, visitedFiles) {
  ...
  if (predefinedImports === void 0) {
    predefinedImports = {};
  }
  if (visitedFiles === void 0) {
    visitedFiles = new Map();
  }
  var set = visitFile(
    filePath,
    path.join(cwd + "/root.graphql"),
    visitedFiles,
    predefinedImports
  );
  ...
  try {
    for (
      var _c = tslib.__values(set.values()), _d = _c.next();
      !_d.done;
      _d = _c.next()
    ) {
      var defs = _d.value;
      try {
        for (
          var defs_1 = ((e_2 = void 0), tslib.__values(defs)),
  ...
  return (
    definitionsStr === null || definitionsStr === void 0
      ? void 0
      : definitionsStr.length
  )
...
function visitFile(filePath, cwd, visitedFiles, predefinedImports) {
  ...
  if (!visitedFiles.has(filePath)) {
    var fileContent =
      filePath in predefinedImports
        ? predefinedImports[filePath]
        : fs.readFileSync(filePath, "utf8");
    var importLines = [];
    var otherLines = "";
    try {
      for (
        var _l = tslib.__values(fileContent.split("\n")), _m = _l.next();
        !_m.done;
        _m = _l.next()
      ) {
        var line = _m.value;
    ...
    if (otherLines) {
      ...
      try {
        for (
          var _o = tslib.__values(document_1.definitions), _p = _o.next();
          !_p.done;
          _p = _o.next()
        ) {
          ...
          if (
            "name" in definition ||
            definition.kind === graphql.Kind.SCHEMA_DEFINITION
          ) {
            var definitionName =
              "name" in definition ? definition.name.value : "schema";
            ...
            var dependencySet =
              dependenciesByDefinitionName_1.get(definitionName);
            switch (definition.kind) {
              ...
              case graphql.Kind.OBJECT_TYPE_DEFINITION:
                visitObjectTypeDefinitionNode(
                  definition,
                  dependencySet,
                  dependenciesByDefinitionName_1
                );
                break;
            ...
            if ("fields" in definition) {
              try {
                for (
                  var _q = ((e_5 = void 0), tslib.__values(definition.fields)),
                    _r = _q.next();
                  !_r.done;
                  _r = _q.next()
                ) {
                  var field = _r.value;
                  var definitionName_1 =
                  ...
                  var definitionsSet_1 =
                    definitionsByName.get(definitionName_1);
                  definitionsSet_1.add(
                    tslib.__assign(tslib.__assign({}, definition), {
                      fields: [field],
                    })
                  );
                  if (!dependenciesByDefinitionName_1.has(definitionName_1)) {
                    dependenciesByDefinitionName_1.set(
                      definitionName_1,
                      new Set()
                    );
                  }
                  var dependencySet_1 =
                    dependenciesByDefinitionName_1.get(definitionName_1);
                  switch (field.kind) {
      ...
      var _loop_1 = function (definitionName, definitions) {
        ...
        try {
          for (
            var definitions_1 = ((e_13 = void 0), tslib.__values(definitions)),
              definitions_1_1 = definitions_1.next();
            !definitions_1_1.done;
            definitions_1_1 = definitions_1.next()
          ) {
          ...
          try {
            if (
              definitions_1_1 &&
              !definitions_1_1.done &&
              (_y = definitions_1.return)
            )
              _y.call(definitions_1);
          } finally {
        ...
        try {
          for (
            var dependenciesOfDefinition_1 =
                ((e_14 = void 0), tslib.__values(dependenciesOfDefinition)),
              dependenciesOfDefinition_1_1 = dependenciesOfDefinition_1.next();
            !dependenciesOfDefinition_1_1.done;
            dependenciesOfDefinition_1_1 = dependenciesOfDefinition_1.next()
          ) {
            var dependencyName = dependenciesOfDefinition_1_1.value;
            var dependencyDefinitions = definitionsByName.get(dependencyName);
            dependencyDefinitions === null || dependencyDefinitions === void 0
              ? void 0
              : dependencyDefinitions.forEach(function (dependencyDefinition) {
          ...
          try {
            if (
              dependenciesOfDefinition_1_1 &&
              !dependenciesOfDefinition_1_1.done &&
              (_z = dependenciesOfDefinition_1.return)
            )
              _z.call(dependenciesOfDefinition_1);
          } finally {
      ...
      try {
        for (
          var definitionsByName_1 = tslib.__values(definitionsByName),
            definitionsByName_1_1 = definitionsByName_1.next();
          !definitionsByName_1_1.done;
          definitionsByName_1_1 = definitionsByName_1.next()
        ) {
          var _s = tslib.__read(definitionsByName_1_1.value, 2),
            definitionName = _s[0],
            definitions = _s[1];
        ...
        try {
          if (
            definitionsByName_1_1 &&
            !definitionsByName_1_1.done &&
            (_d = definitionsByName_1.return)
          )
            _d.call(definitionsByName_1);
        } finally {
    ...
    try {
      for (
        var importLines_1 = tslib.__values(importLines),
          importLines_1_1 = importLines_1.next();
        !importLines_1_1.done;
        importLines_1_1 = importLines_1.next()
      ) {
        var line = importLines_1_1.value;
        var _t = parseImportLine(line.replace("#", "").trim()),
          imports = _t.imports,
          from = _t.from;
        var importFileDefinitionMap = visitFile(
          from,
          filePath,
          visitedFiles,
          predefinedImports
        ...
        if (imports.includes("*")) {
          try {
            for (
              var importFileDefinitionMap_1 =
                  ((e_8 = void 0), tslib.__values(importFileDefinitionMap)),
                importFileDefinitionMap_1_1 = importFileDefinitionMap_1.next();
              !importFileDefinitionMap_1_1.done;
              importFileDefinitionMap_1_1 = importFileDefinitionMap_1.next()
            ) {
              var _u = tslib.__read(importFileDefinitionMap_1_1.value, 2),
                importedDefinitionName = _u[0],
                importedDefinitions = _u[1];
              var _v = tslib.__read(importedDefinitionName.split("."), 1),
                importedDefinitionTypeName = _v[0];
              if (
                !allImportedDefinitionsMap_1.has(importedDefinitionTypeName)
              ) {
                allImportedDefinitionsMap_1.set(
                  importedDefinitionTypeName,
                  new Set()
                );
              }
              var allImportedDefinitions = allImportedDefinitionsMap_1.get(
                importedDefinitionTypeName
              );
              try {
                for (
                  var importedDefinitions_1 =
                      ((e_9 = void 0), tslib.__values(importedDefinitions)),
                    importedDefinitions_1_1 = importedDefinitions_1.next();
                  !importedDefinitions_1_1.done;
                  importedDefinitions_1_1 = importedDefinitions_1.next()
                ) {
                ...
                try {
                  if (
                    importedDefinitions_1_1 &&
                    !importedDefinitions_1_1.done &&
                    (_g = importedDefinitions_1.return)
                  )
                    _g.call(importedDefinitions_1);
                } finally {
            ...
            try {
              if (
                importFileDefinitionMap_1_1 &&
                !importFileDefinitionMap_1_1.done &&
                (_f = importFileDefinitionMap_1.return)
              )
                _f.call(importFileDefinitionMap_1);
            } finally {
          ...
          try {
            for (
              var imports_1 = ((e_10 = void 0), tslib.__values(imports)),
              ...
              var _w = tslib.__read(importedDefinitionName.split("."), 1),
                importedDefinitionTypeName = _w[0];
              if (
                !allImportedDefinitionsMap_1.has(importedDefinitionTypeName)
              ) {
                allImportedDefinitionsMap_1.set(
              ...
              var importedDefinitions = importFileDefinitionMap.get(
                importedDefinitionName
              );
              ...
              try {
                for (
                  var importedDefinitions_2 =
                      ((e_11 = void 0), tslib.__values(importedDefinitions)),
                    importedDefinitions_2_1 = importedDefinitions_2.next();
                  !importedDefinitions_2_1.done;
                  importedDefinitions_2_1 = importedDefinitions_2.next()
                ) {
                ...
                try {
                  if (
                    importedDefinitions_2_1 &&
                    !importedDefinitions_2_1.done &&
                    (_j = importedDefinitions_2.return)
                  )
                    _j.call(importedDefinitions_2);
                } finally {
            ...
            try {
              if (imports_1_1 && !imports_1_1.done && (_h = imports_1.return))
                _h.call(imports_1);
            } finally {
      ...
      try {
        if (
          importLines_1_1 &&
          !importLines_1_1.done &&
          (_e = importLines_1.return)
        )
          _e.call(importLines_1);
      } finally {
    ...
    if (!otherLines) {
        ...
        if (!definitionSet.has(definition)) {
          ...
          if ("fields" in definition) {
            var _loop_3 = function (field) {
              ...
              var allImportedDefinitions =
                allImportedDefinitionsMap_1.get(definitionName);
              allImportedDefinitions === null ||
              allImportedDefinitions === void 0
                ? void 0
                : allImportedDefinitions.forEach(function (importedDefinition) {
                    if (!fileDefinitionMap_1.has(fieldDefinitionName)) {
                      fileDefinitionMap_1.set(fieldDefinitionName, new Set());
                    }
                    var definitionsWithDeps =
                      fileDefinitionMap_1.get(fieldDefinitionName);
                    addDefinition_1(
                      importedDefinition,
                      fieldDefinitionName,
                      definitionsWithDeps
              ...
              newDependencySet.forEach(function (dependencyName) {
                var definitionsInCurrentFile =
                  fileDefinitionMap_1.get(dependencyName);
                definitionsInCurrentFile === null ||
                definitionsInCurrentFile === void 0
                  ? void 0
                  : definitionsInCurrentFile.forEach(function (def) {
                      return addDefinition_1(
                        def,
                        definitionName,
                        definitionSet
                      );
                    });
                var definitionsFromImports =
                  allImportedDefinitionsMap_1.get(dependencyName);
                definitionsFromImports === null ||
                definitionsFromImports === void 0
                  ? void 0
                  : definitionsFromImports.forEach(function (def) {
                      return addDefinition_1(
                        def,
                        definitionName,
                        definitionSet
            ...
            try {
              for (
                var _b = tslib.__values(definition.fields), _c = _b.next();
                !_c.done;
                _c = _b.next()
              ) {
                var field = _c.value;
      ...
      var _loop_2 = function (definitionName) {
        var e_16, _0;
        var definitionsWithDependencies =
          fileDefinitionMap_1.get(definitionName);
        var allImportedDefinitions =
          allImportedDefinitionsMap_1.get(definitionName);
        allImportedDefinitions === null || allImportedDefinitions === void 0
          ? void 0
          : allImportedDefinitions.forEach(function (importedDefinition) {
              addDefinition_1(
                importedDefinition,
        ...
        try {
          for (
            var dependenciesOfDefinition_2 =
                ((e_16 = void 0), tslib.__values(dependenciesOfDefinition)),
              dependenciesOfDefinition_2_1 = dependenciesOfDefinition_2.next();
            !dependenciesOfDefinition_2_1.done;
            dependenciesOfDefinition_2_1 = dependenciesOfDefinition_2.next()
          ) {
            ...
            if (
              !allImportedDefinitionsMap_1.has(dependencyName) &&
            ...
            var dependencyDefinitionsFromImports =
              allImportedDefinitionsMap_1.get(dependencyName);
            dependencyDefinitionsFromImports === null ||
            dependencyDefinitionsFromImports === void 0
              ? void 0
              : dependencyDefinitionsFromImports.forEach(function (
          ...
          try {
            if (
              dependenciesOfDefinition_2_1 &&
              !dependenciesOfDefinition_2_1.done &&
              (_0 = dependenciesOfDefinition_2.return)
            )
              _0.call(dependenciesOfDefinition_2);
          } finally {
      ...
      try {
        for (
          var definitionsByName_2 = tslib.__values(definitionsByName),
            definitionsByName_2_1 = definitionsByName_2.next();
          !definitionsByName_2_1.done;
          definitionsByName_2_1 = definitionsByName_2.next()
        ) {
          var _x = tslib.__read(definitionsByName_2_1.value, 1),
            definitionName = _x[0];
        ...
        try {
          if (
            definitionsByName_2_1 &&
            !definitionsByName_2_1.done &&
            (_k = definitionsByName_2.return)
          )
            _k.call(definitionsByName_2);
        } finally {
...
function parseImportLine(importLine) {
  if (IMPORT_FROM_REGEX.test(importLine)) {
    ...
    var _a = tslib.__read(importLine.match(IMPORT_FROM_REGEX), 5),
      wildcard = _a[1],
      importsString = _a[2],
      from = _a[4];
    if (from) {
      ...
      var imports =
        wildcard === "*"
          ? ["*"]
          : importsString.split(",").map(function (d) {
              return d.trim();
            });
    ...
    var _b = tslib.__read(importLine.match(IMPORT_DEFAULT_REGEX), 3),
      from = _b[2];
    if (from) {
...
function visitOperationDefinitionNode(node, dependencySet) {
  ...
  node.selectionSet.selections.forEach(function (selectionNode) {
    return visitSelectionNode(selectionNode, dependencySet);
  });
}
...
function visitFieldNode(node, dependencySet) {
  var _a;
  (_a = node.selectionSet) === null || _a === void 0
    ? void 0
    : _a.selections.forEach(function (selectionNode) {
        return visitSelectionNode(selectionNode, dependencySet);
      });
}
...
function visitObjectTypeDefinitionNode(
  ...
  (_a = node.directives) === null || _a === void 0
    ? void 0
    : _a.forEach(function (directiveNode) {
        return visitDirectiveNode(directiveNode, dependencySet);
      });
  (_b = node.fields) === null || _b === void 0
    ? void 0
    : _b.forEach(function (fieldDefinitionNode) {
        return visitFieldDefinitionNode(fieldDefinitionNode, dependencySet);
      });
  (_c = node.interfaces) === null || _c === void 0
    ? void 0
    : _c.forEach(function (namedTypeNode) {
...
function visitFieldDefinitionNode(
  ...
  var _a, _b;
  (_a = node.arguments) === null || _a === void 0
    ? void 0
    : _a.forEach(function (inputValueDefinitionNode) {
        return visitInputValueDefinitionNode(
          inputValueDefinitionNode,
          dependencySet
        );
      });
  (_b = node.directives) === null || _b === void 0
    ? void 0
    : _b.forEach(function (directiveNode) {
        return visitDirectiveNode(directiveNode, dependencySet);
      });
...
function visitUnionTypeDefinitionNode(node, dependencySet) {
  ...
  node.types.forEach(function (namedTypeNode) {
    return visitNamedTypeNode(namedTypeNode, dependencySet);
  });
}
...
function visitInputObjectTypeDefinitionNode(
  ...
  (_b = node.fields) === null || _b === void 0
    ? void 0
    : _b.forEach(function (inputValueDefinitionNode) {
        return visitInputValueDefinitionNode(
          inputValueDefinitionNode,
          dependencySet
        );
...
function visitSchemaDefinitionNode(node, dependencySet) {
  ...
  node.operationTypes.forEach(function (operationTypeDefinitionNode) {
    return visitOperationTypeDefinitionNode(
