    ...
    if (otherLines) {
      ...
      for (const definition of document.definitions) {
        if (
          ...
          const dependencySet =
            dependenciesByDefinitionName.get(definitionName);
      ...
      for (const [definitionName, definitions] of definitionsByName) {
        ...
        const definitionsWithDependencies =
          fileDefinitionMap.get(definitionName);
    ...
    for (const line of importLines) {
      ...
      if (imports.includes("*")) {
        for (const [
          ...
          importedDefinitions,
        ] of importFileDefinitionMap) {
          const [importedDefinitionTypeName] =
            importedDefinitionName.split(".");
          if (!allImportedDefinitionsMap.has(importedDefinitionTypeName)) {
            allImportedDefinitionsMap.set(
              importedDefinitionTypeName,
              new Set()
            );
          }
          const allImportedDefinitions = allImportedDefinitionsMap.get(
            importedDefinitionTypeName
          );
        ...
        for (let importedDefinitionName of imports) {
          ...
          const importedDefinitions = importFileDefinitionMap.get(
            importedDefinitionName
          );
        ...
        if (!definitionSet.has(definition)) {
          ...
          if ("fields" in definition) {
            for (const field of definition.fields) {
              ...
              const fieldDefinitionName =
                definition.name.value + "." + fieldName;
              const allImportedDefinitions =
                allImportedDefinitionsMap.get(definitionName);
              ...
              newDependencySet.forEach((dependencyName) => {
                const definitionsInCurrentFile =
                  fileDefinitionMap.get(dependencyName);
      ...
      for (const [definitionName] of definitionsByName) {
        ...
        for (const dependencyName of dependenciesOfDefinition) {
          ...
          dependencyDefinitionsFromImports === void 0
            ? void 0
            : dependencyDefinitionsFromImports.forEach(
...
function parseImportLine(importLine) {
  if (IMPORT_FROM_REGEX.test(importLine)) {
    ...
    const [, wildcard, importsString, , from] =
      importLine.match(IMPORT_FROM_REGEX);
    if (from) {
      // Extract imported types
      const imports =
        wildcard === "*"
          ? ["*"]
          : importsString.split(",").map((d) => d.trim());
...
function visitFieldNode(node, dependencySet) {
  ...
  (_a = node.selectionSet) === null || _a === void 0
    ? void 0
    : _a.selections.forEach((selectionNode) =>
        visitSelectionNode(selectionNode, dependencySet)
      );
}
...
function visitObjectTypeDefinitionNode(
  ...
  (_a = node.directives) === null || _a === void 0
    ? void 0
    : _a.forEach((directiveNode) =>
        visitDirectiveNode(directiveNode, dependencySet)
      );
  (_b = node.fields) === null || _b === void 0
    ? void 0
    : _b.forEach((fieldDefinitionNode) =>
        visitFieldDefinitionNode(fieldDefinitionNode, dependencySet)
      );
  (_c = node.interfaces) === null || _c === void 0
    ? void 0
    : _c.forEach((namedTypeNode) => {
...
function visitFieldDefinitionNode(
  ...
  (_a = node.arguments) === null || _a === void 0
    ? void 0
    : _a.forEach((inputValueDefinitionNode) =>
        visitInputValueDefinitionNode(inputValueDefinitionNode, dependencySet)
      );
  (_b = node.directives) === null || _b === void 0
    ? void 0
    : _b.forEach((directiveNode) =>
        visitDirectiveNode(directiveNode, dependencySet)
      );
...
function visitUnionTypeDefinitionNode(node, dependencySet) {
  ...
  node.types.forEach((namedTypeNode) =>
    visitNamedTypeNode(namedTypeNode, dependencySet)
  );
}
...
function visitInputObjectTypeDefinitionNode(
  ...
  (_b = node.fields) === null || _b === void 0
    ? void 0
    : _b.forEach((inputValueDefinitionNode) =>
        visitInputValueDefinitionNode(inputValueDefinitionNode, dependencySet)
      );
}
