...
export declare function parseGraphQLSDL(
  location: string,
  rawSDL: string,
...
export declare function transformCommentsToDescriptions(
  sourceSdl: string,
  options?: GraphQLParseOptions
): DocumentNode | null;
declare type DiscriminateUnion<T, U> = T extends U ? T : never;
declare type DescribableASTNodes = DiscriminateUnion<
  ASTNode,
  {
    description?: StringValueNode;
  }
>;
export declare function isDescribable(
  node: ASTNode
