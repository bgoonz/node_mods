...
function formatObjectValue(value, previouslySeenValues) {
  ...
  var seenValues = __spreadArray(
    __spreadArray([], __read(previouslySeenValues)),
    [value]
  );
...
function getArgumentValues(def, node, variableValues) {
  ...
  try {
    for (
      var _c = __values(def.args), _d = _c.next();
      !_d.done;
      _d = _c.next()
    ) {
      var argDef = _d.value;
...
function getDirectives(schema, node, pathToDirectivesInExtensions) {
  ...
  if ("extensionASTNodes" in node && node.extensionASTNodes) {
    astNodes = __spreadArray(
      __spreadArray([], __read(astNodes)),
      __read(node.extensionASTNodes)
    );
  }
  var result = {};
...
function getFieldsWithDirectives(documentNode, options) {
  ...
  if (options.includeInputTypes) {
    selected = __spreadArray(__spreadArray([], __read(selected)), [
  ...
  try {
    for (
      var allTypes_1 = __values(allTypes), allTypes_1_1 = allTypes_1.next();
      !allTypes_1_1.done;
      ...
      try {
        for (
          var _c = ((e_2 = void 0), __values(type.fields)), _d = _c.next();
          !_d.done;
          _d = _c.next()
        ) {
          var field = _d.value;
...
function getDocumentNodeFromSchema(schema, options) {
  ...
  try {
    for (
      var directives_1 = __values(directives),
...
function astFromSchema(schema, pathToDirectivesInExtensions) {
  ...
  var schemaNode = {
    kind:
      operationTypes != null ? Kind.SCHEMA_DEFINITION : Kind.SCHEMA_EXTENSION,
        ...
        case 0:
          ...
          documentFiles.forEach(function (documentFile) {
            ...
            if (documentFile.document) {
              try {
                for (
                  var _b = __values(documentFile.document.definitions),
                    _c = _b.next();
                  !_c.done;
                  _c = _b.next()
                ) {
                  ...
                  return __generator(this, function (_a) {
                    documentToValidate = {
                      ...
                      definitions: __spreadArray(
                        __spreadArray([], __read(allFragments)),
                        __read(documentFile.document.definitions)
...
function checkValidationErrors(loadDocumentErrors) {
  ...
  if (loadDocumentErrors.length > 0) {
    ...
    var _loop_1 = function (loadDocumentError) {
      ...
      try {
        for (
          var _c = ((e_3 = void 0), __values(loadDocumentError.errors)),
            _d = _c.next();
          !_d.done;
          _d = _c.next()
        ) {
    ...
    try {
      for (
        var loadDocumentErrors_1 = __values(loadDocumentErrors),
...
function buildFixedSchema(schema, options) {
  return buildSchema(
    ...
    __assign({ noLocation: true }, options || {})
  );
}
...
function transformCommentsToDescriptions(sourceSdl, options) {
  ...
  var parsedDoc = parse(
    sourceSdl,
    __assign(__assign({}, options), { noLocation: false })
  );
      ...
      if (isDescribable(node)) {
        ...
        if (rawValue !== undefined) {
          ...
          if (!node.description) {
            ...
            return __assign(__assign({}, node), {
              description: __assign(__assign({}, node.description), {
...
function buildOperationNodeForField(_a) {
  ...
  // attach variables
  operationNode.variableDefinitions = __spreadArray(
    [],
    __read(operationVariables)
  );
  resetOperationVariables();
  resetFieldMap();
      ...
      selections: types
        .filter(function (t) {
          return !hasCircularRef(
            __spreadArray(__spreadArray([], __read(ancestors)), [t]),
            {
    ...
    return {
      ...
      selections: Object.keys(fields_1)
        .filter(function (fieldName) {
          return !hasCircularRef(
            __spreadArray(__spreadArray([], __read(ancestors)), [
              getNamedType(fields_1[fieldName].type),
            ]),
            {
              depth: circularReferenceDepth,
            }
...
function getArgumentName(name, path) {
  return camelCase(
    __spreadArray(__spreadArray([], __read(path)), [name]).join("_")
  );
}
      ...
      ),
      {
        selectionSet:
          resolveSelectionSet({
            ...
            firstCall: firstCall,
            path: fieldPath,
            ancestors: __spreadArray(__spreadArray([], __read(ancestors)), [
              type,
            ]),
            ignore: ignore,
            depthLimit: depthLimit,
...
function mapSchema(schema, schemaMapper) {
  ...
  return new GraphQLSchema(
    __assign(__assign({}, schema.toConfig()), {
    ...
    (_a[MapperKind.ENUM_TYPE] = function (type) {
      ...
      Object.keys(originalEnumValueConfigMap).forEach(function (externalValue) {
        ...
        if (mappedEnumValue === undefined) {
          ...
          var _a = __read(mappedEnumValue, 2),
      ...
      return correctASTNodes(
        new GraphQLEnumType(
          __assign(__assign({}, config), { values: newEnumValueConfigMap })
        )
      );
    }),
    _a),
...
function mapDefaultValues(originalTypeMap, schema, fn) {
  ...
  var newTypeMap = mapArguments(
    ...
    (_a[MapperKind.ARGUMENT] = function (argumentConfig) {
      ...
      if (maybeNewType != null) {
        return __assign(__assign({}, argumentConfig), {
  ...
  return mapFields(
    ...
    (_b[MapperKind.INPUT_OBJECT_FIELD] = function (inputFieldConfig) {
      ...
      if (maybeNewType != null) {
        return __assign(__assign({}, inputFieldConfig), {
    ...
    if (!typeName.startsWith("__")) {
      ...
      Object.keys(originalFieldConfigMap_1).forEach(function (fieldName) {
        ...
        if (mappedField === undefined) {
          ...
          var _a = __read(mappedField, 2),
            newFieldName = _a[0],
            newFieldConfig = _a[1];
          if (newFieldConfig.astNode != null) {
            newFieldConfig.astNode = __assign(
              __assign({}, newFieldConfig.astNode),
              {
                name: __assign(__assign({}, newFieldConfig.astNode.name), {
                  value: newFieldName,
                }),
              }
            );
      ...
      if (isObjectType(originalType)) {
        newTypeMap[typeName] = correctASTNodes(
          new GraphQLObjectType(
            __assign(__assign({}, config), { fields: newFieldConfigMap_1 })
          )
        );
      ...
      Object.keys(originalFieldConfigMap_2).forEach(function (fieldName) {
        ...
        argumentNames.forEach(function (argumentName) {
          ...
          if (mappedArgument === undefined) {
            ...
            var _a = __read(mappedArgument, 2),
        ...
        newFieldConfigMap_2[fieldName] = __assign(
          __assign({}, originalFieldConfig),
          { args: newArgumentConfigMap }
        );
      });
      if (isObjectType(originalType)) {
        newTypeMap[typeName] = new GraphQLObjectType(
          __assign(__assign({}, config), { fields: newFieldConfigMap_2 })
        );
      } else if (isInterfaceType(originalType)) {
...
function correctASTNodes(type) {
  if (isObjectType(type)) {
    ...
    if (config.astNode != null) {
      ...
      config.astNode = __assign(__assign({}, config.astNode), {
        kind: Kind.OBJECT_TYPE_DEFINITION,
        fields: fields_1,
      });
    }
    ...
    if (config.extensionASTNodes != null) {
      config.extensionASTNodes = config.extensionASTNodes.map(function (node) {
        return __assign(__assign({}, node), { values: undefined });
      });
    }
  ...
  if (rootFieldFilter || argumentFilter) {
    ...
    Object.entries(config_1.fields).forEach(function (_a) {
      ...
      if (
        ...
        try {
          for (
            var _d = __values(Object.keys(field.args)), _e = _d.next();
            !_e.done;
            _e = _d.next()
          ) {
...
function cloneType(type) {
  if (isObjectType(type)) {
    ...
    return new GraphQLUnionType(
      __assign(__assign({}, config), { types: config.types.slice() })
    );
  } else if (isInputObjectType(type)) {
...
function healTypes(originalTypeMap, directives) {
  ...
  try {
    for (
      var _b = __values(Object.keys(originalTypeMap)), _c = _b.next();
      !_c.done;
      _c = _b.next()
    ) {
  ...
  function healFields(type) {
    ...
    try {
      for (
        var _b = __values(Object.entries(fieldMap)), _c = _b.next();
        !_c.done;
        _c = _b.next()
      ) {
    ...
    visitors.every(function (visitorOrVisitorDef) {
      ...
      if (isSchemaVisitor(visitorOrVisitorDef)) {
        newType = visitorOrVisitorDef[methodName].apply(
          visitorOrVisitorDef,
          __spreadArray([finalType], __read(args))
        );
      } else if (
  ...
  function visit(type) {
    ...
    if (isInputObjectType(type)) {
      ...
      if (newInputObject != null) {
        ...
        try {
          for (
            var _b = __values(Object.keys(fieldMap)), _c = _b.next();
            !_c.done;
            _c = _b.next()
          ) {
            var key = _c.value;
    ...
    if (isEnumType(type)) {
      ...
      if (newEnum_1 != null) {
        ...
        if (valuesUpdated) {
          newEnum_1 = new GraphQLEnumType(
            __assign(__assign({}, newEnum_1.toConfig()), {
  ...
  var newSchema = mapSchema(
    ...
    (_a[MapperKind.OBJECT_TYPE] = function (type) {
      if (type.name === typeName) {
        ...
        return correctASTNodes(
          new GraphQLObjectType(
            __assign(__assign({}, config), { fields: newFieldConfigMap_3 })
          )
        );
      }
    }),
...
function renameType(type, newTypeName) {
  if (isObjectType(type)) {
    return new GraphQLObjectType(
      __assign(__assign({}, type.toConfig()), {
        name: newTypeName,
        astNode:
          type.astNode == null
            ? type.astNode
            : __assign(__assign({}, type.astNode), {
                name: __assign(__assign({}, type.astNode.name), {
                  value: newTypeName,
                }),
              }),
        extensionASTNodes:
          type.extensionASTNodes == null
            ...
            : type.extensionASTNodes.map(function (node) {
                return __assign(__assign({}, node), {
                  name: __assign(__assign({}, node.name), {
                    value: newTypeName,
                  }),
                });
              }),
...
function collectFields(
  ...
  try {
    for (
      var _b = __values(selectionSet.selections), _c = _b.next();
      !_c.done;
      _c = _b.next()
    ) {
