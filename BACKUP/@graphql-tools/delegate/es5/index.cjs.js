...
function applySchemaTransforms(
...
var Subschema = /** @class */ (function () {
  function Subschema(config) {
    ...
    this.transforms =
      (_a = config.transforms) !== null && _a !== void 0 ? _a : [];
...
function createRequestFromInfo(_a) {
  var info = _a.info,
    ...
    _b = _a.operation,
    operation =
      _b === void 0 ? getDelegatingOperation(info.parentType, info.schema) : _b,
    _c = _a.fieldName,
    fieldName = _c === void 0 ? info.fieldName : _c,
    selectionSet = _a.selectionSet,
    _d = _a.fieldNodes,
    fieldNodes = _d === void 0 ? info.fieldNodes : _d;
...
function createRequest(_a) {
  ...
  var sourceSchema = _a.sourceSchema,
    ...
    targetOperationName = _a.targetOperationName,
  ...
  if (selectionSet != null) {
    ...
    argumentNodeMap = {};
    var args =
      (_b = fieldNodes[0]) === null || _b === void 0 ? void 0 : _b.arguments;
    if (args) {
      argumentNodeMap = args.reduce(function (prev, curr) {
        var _a;
        return tslib.__assign(
          tslib.__assign({}, prev),
          ((_a = {}), (_a[curr.name.value] = curr), _a)
        );
      }, argumentNodeMap);
    }
  }
  ...
  if (sourceSchema != null && variableDefinitions != null) {
    variableDefinitions.forEach(function (def) {
      ...
      var serializedValue = utils.serializeInputValue(
        varType,
  ...
  if (fragments != null) {
    definitions = definitions.concat(
      Object.keys(fragments).map(function (fragmentName) {
...
function getSubschema(object, responseKey) {
  var _a;
  return (_a = object[FIELD_SUBSCHEMA_MAP_SYMBOL][responseKey]) !== null &&
    _a !== void 0
    ? _a
...
function mergeExternalObjects(
  ...
  sources.forEach(function (source, index) {
    if (source instanceof Error || source === null) {
      ...
      var fieldNodes_1 = utils.collectFields(
        {
          schema: schema,
          variableValues: {},
          fragments: {},
      ...
      Object.keys(fieldNodes_1).forEach(function (responseKey) {
        if (source instanceof graphql.GraphQLError) {
          nullResult_1[responseKey] = utils.relocatedError(
            source,
            path.concat([responseKey])
          );
        } else if (source instanceof Error) {
          nullResult_1[responseKey] = graphql.locatedError(
            source,
            fieldNodes_1[responseKey],
            path.concat([responseKey])
          );
        } else {
  ...
  var combinedResult = results.reduce(utils.mergeDeep, target);
  var newFieldSubschemaMap =
    (_a = target[FIELD_SUBSCHEMA_MAP_SYMBOL]) !== null && _a !== void 0
      ? _a
      : Object.create(null);
    ...
    if (fieldSubschemaMap === undefined) {
      ...
      Object.keys(source).forEach(function (responseKey) {
        ...
        newFieldSubschemaMap[responseKey] =
          (_a = fieldSubschemaMap[responseKey]) !== null && _a !== void 0
            ? _a
            : objectSubschema;
      });
    }
  ...
  combinedResult[UNPATHED_ERRORS_SYMBOL] =
    target[UNPATHED_ERRORS_SYMBOL].concat(errors);
...
function cloneSubschemaConfig(subschemaConfig) {
  var newSubschemaConfig = tslib.__assign(tslib.__assign({}, subschemaConfig), {
    transforms:
      subschemaConfig.transforms != null
        ? tslib.__spreadArray([], tslib.__read(subschemaConfig.transforms))
        : undefined,
  });
  if (newSubschemaConfig.merge != null) {
    ...
    Object.keys(newSubschemaConfig.merge).forEach(function (typeName) {
      var mergedTypeConfig = (newSubschemaConfig.merge[typeName] =
        tslib.__assign({}, subschemaConfig.merge[typeName]));
      if (mergedTypeConfig.entryPoints != null) {
        mergedTypeConfig.entryPoints = mergedTypeConfig.entryPoints.map(
          function (entryPoint) {
            return tslib.__assign({}, entryPoint);
          }
        );
      }
      if (mergedTypeConfig.fields != null) {
        var fields_1 = (mergedTypeConfig.fields = tslib.__assign(
          {},
          mergedTypeConfig.fields
        ));
        Object.keys(fields_1).forEach(function (fieldName) {
          fields_1[fieldName] = tslib.__assign({}, fields_1[fieldName]);
        });
      }
    });
  }
...
function collectSubFields(info, typeName) {
  ...
  Object.keys(subFieldNodes).forEach(function (responseName) {
    ...
    var fieldSelectionSet =
      (_a =
        selectionSetsByField === null || selectionSetsByField === void 0
          ? void 0
          : selectionSetsByField[typeName]) === null || _a === void 0
        ? void 0
        : _a[fieldName];
...
var getFieldsNotInSubschema = memoizeInfoAnd2Objects(function (
  info,
  subschema,
  mergedTypeInfo
) {
...
var sortSubschemasByProxiability = memoize4(function (
  mergedTypeInfo,
...
var buildDelegationPlan = memoize3(function (
  mergedTypeInfo,
  fieldNodes,
  proxiableSubschemas
) {
...
var combineSubschemas = memoize2(function (
  subschemaOrSubschemas,
  additionalSubschemas
) {
...
function mergeFields(
  ...
  var _a = sortSubschemasByProxiability(
      mergedTypeInfo,
      sourceSubschemaOrSourceSubschemas,
      targetSubschemas,
      fieldNodes
  ...
  var _b = buildDelegationPlan(mergedTypeInfo, fieldNodes, proxiableSubschemas),
    delegationMap = _b.delegationMap,
    unproxiableFieldNodes = _b.unproxiableFieldNodes;
  ...
  delegationMap.forEach(function (selectionSet, s) {
    ...
    var valueOrPromise$1 = new valueOrPromise.ValueOrPromise(function () {
      return resolver(object, context, info, s, selectionSet);
    }).catch(function (error) {
      return error;
    });
    resultMap.set(valueOrPromise$1, selectionSet);
  });
  return valueOrPromise.ValueOrPromise.all(Array.from(resultMap.keys()))
...
var subschemaTypesContainSelectionSet = memoize3(function (
  mergedTypeInfo,
  sourceSubschemaOrSourceSubschemas,
  selectionSet
) {
  if (Array.isArray(sourceSubschemaOrSourceSubschemas)) {
    return typesContainSelectionSet(
      sourceSubschemaOrSourceSubschemas.map(function (sourceSubschema) {
        return sourceSubschema.transformedSchema.getType(
  ...
  return typesContainSelectionSet(
    [
      sourceSubschemaOrSourceSubschemas.transformedSchema.getType(
        mergedTypeInfo.typeName
      ),
    ],
    selectionSet
...
function typesContainSelectionSet(types, selectionSet) {
  var e_1, _a;
  var fieldMaps = types.map(function (type) {
    return type.getFields();
  });
  var _loop_1 = function (selection) {
    if (selection.kind === graphql.Kind.FIELD) {
      var fields = fieldMaps
        .map(function (fieldMap) {
          return fieldMap[selection.name.value];
        })
      ...
      if (selection.selectionSet != null) {
        return {
          value: typesContainSelectionSet(
            fields.map(function (field) {
              return graphql.getNamedType(field.type);
            }),
...
function resolveExternalObject(
  ...
  var stitchingInfo =
    (_a =
      info === null || info === void 0 ? void 0 : info.schema.extensions) ===
      null || _a === void 0
      ? void 0
      : _a.stitchingInfo;
    ...
    if (resolvedType == null) {
      throw new Error(
        "Unable to resolve type '" +
          object.__typename +
          "'. Did you forget to include a transform that renames types? Did you delegate to the original subschema rather that the subschema config object containing the transform?"
      );
    }
...
function resolveExternalList(
  ...
  return list.map(function (listMember) {
    return resolveExternalListMember(
      graphql.getNullableType(type.ofType),
      listMember,
      unpathedErrors,
      subschema,
      context,
...
var VisitSelectionSets = /** @class */ (function () {
  ...
  VisitSelectionSets.prototype.transformRequest = function (
    originalRequest,
    delegationContext,
    _transformationContext
  ) {
    var document = visitSelectionSets(
      originalRequest,
...
function visitSelectionSets(request, schema, initialType, visitor) {
  ...
  var newDefinitions = operations.map(function (operation) {
    ...
    var fields = utils.collectFields(
      partialExecutionContext,
      type,
    ...
    return tslib.__assign(tslib.__assign({}, operation), {
      selectionSet: {
        kind: graphql.Kind.SELECTION_SET,
  ...
  return tslib.__assign(tslib.__assign({}, document), {
    definitions: newDefinitions,
  });
}

var AddSelectionSets = /** @class */ (function () {
  function AddSelectionSets(
    selectionSetsByType,
  ...
  AddSelectionSets.prototype.transformRequest = function (
    originalRequest,
    delegationContext,
    ...
    if (parentTypeName_1 in dynamicSelectionSetsByField) {
      node.selections.forEach(function (selection) {
        if (selection.kind === graphql.Kind.FIELD) {
          ...
          var dynamicSelectionSets =
            dynamicSelectionSetsByField[parentTypeName_1][name_2];
...
var ExpandAbstractTypes = /** @class */ (function () {
  ...
  ExpandAbstractTypes.prototype.transformRequest = function (
    originalRequest,
    delegationContext,
    _transformationContext
  ) {
    var targetSchema = delegationContext.targetSchema;
    var _a = extractPossibleTypes(delegationContext.info.schema, targetSchema),
      possibleTypesMap = _a.possibleTypesMap,
      interfaceExtensionsMap = _a.interfaceExtensionsMap;
    var reversePossibleTypesMap = flipMapping(possibleTypesMap);
    var document = expandAbstractTypes(
      targetSchema,
      possibleTypesMap,
  ...
  Object.keys(typeMap).forEach(function (typeName) {
    ...
    if (graphql.isAbstractType(type)) {
      ...
      if (
        ...
        graphql.isInterfaceType(targetType)
      ) {
...
function expandAbstractTypes(
  ...
  var newDocument = tslib.__assign(tslib.__assign({}, document), {
    definitions: tslib.__spreadArray(
      tslib.__spreadArray([], tslib.__read(operations)),
      tslib.__read(newFragments)
    ),
  });
          ...
          node.selections.forEach(function (selection) {
            if (selection.kind === graphql.Kind.INLINE_FRAGMENT) {
              if (selection.typeCondition != null) {
                var possibleTypes =
                  possibleTypesMap[selection.typeCondition.name.value];
                if (possibleTypes != null) {
              ...
              if (fragmentName in fragmentReplacements) {
                fragmentReplacements[fragmentName].forEach(function (
                  replacement
                ) {
...
var WrapConcreteTypes = /** @class */ (function () {
  ...
  WrapConcreteTypes.prototype.transformRequest = function (
    originalRequest,
    delegationContext,
    _transformationContext
  ) {
    var document = wrapConcreteTypes(
      delegationContext.returnType,
...
function wrapConcreteTypes(returnType, targetSchema, document) {
  ...
  var queryTypeName =
    (_b = targetSchema.getQueryType()) === null || _b === void 0
      ? void 0
      : _b.name;
  var mutationTypeName =
    (_c = targetSchema.getMutationType()) === null || _c === void 0
      ? void 0
      : _c.name;
  var subscriptionTypeName =
    (_d = targetSchema.getSubscriptionType()) === null || _d === void 0
      ? void 0
      : _d.name;
  var typeInfo = new graphql.TypeInfo(targetSchema);
...
var FilterToSchema = /** @class */ (function () {
  ...
  FilterToSchema.prototype.transformRequest = function (
    originalRequest,
    delegationContext,
    _transformationContext
  ) {
...
function filterToSchema(targetSchema, document, variables) {
  ...
  var validFragmentsWithType = validFragments.reduce(function (prev, fragment) {
    ...
    return tslib.__assign(
      tslib.__assign({}, prev),
      ((_a = {}),
      (_a[fragment.name.value] = targetSchema.getType(
  ...
  operations.forEach(function (operation) {
    ...
    var _b = collectFragmentVariables(
        targetSchema,
        fragmentSet,
        validFragments,
        validFragmentsWithType,
    ...
    var operationOrFragmentVariables = union(
...
function filterSelectionSet(schema, type, validFragments, selectionSet) {
  ...
  var filteredSelectionSet = graphql.visit(
    selectionSet,
    graphql.visitWithTypeInfo(
      typeInfo,
      ((_a = {}),
      (_a[graphql.Kind.FIELD] = {
        enter: function (node) {
          ...
          if (
            ...
            graphql.isInterfaceType(parentType)
          ) {
            ...
            var argNames_1 = (field.args != null ? field.args : []).map(
              function (arg) {
                return arg.name;
              }
            );
        ...
        leave: function (node) {
          ...
          if (
            graphql.isObjectType(resolvedType) ||
            graphql.isInterfaceType(resolvedType)
          ) {
            var selections =
...
var AddTypenameToAbstract = /** @class */ (function () {
  ...
  AddTypenameToAbstract.prototype.transformRequest = function (
    originalRequest,
    delegationContext,
    _transformationContext
  ) {
    var document = addTypenameToAbstract(
      delegationContext.targetSchema,
      originalRequest.document
    );
    return tslib.__assign(tslib.__assign({}, originalRequest), {
...
var CheckResultAndHandleErrors = /** @class */ (function () {
  ...
  CheckResultAndHandleErrors.prototype.transformResult = function (
    originalResult,
    delegationContext,
    _transformationContext
  ) {
...
function checkResultAndHandleErrors(
  ...
  if (responseKey === void 0) {
    responseKey = utils.getResponseKeyFromInfo(info);
  }
  if (returnType === void 0) {
    returnType = info.returnType;
  }
  var _a = mergeDataAndErrors(
      result.data == null ? undefined : result.data[responseKey],
      result.errors == null ? [] : result.errors,
      info ? graphql.responsePathAsArray(info.path) : undefined,
      onLocatedError
    ),
    data = _a.data,
    unpathedErrors = _a.unpathedErrors;
...
function mergeDataAndErrors(data, errors, path, onLocatedError, index) {
  ...
  if (data == null) {
    ...
    if (errors.length === 1) {
      ...
      return {
        data: utils.relocatedError(errors[0], newPath),
        unpathedErrors: [],
      };
    }
    var newError = graphql.locatedError(
  ...
  errors.forEach(function (error) {
    var _a;
    var pathSegment =
      (_a = error.path) === null || _a === void 0 ? void 0 : _a[index];
    if (pathSegment != null) {
...
var AddArgumentsAsVariables = /** @class */ (function () {
  ...
  AddArgumentsAsVariables.prototype.transformRequest = function (
    originalRequest,
    delegationContext,
    _transformationContext
  ) {
    var _a = addVariablesToRootField(
        delegationContext.targetSchema,
        originalRequest,
        this.args
      ),
...
function addVariablesToRootField(targetSchema, originalRequest, args) {
  ...
  var newOperations = operations.map(function (operation) {
    var variableDefinitionMap = operation.variableDefinitions.reduce(function (
      prev,
      def
    ) {
      var _a;
    ...
    operation.selectionSet.selections.forEach(function (selection) {
      ...
      if (selection.kind === graphql.Kind.FIELD) {
        var argumentNodes =
          (_a = selection.arguments) !== null && _a !== void 0 ? _a : [];
        ...
        newSelectionSet.push(
          tslib.__assign(tslib.__assign({}, selection), {
...
var Transformer = /** @class */ (function () {
  function Transformer(context, binding) {
    ...
    delegationTransforms.forEach(function (transform) {
      return _this.addTransform(transform, {});
    });
  }
  ...
  Transformer.prototype.transformRequest = function (originalRequest) {
    ...
    return this.transformations.reduce(function (request, transformation) {
      return transformation.transform.transformRequest != null
        ? transformation.transform.transformRequest(
            request,
            _this.delegationContext,
  ...
  Transformer.prototype.transformResult = function (originalResult) {
    ...
    return this.transformations.reduceRight(function (result, transformation) {
      return transformation.transform.transformResult != null
        ? transformation.transform.transformResult(
            result,
            _this.delegationContext,
            transformation.context
          )
...
function delegateToSchema(options) {
  var info = options.info,
    ...
    operation =
      _a === void 0 ? getDelegatingOperation(info.parentType, info.schema) : _a,
...
function delegateRequest(_a) {
  ...
  var request = _a.request,
    ...
    onLocatedError = _a.onLocatedError,
    context = _a.context,
    _e = _a.transforms,
  ...
  if (fieldName == null) {
    operationDefinition =
      operationDefinition !== null && operationDefinition !== void 0
        ? operationDefinition
  ...
  var _f = collectTargetParameters(
      subschemaOrSubschemaConfig,
      rootValue,
      info,
      transforms
    ),
    targetSchema = _f.targetSchema,
    targetRootValue = _f.targetRootValue,
    subschemaConfig = _f.subschemaConfig,
    allTransforms = _f.allTransforms;
  var delegationContext = {
    ...
    returnType:
      (_b =
        returnType !== null && returnType !== void 0
          ? returnType
          : info === null || info === void 0
          ? void 0
          : info.returnType) !== null && _b !== void 0
        ? _b
    ...
    transformedSchema:
      (_d =
        transformedSchema !== null && transformedSchema !== void 0
          ? transformedSchema
          : (_c = subschemaConfig) === null || _c === void 0
          ? void 0
          : _c.transformedSchema) !== null && _d !== void 0
        ? _d
        : targetSchema,
  ...
  if (targetOperation === "query" || targetOperation === "mutation") {
    var executor_1 =
      (subschemaConfig === null || subschemaConfig === void 0
        ? void 0
    ...
    if (
      subschemaConfig === null || subschemaConfig === void 0
        ? void 0
        : subschemaConfig.batch
    ) {
      var batchingOptions =
        subschemaConfig === null || subschemaConfig === void 0
          ? void 0
          : subschemaConfig.batchingOptions;
      executor_1 = batchExecute.getBatchingExecutor(
        context,
        executor_1,
        batchingOptions === null || batchingOptions === void 0
          ? void 0
    ...
    return new valueOrPromise.ValueOrPromise(function () {
      return executor_1(
        tslib.__assign(tslib.__assign({}, processedRequest), {
          context: context,
          info: info,
        })
      );
...
function collectTargetParameters(subschema, rootValue, info, transforms) {
  ...
  var subschemaOrSubschemaConfig =
    (_b =
      stitchingInfo === null || stitchingInfo === void 0
        ? void 0
        : stitchingInfo.subschemaMap.get(subschema)) !== null && _b !== void 0
      ? _b
      : subschema;
  if (isSubschemaConfig(subschemaOrSubschemaConfig)) {
    return {
      ...
      targetRootValue:
        (_d =
          (_c =
            rootValue !== null && rootValue !== void 0
              ? rootValue
              : subschemaOrSubschemaConfig === null ||
                subschemaOrSubschemaConfig === void 0
              ? void 0
              : subschemaOrSubschemaConfig.rootValue) !== null && _c !== void 0
            ? _c
            : info === null || info === void 0
            ? void 0
            : info.rootValue) !== null && _d !== void 0
          ? _d
          : emptyObject,
