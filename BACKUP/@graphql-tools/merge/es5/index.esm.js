...
function mergeResolvers(resolversDefinitions, options) {
  ...
  try {
    for (
      var resolversDefinitions_1 = __values(resolversDefinitions),
  ...
  if (resolversFactories.length) {
    result = function () {
      ...
      var resultsOfFactories = resolversFactories.map(function (factory) {
        return factory.apply(void 0, __spreadArray([], __read(args)));
      });
  ...
  if (options && options.exclusions) {
    try {
      for (
        var _c = __values(options.exclusions), _d = _c.next();
        !_d.done;
        _d = _c.next()
      ) {
        var exclusion = _d.value;
        var _e = __read(exclusion.split("."), 2),
          typeName = _e[0],
          fieldName = _e[1];
...
function addDescription(cb) {
  return function (node, _key, _parent, path, ancestors) {
    ...
    var key = __spreadArray(__spreadArray([], __read(keys)), [
      parent.name.value,
    ]).join(".");
    var items = [];
    ...
    return join(
      __spreadArray(__spreadArray([], __read(items.map(printComment))), [
        node.description,
        cb(node),
      ]),
      "\n"
...
function mergeArguments$1(a1, a2) {
  ...
  try {
    for (
      var a1_1 = __values(a1), a1_1_1 = a1_1.next();
      !a1_1_1.done;
      a1_1_1 = a1_1.next()
    ) {
...
function mergeDirectives(d1, d2, config) {
  ...
  try {
    for (
      var asFirst_1 = __values(asFirst), asFirst_1_1 = asFirst_1.next();
      !asFirst_1_1.done;
  ...
  if (existingNode) {
    ...
    return __assign(__assign({}, node), {
      locations: __spreadArray(
        __spreadArray([], __read(existingNode.locations)),
        __read(
...
function mergeEnumValues(first, second, config) {
  ...
  try {
    for (
      var first_1 = __values(first), first_1_1 = first_1.next();
      !first_1_1.done;
  ...
  try {
    for (
      var second_1 = __values(second), second_1_1 = second_1.next();
      !second_1_1.done;
...
function mergeEnum(e1, e2, config) {
  ...
  return config && config.convertExtensions
    ? __assign(__assign({}, e1), { kind: "EnumTypeDefinition" })
    : e1;
}
...
function extractType(type) {
  ...
  while (
    visitedType.kind === Kind.LIST_TYPE ||
...
function mergeFields(type, f1, f2, config) {
  ...
  try {
    for (
      var f1_1 = __values(f1), f1_1_1 = f1_1.next();
      !f1_1_1.done;
      f1_1_1 = f1_1.next()
    ) {
...
function mergeInputType(node, existingNode, config) {
  ...
  return config && config.convertExtensions
    ? __assign(__assign({}, node), { kind: "InputObjectTypeDefinition" })
    : node;
}
...
function mergeInterface(node, existingNode, config) {
  ...
  return config && config.convertExtensions
    ? __assign(__assign({}, node), { kind: "InterfaceTypeDefinition" })
    : node;
}
...
function mergeType(node, existingNode, config) {
  ...
  return config && config.convertExtensions
    ? __assign(__assign({}, node), { kind: "ObjectTypeDefinition" })
    : node;
}
...
function mergeScalar(node, existingNode, config) {
  ...
  return config && config.convertExtensions
    ? __assign(__assign({}, node), { kind: "ScalarTypeDefinition" })
    : node;
}
...
function mergeUnion(first, second, config) {
  ...
  return config && config.convertExtensions
    ? __assign(__assign({}, first), { kind: "UnionTypeDefinition" })
    : first;
}
...
function mergeSchemaDefs(node, existingNode, config) {
  ...
  return (
    ...
    ? __assign(__assign({}, node), { kind: Kind.SCHEMA_EXTENSION })
    : node;
}
...
function travelSchemaPossibleExtensions(schema, hooks) {
  ...
  try {
    for (
      var _h = __values(Object.entries(typesMap)), _j = _h.next();
      !_j.done;
      _j = _h.next()
    ) {
      ...
      if (isObjectType(type)) {
        ...
        try {
          for (
            var _l = ((e_2 = void 0), __values(Object.entries(fields))),
              _m = _l.next();
            !_m.done;
            _m = _l.next()
          ) {
            ...
            try {
              for (
                var args_1 = ((e_3 = void 0), __values(args)),
        ...
        try {
          for (
            var _p = ((e_4 = void 0), __values(Object.entries(fields))),
              _q = _p.next();
            !_q.done;
            _q = _p.next()
          ) {
            ...
            try {
              for (
                var args_2 = ((e_5 = void 0), __values(args)),
        ...
        try {
          for (
            var _s = ((e_6 = void 0), __values(Object.entries(fields))),
              _t = _s.next();
            !_t.done;
            _t = _s.next()
          ) {
        ...
        try {
          for (
            var _v = ((e_7 = void 0), __values(type.getValues())),
              _w = _v.next();
            !_w.done;
            _w = _v.next()
          ) {
...
function mergeExtensions(extensions) {
  return extensions.reduce(function (result, extensionObj) {
    return [result, extensionObj].reduce(mergeDeep, {});
  }, {});
}
...
function applyExtensions(schema, extensions) {
  ...
  try {
    for (
      var _f = __values(Object.entries(extensions.types || {})), _g = _f.next();
      !_g.done;
      _g = _f.next()
    ) {
      ...
      if (type) {
        ...
        if (data.type === "object" || data.type === "interface") {
          try {
            for (
              var _j = ((e_9 = void 0), __values(Object.entries(data.fields))),
                _k = _j.next();
              !_k.done;
              _k = _j.next()
            ) {
              ...
              if (field) {
                ...
                try {
                  for (
                    var _m =
                        ((e_10 = void 0),
                        __values(Object.entries(fieldData.arguments))),
                      _o = _m.next();
                    !_o.done;
                    _o = _m.next()
                  ) {
          ...
          try {
            for (
              var _q = ((e_11 = void 0), __values(Object.entries(data.fields))),
                _r = _q.next();
              !_r.done;
              _r = _q.next()
            ) {
              var _s = __read(_r.value, 2),
                fieldName = _s[0],
                fieldData = _s[1];
              var field = type.getFields()[fieldName];
              applyExtensionObject(field, fieldData.extensions);
          ...
          try {
            for (
              var _t = ((e_12 = void 0), __values(Object.entries(data.values))),
                _u = _t.next();
              !_u.done;
              _u = _t.next()
            ) {
              var _v = __read(_u.value, 2),
                valueName = _v[0],
                valueData = _v[1];
...
function mergeSchemas(config) {
  ...
  try {
    for (
      var _b = __values(config.schemas), _c = _b.next();
      !_c.done;
      _c = _b.next()
    ) {
      var schema = _c.value;
  ...
  extractedResolvers.push.apply(
    extractedResolvers,
    __spreadArray([], __read(ensureResolvers(config)))
  );
            ...
            Promise.all([
              ...
              Promise.all(
                ...
                return mergeResolvers(
                  __spreadArray(
                    __spreadArray([], __read(extractedResolvers)),
                    __read(ensureResolvers(config))
                  ),
                  config
                );
              }),
...
function mergeTypes(_a) {
  var schemas = _a.schemas,
    ...
    config = __rest(_a, ["schemas", "typeDefs"]);
  return mergeTypeDefs(
    __spreadArray(
      __spreadArray([], __read(schemas)),
      __read(typeDefs ? asArray(typeDefs) : [])
    ),
    config
  );
}
...
function makeSchema(_a, config) {
  ...
  var schema =
    typeof typeDefs === "string"
      ? buildSchema(typeDefs, config)
      : buildASTSchema(typeDefs, config);
  // add resolvers
  if (resolvers) {
    schema = addResolversToSchema({
      schema: schema,
      resolvers: resolvers,
      resolverValidationOptions: __assign(
        __assign({}, defaultResolverValidationOptions),
