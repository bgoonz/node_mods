...
export declare type PossibleTypeExtensions =
  | InputTypeExtensions
...
export declare function travelSchemaPossibleExtensions(
...
export declare function applyExtensions(
  schema: GraphQLSchema,
  extensions: SchemaExtensions
): GraphQLSchema;
export declare function extractExtensionsFromSchema(
  schema: GraphQLSchema
): SchemaExtensions;
