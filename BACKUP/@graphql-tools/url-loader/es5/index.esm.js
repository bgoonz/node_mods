...
var UrlLoader = /** @class */ (function () {
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          case 0:
            ...
            (_b = extractFiles(vars, "variables", function (v) {
              return (
                isExtractableFile(v) ||
  ...
  UrlLoader.prototype.buildExecutor = function (_a) {
    ...
    var executor = function (_a) {
      ...
      var document = _a.document,
        variables = _a.variables,
        rest = __rest(_a, ["document", "variables"]);
      ...
      if (useGETForQueries) {
        ...
        try {
          for (
            var _c = __values(document.definitions), _d = _c.next();
            !_d.done;
            _d = _c.next()
          ) {
      ...
      var headers = _this.getHeadersFromOptions(
        extraHeaders,
        __assign({ document: document, variables: variables }, rest)
      );
      var fetchResult;
                ...
                case 1:
                  ...
                  if (isAsyncIterable(maybeStream)) {
                    return [
                      2 /*return*/,
                      withCancel(
                        mapAsyncIterator(maybeStream, function (part) {
                          if (part.json) {
                            var chunk = part.body;
                            if (chunk.path) {
                              if (chunk.data) {
                                ...
                                merge(
                                  response,
                                  set({}, path.concat(chunk.path), chunk.data)
                                );
                              }
                              if (chunk.errors) {
                                response.errors = (
  ...
  UrlLoader.prototype.getFetch = function (customFetch, importFn, async) {
    if (customFetch) {
      if (typeof customFetch === "string") {
        var _a = __read(customFetch.split("#"), 2),
          moduleName = _a[0],
          fetchFnName_1 = _a[1];
    ...
    if (customHeaders) {
      ...
      if (Array.isArray(customHeaders)) {
        headers = customHeaders.reduce(function (prev, v) {
          return __assign(__assign({}, prev), v);
        }, {});
  ...
  UrlLoader.prototype.getWebSocketImpl = function (options, importFn) {
    if (
      ...
      var _a = __read(options.webSocketImpl.split("#"), 2),
        moduleName = _a[0],
      ...
      var asyncFetchFn = function () {
        ...
        return _this
          ...
          .then(function (asyncFetch) {
            return asyncFetch.apply(void 0, __spreadArray([], __read(args)));
          });
      };
      subscriber = this.buildSSESubscriber(
        subscriptionsEndpoint,
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              introspectSchema(executor, undefined, options),
            ];
          case 2:
            return [
              2 /*return*/,
