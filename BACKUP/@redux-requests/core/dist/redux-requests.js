(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else root["ReduxRequests"] = factory(root["Reselect"]);
  ...
  \************************/
        ...
        /***/ (
          ...
          /* harmony export */ __webpack_require__.d(__webpack_exports__, {
            ...
            /* harmony export */ createSuccessAction: () =>
              /* binding */ createSuccessAction,
            /* harmony export */ createErrorAction: () =>
              /* binding */ createErrorAction,
            /* harmony export */ createAbortAction: () =>
              /* binding */ createAbortAction,
            /* harmony export */ getActionPayload: () =>
              /* binding */ getActionPayload,
            /* harmony export */ getResponseFromSuccessAction: () =>
              /* binding */ getResponseFromSuccessAction,
            /* harmony export */ isRequestAction: () =>
              /* binding */ isRequestAction,
            /* harmony export */ isResponseAction: () =>
              /* binding */ isResponseAction,
            /* harmony export */ getRequestActionFromResponse: () =>
              /* binding */ getRequestActionFromResponse,
            /* harmony export */ isSuccessAction: () =>
              /* binding */ isSuccessAction,
            /* harmony export */ isErrorAction: () =>
              /* binding */ isErrorAction,
            /* harmony export */ isAbortAction: () =>
              /* binding */ isAbortAction,
            /* harmony export */ isRequestActionQuery: () =>
              /* binding */ isRequestActionQuery,
            /* harmony export */ clearRequestsCache: () =>
              /* binding */ clearRequestsCache,
            /* harmony export */ resetRequests: () =>
              /* binding */ resetRequests,
            /* harmony export */ abortRequests: () =>
              /* binding */ abortRequests,
            /* harmony export */ stopPolling: () => /* binding */ stopPolling,
            /* harmony export */ setDownloadProgress: () =>
              /* binding */ setDownloadProgress,
            /* harmony export */ setUploadProgress: () =>
              /* binding */ setUploadProgress,
            /* harmony export */ addWatcher: () => /* binding */ addWatcher,
            /* harmony export */ removeWatcher: () =>
              /* binding */ removeWatcher,
            /* harmony export */ joinRequest: () => /* binding */ joinRequest,
            /* harmony export */ websocketOpened: () =>
              /* binding */ websocketOpened,
            /* harmony export */ websocketClosed: () =>
              /* binding */ websocketClosed,
            /* harmony export */ getWebsocket: () => /* binding */ getWebsocket,
            /* harmony export */ openWebsocket: () =>
              /* binding */ openWebsocket,
            /* harmony export */ closeWebsocket: () =>
              /* binding */ closeWebsocket,
            /* harmony export */ stopSubscriptions: () =>
              /* binding */ stopSubscriptions,
            /* harmony export */
          });
          ...
          var success = getActionWithSuffix(
            _constants__WEBPACK_IMPORTED_MODULE_1__.SUCCESS_SUFFIX
          );
          var error = getActionWithSuffix(
            _constants__WEBPACK_IMPORTED_MODULE_1__.ERROR_SUFFIX
          );
          var abort = getActionWithSuffix(
            _constants__WEBPACK_IMPORTED_MODULE_1__.ABORT_SUFFIX
          );
          ...
          var createSuccessAction = function createSuccessAction(
            action,
            response
          ) {
          ...
          var createErrorAction = function createErrorAction(
            action,
            errorData
          ) {
            return _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()(
          ...
          var getResponseFromSuccessAction =
          ...
          var isResponseAction = function isResponseAction(action) {
            ...
            return !!(
              (_action$meta = action.meta) != null && _action$meta.requestAction
            );
          };
          var getRequestActionFromResponse =
          ...
          var setDownloadProgress = function setDownloadProgress(
            requestType,
            progress
          ) {
            return {
          ...
          var setUploadProgress = function setUploadProgress(
            requestType,
            progress
          ) {
            return {
  ...
  \**************************/
        ...
        /***/ (
          ...
          __webpack_require__.r(__webpack_exports__);
          /* harmony export */ __webpack_require__.d(__webpack_exports__, {
            /* harmony export */ SUCCESS_SUFFIX: () =>
              /* binding */ SUCCESS_SUFFIX,
            /* harmony export */ ERROR_SUFFIX: () => /* binding */ ERROR_SUFFIX,
            /* harmony export */ ABORT_SUFFIX: () => /* binding */ ABORT_SUFFIX,
            /* harmony export */ CLEAR_REQUESTS_CACHE: () =>
              /* binding */ CLEAR_REQUESTS_CACHE,
            /* harmony export */ RESET_REQUESTS: () =>
              /* binding */ RESET_REQUESTS,
            /* harmony export */ ABORT_REQUESTS: () =>
              /* binding */ ABORT_REQUESTS,
            /* harmony export */ SET_DOWNLOAD_PROGRESS: () =>
              /* binding */ SET_DOWNLOAD_PROGRESS,
            /* harmony export */ SET_UPLOAD_PROGRESS: () =>
              /* binding */ SET_UPLOAD_PROGRESS,
            /* harmony export */ ADD_WATCHER: () => /* binding */ ADD_WATCHER,
            /* harmony export */ REMOVE_WATCHER: () =>
              /* binding */ REMOVE_WATCHER,
            /* harmony export */ JOIN_REQUEST: () => /* binding */ JOIN_REQUEST,
            /* harmony export */ STOP_POLLING: () => /* binding */ STOP_POLLING,
            /* harmony export */ WEBSOCKET_OPENED: () =>
              /* binding */ WEBSOCKET_OPENED,
            /* harmony export */ WEBSOCKET_CLOSED: () =>
              /* binding */ WEBSOCKET_CLOSED,
            /* harmony export */ GET_WEBSOCKET: () =>
              /* binding */ GET_WEBSOCKET,
            /* harmony export */ OPEN_WEBSOCKET: () =>
              /* binding */ OPEN_WEBSOCKET,
            /* harmony export */ CLOSE_WEBSOCKET: () =>
              /* binding */ CLOSE_WEBSOCKET,
            /* harmony export */ STOP_SUBSCRIPTIONS: () =>
              /* binding */ STOP_SUBSCRIPTIONS,
            /* harmony export */
          });
  ...
  \*******************************/
        ...
        /***/ (
          ...
          /* harmony import */ var _actions__WEBPACK_IMPORTED_MODULE_0__ =
          ...
          /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = {
            ...
            isRequestAction:
              _actions__WEBPACK_IMPORTED_MODULE_0__.isRequestAction,
            isRequestActionQuery:
              _actions__WEBPACK_IMPORTED_MODULE_0__.isRequestActionQuery,
            takeLatest:
              _actions__WEBPACK_IMPORTED_MODULE_0__.isRequestActionQuery,
            normalize: false,
  ...
  \********************************/
        ...
        /***/ (
          ...
          /* harmony import */ var _reducers__WEBPACK_IMPORTED_MODULE_2__ =
            __webpack_require__(
              /*! ./reducers */ "./src/reducers/requests-reducer.js"
            );
          /* harmony import */ var _middleware__WEBPACK_IMPORTED_MODULE_3__ =
            __webpack_require__(
              /*! ./middleware */ "./src/middleware/create-subscriptions-middleware.js"
            );
          /* harmony import */ var _middleware__WEBPACK_IMPORTED_MODULE_4__ =
            __webpack_require__(
              /*! ./middleware */ "./src/middleware/create-polling-middleware.js"
            );
          /* harmony import */ var _middleware__WEBPACK_IMPORTED_MODULE_5__ =
            __webpack_require__(
              /*! ./middleware */ "./src/middleware/create-server-ssr-middleware.js"
            );
          /* harmony import */ var _middleware__WEBPACK_IMPORTED_MODULE_6__ =
            __webpack_require__(
              /*! ./middleware */ "./src/middleware/create-client-ssr-middleware.js"
            );
          /* harmony import */ var _middleware__WEBPACK_IMPORTED_MODULE_7__ =
            __webpack_require__(
              /*! ./middleware */ "./src/middleware/create-requests-cache-middleware.js"
            );
          /* harmony import */ var _middleware__WEBPACK_IMPORTED_MODULE_8__ =
            __webpack_require__(
              /*! ./middleware */ "./src/middleware/create-send-requests-middleware.js"
            );
          /* harmony import */ var _default_config__WEBPACK_IMPORTED_MODULE_1__ =
            __webpack_require__(
          ...
          var handleRequests = function handleRequests(userConfig) {
            var config =
              _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()(
                {},
                _default_config__WEBPACK_IMPORTED_MODULE_1__.default,
                userConfig
              );

            var requestsPromise =
              config.ssr === "server" && !config.disableRequestsPromise
                ? defer()
                : null;
            return {
              requestsReducer: (0,
              _reducers__WEBPACK_IMPORTED_MODULE_2__.default)(config),
              requestsMiddleware: [
                config.ssr !== "server" &&
                  config.subscriber &&
                  (0, _middleware__WEBPACK_IMPORTED_MODULE_3__.default)(config),
                config.ssr !== "server" &&
                  (0, _middleware__WEBPACK_IMPORTED_MODULE_4__.default)(config),
                config.ssr === "server" &&
                  !config.disableRequestsPromise &&
                  (0, _middleware__WEBPACK_IMPORTED_MODULE_5__.default)(
                    requestsPromise,
                    config
                  ),
                config.ssr === "client" &&
                  (0, _middleware__WEBPACK_IMPORTED_MODULE_6__.default)(config),
                config.cache &&
                  (0, _middleware__WEBPACK_IMPORTED_MODULE_7__.default)(config),
                (0, _middleware__WEBPACK_IMPORTED_MODULE_8__.default)(config),
              ].filter(Boolean),
  ...
  \**********************/
        ...
        /***/ (
          ...
          __webpack_require__.r(__webpack_exports__);
          /* harmony export */ __webpack_require__.d(__webpack_exports__, {
            /* harmony export */ success: () =>
              /* reexport safe */ _actions__WEBPACK_IMPORTED_MODULE_0__.success,
            /* harmony export */ error: () =>
              /* reexport safe */ _actions__WEBPACK_IMPORTED_MODULE_0__.error,
            /* harmony export */ abort: () =>
              /* reexport safe */ _actions__WEBPACK_IMPORTED_MODULE_0__.abort,
            /* harmony export */ clearRequestsCache: () =>
              /* reexport safe */ _actions__WEBPACK_IMPORTED_MODULE_0__.clearRequestsCache,
            /* harmony export */ resetRequests: () =>
              /* reexport safe */ _actions__WEBPACK_IMPORTED_MODULE_0__.resetRequests,
            /* harmony export */ stopPolling: () =>
              /* reexport safe */ _actions__WEBPACK_IMPORTED_MODULE_0__.stopPolling,
            /* harmony export */ abortRequests: () =>
              /* reexport safe */ _actions__WEBPACK_IMPORTED_MODULE_0__.abortRequests,
            /* harmony export */ isRequestActionQuery: () =>
              /* reexport safe */ _actions__WEBPACK_IMPORTED_MODULE_0__.isRequestActionQuery,
            /* harmony export */ isRequestAction: () =>
              /* reexport safe */ _actions__WEBPACK_IMPORTED_MODULE_0__.isRequestAction,
            /* harmony export */ isResponseAction: () =>
              /* reexport safe */ _actions__WEBPACK_IMPORTED_MODULE_0__.isResponseAction,
            /* harmony export */ addWatcher: () =>
              /* reexport safe */ _actions__WEBPACK_IMPORTED_MODULE_0__.addWatcher,
            /* harmony export */ removeWatcher: () =>
              /* reexport safe */ _actions__WEBPACK_IMPORTED_MODULE_0__.removeWatcher,
            /* harmony export */ joinRequest: () =>
              /* reexport safe */ _actions__WEBPACK_IMPORTED_MODULE_0__.joinRequest,
            /* harmony export */ stopSubscriptions: () =>
              /* reexport safe */ _actions__WEBPACK_IMPORTED_MODULE_0__.stopSubscriptions,
            /* harmony export */ openWebsocket: () =>
              /* reexport safe */ _actions__WEBPACK_IMPORTED_MODULE_0__.openWebsocket,
            /* harmony export */ closeWebsocket: () =>
              /* reexport safe */ _actions__WEBPACK_IMPORTED_MODULE_0__.closeWebsocket,
            /* harmony export */ handleRequests: () =>
              /* reexport safe */ _handle_requests__WEBPACK_IMPORTED_MODULE_1__.default,
            /* harmony export */ getQuery: () =>
              /* reexport safe */ _selectors__WEBPACK_IMPORTED_MODULE_2__.default,
            /* harmony export */ getMutation: () =>
              /* reexport safe */ _selectors__WEBPACK_IMPORTED_MODULE_3__.default,
            /* harmony export */ getQuerySelector: () =>
              /* reexport safe */ _selectors__WEBPACK_IMPORTED_MODULE_4__.default,
            /* harmony export */ getMutationSelector: () =>
              /* reexport safe */ _selectors__WEBPACK_IMPORTED_MODULE_5__.default,
            /* harmony export */ getWebsocketState: () =>
              /* reexport safe */ _selectors__WEBPACK_IMPORTED_MODULE_6__.default,
            /* harmony export */ createRequestsStore: () =>
              /* reexport safe */ _middleware__WEBPACK_IMPORTED_MODULE_7__.default,
            /* harmony export */
          });
          /* harmony import */ var _actions__WEBPACK_IMPORTED_MODULE_0__ =
            __webpack_require__(/*! ./actions */ "./src/actions.js");
          /* harmony import */ var _handle_requests__WEBPACK_IMPORTED_MODULE_1__ =
            __webpack_require__(
              /*! ./handle-requests */ "./src/handle-requests.js"
            );
          /* harmony import */ var _selectors__WEBPACK_IMPORTED_MODULE_2__ =
            __webpack_require__(
              /*! ./selectors */ "./src/selectors/get-query.js"
            );
          /* harmony import */ var _selectors__WEBPACK_IMPORTED_MODULE_3__ =
            __webpack_require__(
              /*! ./selectors */ "./src/selectors/get-mutation.js"
            );
          /* harmony import */ var _selectors__WEBPACK_IMPORTED_MODULE_4__ =
            __webpack_require__(
              /*! ./selectors */ "./src/selectors/get-query-selector.js"
            );
          /* harmony import */ var _selectors__WEBPACK_IMPORTED_MODULE_5__ =
            __webpack_require__(
              /*! ./selectors */ "./src/selectors/get-mutation-selector.js"
            );
          /* harmony import */ var _selectors__WEBPACK_IMPORTED_MODULE_6__ =
            __webpack_require__(
              /*! ./selectors */ "./src/selectors/get-websocket-state.js"
            );
          /* harmony import */ var _middleware__WEBPACK_IMPORTED_MODULE_7__ =
            __webpack_require__(
              /*! ./middleware */ "./src/middleware/create-requests-store.js"
            );
              ...
              return function (store) {
                return function (next) {
                  return function (action) {
                    ...
                    var query = (0,
                    _selectors__WEBPACK_IMPORTED_MODULE_2__.default)(state, {
                      type: action.type,
                      requestKey:
                        (_action$meta2 = action.meta) == null
                          ? void 0
              ...
              return function (store) {
                return function (next) {
                  return function (action) {
                    ...
                    if (
                      action.type ===
                        _constants__WEBPACK_IMPORTED_MODULE_2__.STOP_POLLING ||
                      action.type ===
                        _constants__WEBPACK_IMPORTED_MODULE_2__.RESET_REQUESTS
                    ) {
                      if (!action.requests) {
                  ...
                  return function (action) {
                    ...
                    if (
                      ...
                      if (
                        ...
                        var query = (0,
                        _selectors__WEBPACK_IMPORTED_MODULE_2__.default)(
                          state,
                          {
                            type: action.type,
                            requestKey:
  ...
  \***********************************************************/
        ...
        /***/ (
          ...
          /* harmony import */ var _actions__WEBPACK_IMPORTED_MODULE_1__ =
            __webpack_require__(/*! ../actions */ "./src/actions.js");
          /* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_4__ =
            __webpack_require__(/*! ../constants */ "./src/constants.js");
          /* harmony import */ var _selectors__WEBPACK_IMPORTED_MODULE_2__ =
            __webpack_require__(
              /*! ../selectors */ "./src/selectors/get-query.js"
            );
          /* harmony import */ var _create_requests_store__WEBPACK_IMPORTED_MODULE_3__ =
            __webpack_require__(
              /*! ./create-requests-store */ "./src/middleware/create-requests-store.js"
            );

          var getRequestTypeString = function getRequestTypeString(
            requestType
          ) {
          ...
          var getDriver = function getDriver(config, action) {
            ...
            return (_action$meta = action.meta) != null && _action$meta.driver
          ...
          var getLastActionKey = function getLastActionKey(action) {
            ...
            return (
              action.type +
              ((_action$meta2 = action.meta) != null && _action$meta2.requestKey
          ...
          var isActionRehydrated = function isActionRehydrated(action) {
            ...
            return !!(
              ((_action$meta3 = action.meta) != null &&
                _action$meta3.cacheResponse) ||
              ((_action$meta4 = action.meta) != null &&
                _action$meta4.ssrResponse) ||
              ((_action$meta5 = action.meta) != null && _action$meta5.ssrError)
            );
          ...
          var abortPendingRequests = function abortPendingRequests(
            ...
            var payload = (0,
            _actions__WEBPACK_IMPORTED_MODULE_1__.getActionPayload)(action);
          ...
          var isTakeLatest = function isTakeLatest(action, config) {
            ...
            return ((_action$meta6 = action.meta) == null
              ? void 0
              : _action$meta6.takeLatest) !== undefined
          ...
          var maybeCallOnRequestInterceptor =
            function maybeCallOnRequestInterceptor(action, config, store) {
              var payload = (0,
              _actions__WEBPACK_IMPORTED_MODULE_1__.getActionPayload)(action);
          ...
          var maybeCallOnRequestMeta = function maybeCallOnRequestMeta(
            action,
            store
          ) {
            var _action$meta7;
            ...
            if (
              (_action$meta7 = action.meta) != null &&
              _action$meta7.onRequest &&
              !action.meta.ssrDuplicate
            ) {
              if (action.request) {
                return _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()(
          ...
          var maybeDispatchRequestAction = function maybeDispatchRequestAction(
            action,
            next
          ) {
          ...
          var getDriverActions = function getDriverActions(action, store) {
            ...
            if (
              (_action$meta8 = action.meta) != null &&
              _action$meta8.measureDownloadProgress
            ) {
              driverActions.setDownloadProgress = function (progress) {
                ...
                return store.dispatch(
                  (0,
                  _actions__WEBPACK_IMPORTED_MODULE_1__.setDownloadProgress)(
                    action.type +
                      (((_action$meta9 = action.meta) == null
                        ? void 0
                        : _action$meta9.requestKey) || ""),
                    progress
                  )
                );
              };
            ...
            if (
              (_action$meta10 = action.meta) != null &&
              _action$meta10.measureUploadProgress
            ) {
              driverActions.setUploadProgress = function (progress) {
                var _action$meta11;

                return store.dispatch(
                  (0, _actions__WEBPACK_IMPORTED_MODULE_1__.setUploadProgress)(
                    action.type +
                      (((_action$meta11 = action.meta) == null
                        ? void 0
                        : _action$meta11.requestKey) || ""),
                    progress
                  )
                );
              };
          ...
          var getResponsePromises = function getResponsePromises(
            action,
            config,
            pendingRequests,
            store
            ...
            if (
              (_action$meta12 = action.meta) != null &&
              _action$meta12.cacheResponse
            ) {
              return [Promise.resolve(action.meta.cacheResponse)];
            } else if (
              (_action$meta13 = action.meta) != null &&
              _action$meta13.ssrResponse
            ) {
              return [Promise.resolve(action.meta.ssrResponse)];
            } else if (
              (_action$meta14 = action.meta) != null &&
              _action$meta14.ssrError
            ) {
              return [Promise.reject(action.meta.ssrError)];
            }

            var driverActions = isBatchedRequest
              ? {}
              : getDriverActions(action, store);
            ...
            var responsePromises = isBatchedRequest
              ? actionPayload.request.map(function (r) {
          ...
          var maybeCallGetError = function maybeCallGetError(action, error) {
            ...
            if (
              ...
              (_action$meta15 = action.meta) != null &&
              _action$meta15.getError
            ) {
          ...
          var maybeCallOnErrorInterceptor =
            function maybeCallOnErrorInterceptor(action, config, store, error) {
              if (
                error !== "REQUEST_ABORTED" &&
                config.onError &&
                (!action.meta ||
          ...
          var maybeCallOnErrorMeta = function maybeCallOnErrorMeta(
            action,
            store,
            error
          ) {
            ...
            if (
              error !== "REQUEST_ABORTED" &&
              (_action$meta16 = action.meta) != null &&
              _action$meta16.onError &&
              !action.meta.ssrDuplicate
            ) {
          ...
          var maybeCallOnAbortInterceptor =
            function maybeCallOnAbortInterceptor(action, config, store, error) {
              if (
                error === "REQUEST_ABORTED" &&
                config.onAbort &&
          ...
          var maybeCallOnAbortMeta = function maybeCallOnAbortMeta(
            action,
            store,
            error
          ) {
            ...
            if (
              error === "REQUEST_ABORTED" &&
              (_action$meta17 = action.meta) != null &&
              _action$meta17.onAbort
            ) {
          ...
          var getInitialBatchObject = function getInitialBatchObject(
            responseKeys
          ) {
          ...
          var maybeTransformBatchRequestResponse =
            function maybeTransformBatchRequestResponse(action, response) {
              var actionPayload = (0,
              _actions__WEBPACK_IMPORTED_MODULE_1__.getActionPayload)(action);
              var isBatchedRequest = Array.isArray(actionPayload.request);
          ...
          var maybeCallGetData = function maybeCallGetData(
            action,
            store,
            response
          ) {
            ...
            if (
              !isActionRehydrated(action) &&
              (_action$meta18 = action.meta) != null &&
              _action$meta18.getData
            ) {
              var _action$meta19;

              var query = (0, _selectors__WEBPACK_IMPORTED_MODULE_2__.default)(
                store.getState(),
                {
                  type: action.type,
                  requestKey:
                    (_action$meta19 = action.meta) == null
                      ? void 0
                      : _action$meta19.requestKey,
                }
              );
              return _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()(
                {},
          ...
          var maybeCallOnSuccessInterceptor =
            function maybeCallOnSuccessInterceptor(
              action,
              config,
              store,
              response
          ...
          var maybeCallOnSuccessMeta = function maybeCallOnSuccessMeta(
            action,
            store,
            response
          ) {
            ...
            if (
              (_action$meta20 = action.meta) != null &&
              _action$meta20.onSuccess &&
              !action.meta.ssrDuplicate
            ) {
          ...
          var createSendRequestMiddleware =
            function createSendRequestMiddleware(config) {
              ...
              return function (store) {
                return function (next) {
                  return function (action) {
                    var payload = (0,
                    _actions__WEBPACK_IMPORTED_MODULE_1__.getActionPayload)(
                      action
                    );
                    var requestsStore = (0,
                    _create_requests_store__WEBPACK_IMPORTED_MODULE_3__.default)(
                      store
                    );

                    if (
                      action.type ===
                      _constants__WEBPACK_IMPORTED_MODULE_4__.JOIN_REQUEST
                    ) {
                      next(action);
                    ...
                    if (
                      action.type ===
                        _constants__WEBPACK_IMPORTED_MODULE_4__.ABORT_REQUESTS ||
                      (action.type ===
                        _constants__WEBPACK_IMPORTED_MODULE_4__.RESET_REQUESTS &&
                        payload.abortPending)
                    ) {
                    ...
                    if (config.isRequestAction(action)) {
                      ...
                      action = maybeCallOnRequestInterceptor(
                        action,
                        config,
                        requestsStore
                      );
                      ...
                      var responsePromises = getResponsePromises(
                        action,
                        config,
                        pendingRequests,
                        store
                      ...
                      return Promise.all(responsePromises)
                        ...
                        ["catch"](function (error) {
                          return maybeCallOnErrorInterceptor(
                            action,
                            config,
                            requestsStore,
                            error
                        ...
                        ["catch"](function (error) {
                          return maybeCallOnAbortInterceptor(
                            action,
                            config,
                            requestsStore,
                            error
                        ...
                        ["catch"](function (error) {
                          if (error === "REQUEST_ABORTED") {
                            var abortAction = (0,
                            _actions__WEBPACK_IMPORTED_MODULE_1__.createAbortAction)(
                              action
                            );
                          ...
                          var errorAction = (0,
                          _actions__WEBPACK_IMPORTED_MODULE_1__.createErrorAction)(
                            action,
                            error
                          );
                        ...
                        .then(function (response) {
                          response = maybeTransformBatchRequestResponse(
                            action,
                            response
                          );
                        ...
                        .then(function (response) {
                          return maybeCallOnSuccessInterceptor(
                            action,
                            config,
                            requestsStore,
                            response
                        ...
                        .then(function (response) {
                          var successAction = (0,
                          _actions__WEBPACK_IMPORTED_MODULE_1__.createSuccessAction)(
                            action,
                            response
                          );
  ...
  \********************************************************/
        ...
        /***/ (
          ...
          /* harmony import */ var _default_config__WEBPACK_IMPORTED_MODULE_0__ =
            __webpack_require__(
              /*! ../default-config */ "./src/default-config.js"
            );
          /* harmony import */ var _actions__WEBPACK_IMPORTED_MODULE_1__ =
          ...
          /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ =
            function (requestsPromise, config) {
              if (config === void 0) {
                ...
                return function (next) {
                  return function (action) {
                    if (config.isRequestAction(action)) {
                      ...
                      (0,
                      _actions__WEBPACK_IMPORTED_MODULE_1__.isResponseAction)(
                        action
                      )
                    ) {
                      action = next(action);
                      ...
                      if (
                        !(0,
                        _actions__WEBPACK_IMPORTED_MODULE_1__.isSuccessAction)(
                          action
                        )
                      ) {
  ...
  \***********************************************************/
        ...
        /***/ (
          ...
          /* harmony import */ var _actions__WEBPACK_IMPORTED_MODULE_4__ =
            __webpack_require__(/*! ../actions */ "./src/actions.js");
          /* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_2__ =
            __webpack_require__(/*! ../constants */ "./src/constants.js");
          /* harmony import */ var _create_requests_store__WEBPACK_IMPORTED_MODULE_3__ =
          ...
          var shouldBeNormalized = function shouldBeNormalized(
            action,
            globalNormalize
          ) {
            var _action$meta;
          ...
          var transformIntoLocalMutation = function transformIntoLocalMutation(
            ...
            if (
              ...
              meta.mutations = (0,
              _helpers__WEBPACK_IMPORTED_MODULE_1__.mapObject)(
...
*/
          ...
          var CleanableWebsocket = /*#__PURE__*/ (function () {
            ...
            _proto.addEventListener = function addEventListener(
              ...
              this.ws.addEventListener(
                type,
                type === "close" ? this.onClose : callback
              );
            };
          ...
          /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ =
            function (_ref) {
              ...
              _ref$subscriber =
                _ref$subscriber === void 0 ? {} : _ref$subscriber;
              var _ref$subscriber$WS = _ref$subscriber.WS,
                ...
                lazy =
                  _ref$subscriber$lazy === void 0
                    ? false
                    : _ref$subscriber$lazy,
              ...
              var clearLastReconnectTimeout =
                function clearLastReconnectTimeout() {
              ...
              var clearLastHeartbeatTimeout =
                function clearLastHeartbeatTimeout() {
              ...
              return function (store) {
                return function (next) {
                  return function (action) {
                    ...
                    if (
                      action.type ===
                      _constants__WEBPACK_IMPORTED_MODULE_2__.OPEN_WEBSOCKET
                    ) {
                    ...
                    if (
                      ...
                      ws.addEventListener("open", function () {
                        if (!activateOn) {
                          store.dispatch(
                            (0,
                            _actions__WEBPACK_IMPORTED_MODULE_4__.websocketOpened)()
                          );
                          active = true;
                        }
                        ...
                        if (isHeartbeatMessage) {
                          ...
                          lastHeartbeatTimeout = setTimeout(function () {
                            store.dispatch(
                              (0,
                              _actions__WEBPACK_IMPORTED_MODULE_4__.closeWebsocket)(
                                3000
                              )
                            );
                      ...
                      ws.addEventListener("close", function (e) {
                        store.dispatch(
                          (0,
                          _actions__WEBPACK_IMPORTED_MODULE_4__.websocketClosed)(
                            e.code
                          )
                        );
                        active = false;
                          ...
                          lastReconnectTimeout = setTimeout(function () {
                            store.dispatch(
                              lastOpenWebsocketAction
                                ? action
                                : (0,
                                  _actions__WEBPACK_IMPORTED_MODULE_4__.openWebsocket)()
                            );
                      ...
                      ws.addEventListener("message", function (message) {
                        ...
                        if (subscription) {
                          ...
                          if (
                            ((_subscription$meta3 = subscription.meta) !=
                              null &&
                    ...
                    if (
                      action.type ===
                      _constants__WEBPACK_IMPORTED_MODULE_2__.GET_WEBSOCKET
                    ) {
                      return ws;
                    }
                    ...
                    if (
                      ws &&
                      action.type ===
                        _constants__WEBPACK_IMPORTED_MODULE_2__.CLOSE_WEBSOCKET
                    ) {
                      clearLastReconnectTimeout();
                      clearLastHeartbeatTimeout();
                      ...
                      action.type ===
                      _constants__WEBPACK_IMPORTED_MODULE_2__.WEBSOCKET_OPENED
                    ) {
                      Object.values(subscriptions).forEach(function (
                        subscriptionAction
                      ) {
                        var actionPayload = (0,
                        _actions__WEBPACK_IMPORTED_MODULE_4__.getActionPayload)(
                          subscriptionAction
                        );
                      ...
                      action.type ===
                      _constants__WEBPACK_IMPORTED_MODULE_2__.STOP_SUBSCRIPTIONS
                    ) {
                      var _requestsStore = (0,
                      _create_requests_store__WEBPACK_IMPORTED_MODULE_3__.default)(
                        store
                      );
                      ...
                      if (!action.subscriptions) {
                        ...
                        _helpers__WEBPACK_IMPORTED_MODULE_1__.mapObject)(
                          subscriptions,
                          function (k, v) {
                            return action.subscriptions.includes(k)
                              ? undefined
                              : v;
                          }
                        );
  ...
  \****************************************/
        ...
        /***/ (
          ...
          var denormalize = function denormalize(
            data,
            normalizedData,
            usedKeys,
            path
            ...
            if (data !== null && typeof data === "object") {
              var objectEntries = usedKeys[path]
  ...
  \***********************************************/
        ...
        /***/ (
          ...
          __webpack_require__.r(__webpack_exports__);
          /* harmony export */ __webpack_require__.d(__webpack_exports__, {
            /* harmony export */ getDependentKeys: () =>
              /* binding */ getDependentKeys,
            /* harmony export */
          });
          var getDependentKeys = function getDependentKeys(
            data,
            normalizedData,
            usedKeys,
            dependentKeys,
  ...
  \***************************************/
        ...
        /***/ (
          ...
          /* harmony import */ var deepmerge__WEBPACK_IMPORTED_MODULE_0__ =
            __webpack_require__(
              /*! deepmerge */ "../../node_modules/deepmerge/dist/cjs.js"
            );
          /* harmony import */ var deepmerge__WEBPACK_IMPORTED_MODULE_0___default =
            /*#__PURE__*/ __webpack_require__.n(
              deepmerge__WEBPACK_IMPORTED_MODULE_0__
            );
  ...
  \**************************************/
        ...
        /***/ (
          ...
          __webpack_require__.r(__webpack_exports__);
          /* harmony export */ __webpack_require__.d(__webpack_exports__, {
            /* harmony export */ getDependencies: () =>
          ...
          /* harmony import */ var _merge_data__WEBPACK_IMPORTED_MODULE_1__ =
            __webpack_require__(
              /*! ./merge-data */ "./src/normalizers/merge-data.js"
            );
          ...
          var normalize = function normalize(data, config) {
            ...
            return [
              ...
              dependencies.reduce(function (prev, v) {
                var key = config.getNormalisationObjectKey(v);
                prev["@@" + key] = prev["@@" + key]
                  ? (0, _merge_data__WEBPACK_IMPORTED_MODULE_1__.mergeData)(
                      prev["@@" + key],
        ...
        /***/ (
          ...
          /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ =
            function (state, action) {
              if (
                action.type ===
                _constants__WEBPACK_IMPORTED_MODULE_1__.CLEAR_REQUESTS_CACHE
              ) {
                if (!action.requests) {
                  return {};
                }
              ...
              if (
                (0, _actions__WEBPACK_IMPORTED_MODULE_2__.isSuccessAction)(
                  action
                ) &&
                action.meta.cache &&
                ...
                var requestAction = (0,
                _actions__WEBPACK_IMPORTED_MODULE_2__.getRequestActionFromResponse)(
                  action
                );
                return _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()(
                  {},
        ...
        /***/ (
          ...
          /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ =
            function (state, action) {
              ...
              if (
                !(0, _actions__WEBPACK_IMPORTED_MODULE_1__.isResponseAction)(
                  action
                )
              ) {
                ...
                return _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()(
                  ...
                  state,
                  ((_extends2 = {}),
                  (_extends2[_mutationType] = {
                    error: null,
                    pending:
                      (state[_mutationType]
                        ? state[_mutationType].pending
                        : 0) + 1,
              ...
              var requestAction = (0,
              _actions__WEBPACK_IMPORTED_MODULE_1__.getRequestActionFromResponse)(
                action
              );
              var mutationType =
                requestAction.type +
              ...
              if (
                (0, _actions__WEBPACK_IMPORTED_MODULE_1__.isErrorAction)(action)
              ) {
                var _extends3;
              ...
              if (
                (0, _actions__WEBPACK_IMPORTED_MODULE_1__.isAbortAction)(
                  action
                ) &&
        ...
        /***/ (
          ...
          /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ =
            function (state, action, config) {
              ...
              if (
                action.type ===
                _constants__WEBPACK_IMPORTED_MODULE_1__.SET_DOWNLOAD_PROGRESS
              ) {
                var _extends2;
              ...
              if (
                action.type ===
                _constants__WEBPACK_IMPORTED_MODULE_1__.SET_UPLOAD_PROGRESS
              ) {
                var _extends3;
  ...
  \*****************************************/
        ...
        /***/ (
          ...
          /* harmony import */ var _babel_runtime_helpers_objectWithoutPropertiesLoose__WEBPACK_IMPORTED_MODULE_0__ =
            __webpack_require__(
              /*! @babel/runtime/helpers/objectWithoutPropertiesLoose */ "../../node_modules/@babel/runtime/helpers/objectWithoutPropertiesLoose.js"
            );
          /* harmony import */ var _babel_runtime_helpers_objectWithoutPropertiesLoose__WEBPACK_IMPORTED_MODULE_0___default =
            /*#__PURE__*/ __webpack_require__.n(
              _babel_runtime_helpers_objectWithoutPropertiesLoose__WEBPACK_IMPORTED_MODULE_0__
            );
          /* harmony import */ var _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_1__ =
            __webpack_require__(
              /*! @babel/runtime/helpers/extends */ "../../node_modules/@babel/runtime/helpers/extends.js"
            );
          /* harmony import */ var _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_1___default =
            /*#__PURE__*/ __webpack_require__.n(
              _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_1__
            );
          /* harmony import */ var _default_config__WEBPACK_IMPORTED_MODULE_7__ =
            __webpack_require__(
              /*! ../default-config */ "./src/default-config.js"
            );
          /* harmony import */ var _actions__WEBPACK_IMPORTED_MODULE_4__ =
          ...
          /* harmony import */ var _normalizers__WEBPACK_IMPORTED_MODULE_5__ =
            __webpack_require__(
              /*! ../normalizers */ "./src/normalizers/normalize.js"
            );
          /* harmony import */ var _normalizers__WEBPACK_IMPORTED_MODULE_6__ =
            __webpack_require__(
              /*! ../normalizers */ "./src/normalizers/merge-data.js"
            );
          /* harmony import */ var _update_data__WEBPACK_IMPORTED_MODULE_2__ =
            __webpack_require__(
              /*! ./update-data */ "./src/reducers/update-data.js"
            );
          ...
          var getDataFromResponseAction = function getDataFromResponseAction(
            action
          ) {
          ...
          var queryReducer = function queryReducer(
            ...
            if (
              (_action$meta2 = action.meta) != null &&
              (_action$meta2$mutatio = _action$meta2.mutations) != null &&
              _action$meta2$mutatio[actionType]
            ) {
              var _queries;

              var mutationConfig = action.meta.mutations[actionType];
              var data = (0, _update_data__WEBPACK_IMPORTED_MODULE_2__.default)(
                state.normalized
                  ? (0, _selectors__WEBPACK_IMPORTED_MODULE_3__.default)(
                      {
                        requests: {
                          normalizedData: normalizedData,
                          queries:
                            ((_queries = {}),
                            (_queries[actionType] = state),
                            _queries),
                          downloadProgress: {},
                          uploadProgress: {},
                        },
            ...
            switch (action.type) {
              case (0, _actions__WEBPACK_IMPORTED_MODULE_4__.success)(
                actionType
              ):
                return ((_action$meta3 = action.meta) != null &&
                  _action$meta3.ssrResponse) ||
                  ((_action$meta4 = action.meta) != null &&
                    _action$meta4.cacheResponse)
                  ? state
                  : _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_1___default()(
                      {},
                      state,
              ...
              case (0, _actions__WEBPACK_IMPORTED_MODULE_4__.error)(actionType):
                return (_action$meta5 = action.meta) != null &&
                  _action$meta5.ssrError
                  ? state
                  : _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_1___default()(
                      {},
                      state,
              ...
              case (0, _actions__WEBPACK_IMPORTED_MODULE_4__.abort)(
                actionType
              ): {
                if (
                  state.pending === 1 &&
              ...
              default:
                return ((_action$meta6 = action.meta) != null &&
                  _action$meta6.ssrResponse) ||
                  ((_action$meta7 = action.meta) != null &&
                    _action$meta7.ssrError) ||
                  ((_action$meta8 = action.meta) != null &&
                    _action$meta8.cacheResponse)
                  ? state
                  : _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_1___default()(
                      {},
                      state,
          ...
          var maybeGetQueryActionType = function maybeGetQueryActionType(
            action,
            config
          ) {
            if (
            ...
            if (
              (0, _actions__WEBPACK_IMPORTED_MODULE_4__.isResponseAction)(
                action
              ) &&
              config.isRequestActionQuery(
                (0,
                _actions__WEBPACK_IMPORTED_MODULE_4__.getRequestActionFromResponse)(
                  action
                )
              )
            ) {
          ...
          var updateNormalizedData = function updateNormalizedData(
            normalizedData,
            action,
            config
          ) {
            ...
            if (
              config.isRequestAction(action) &&
              (_action$meta9 = action.meta) != null &&
              _action$meta9.optimisticData
            ) {
              var _normalize = (0,
                _normalizers__WEBPACK_IMPORTED_MODULE_5__.normalize)(
                  action.meta.optimisticData,
                  config
                ),
                newNormalizedData = _normalize[1];

              return (0, _normalizers__WEBPACK_IMPORTED_MODULE_6__.mergeData)(
                normalizedData,
                newNormalizedData
              );
            }
            ...
            if (
              ...
              (0, _actions__WEBPACK_IMPORTED_MODULE_4__.isErrorAction)(
                action
              ) &&
            ...
            if (
              ...
              (0, _actions__WEBPACK_IMPORTED_MODULE_4__.isSuccessAction)(
                action
              ) &&
            ...
            if (
              (_action$meta10 = action.meta) != null &&
              _action$meta10.localData
            ) {
              var _normalize4 = (0,
                _normalizers__WEBPACK_IMPORTED_MODULE_5__.normalize)(
                  action.meta.localData,
                  config
                ),
          ...
          /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ =
            function (state, action, config) {
              ...
              var normalizedData = updateNormalizedData(
                      ...
                      Object.keys(action.meta.mutations)
                        ...
                        .reduce(function (prev, actionType) {
                          ...
                          if (
                            ...
                            normalizedData = (0,
                            _normalizers__WEBPACK_IMPORTED_MODULE_6__.mergeData)(
                              normalizedData,
                              newNormalizedData
                            );
                            prev[actionType] =
              ...
              if (queryActionType) {
                ...
                var queryType =
                  ((_action$meta12 = action.meta) == null
                    ? void 0
                    : _action$meta12.requestKey) !== undefined
                ...
                return {
                  queries:
                    _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_1___default()(
                      ...
                      state.queries,
                      ((_extends3 = {}),
                      (_extends3[queryType] = updatedQuery),
                      _extends3)
                    ),
                  normalizedData: normalizedData,
                };
          ...
          /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ =
            function (state, action, config) {
              ...
              if (
                ...
                ((_action$meta = action.meta) == null
                  ? void 0
                  : _action$meta.requestKey) !== undefined
              ) {
                ...
                if (!requestsKeys[action.type]) {
                  ...
                  requestsKeys =
                    _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()(
                      ...
                      requestsKeys,
                      ((_extends2 = {}),
                      (_extends2[action.type] = [action.meta.requestKey]),
                      _extends2)
                    );
                } else {
                  var _extends3;
                  ...
                  requestsKeys =
                    _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()(
                      ...
                      requestsKeys,
                      ((_extends3 = {}),
                      (_extends3[action.type] = [].concat(
                        requestsKeys[action.type].filter(function (k) {
                    ...
                    if (exceedingRequestsKeys.length > 0) {
                      ...
                      requestsKeys =
                        _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()(
                          ...
                          requestsKeys,
                          ((_extends4 = {}),
                          (_extends4[action.type] = requestsKeys[
                            action.type
                          ].filter(function (k) {
  ...
  \******************************************/
        ...
        /***/ (
          ...
          /* harmony import */ var _actions__WEBPACK_IMPORTED_MODULE_3__ =
            __webpack_require__(/*! ../actions */ "./src/actions.js");
          /* harmony import */ var _queries_reducer__WEBPACK_IMPORTED_MODULE_2__ =
            __webpack_require__(
              /*! ./queries-reducer */ "./src/reducers/queries-reducer.js"
            );
          /* harmony import */ var _mutations_reducer__WEBPACK_IMPORTED_MODULE_4__ =
            __webpack_require__(
              /*! ./mutations-reducer */ "./src/reducers/mutations-reducer.js"
            );
          /* harmony import */ var _requests_keys_reducer__WEBPACK_IMPORTED_MODULE_5__ =
            __webpack_require__(
              /*! ./requests-keys-reducer */ "./src/reducers/requests-keys-reducer.js"
            );
          /* harmony import */ var _cache_reducer__WEBPACK_IMPORTED_MODULE_7__ =
            __webpack_require__(
              /*! ./cache-reducer */ "./src/reducers/cache-reducer.js"
            );
          /* harmony import */ var _progress_reducer__WEBPACK_IMPORTED_MODULE_8__ =
            __webpack_require__(
              /*! ./progress-reducer */ "./src/reducers/progress-reducer.js"
            );
          /* harmony import */ var _requests_reset_reducer__WEBPACK_IMPORTED_MODULE_6__ =
            __webpack_require__(
              /*! ./requests-reset-reducer */ "./src/reducers/requests-reset-reducer.js"
            );
          /* harmony import */ var _ssr_reducer__WEBPACK_IMPORTED_MODULE_9__ =
            __webpack_require__(
              /*! ./ssr-reducer */ "./src/reducers/ssr-reducer.js"
            );
          /* harmony import */ var _watchers_reducer__WEBPACK_IMPORTED_MODULE_10__ =
            __webpack_require__(
              /*! ./watchers-reducer */ "./src/reducers/watchers-reducer.js"
            );
          /* harmony import */ var _websocket_reducer__WEBPACK_IMPORTED_MODULE_11__ =
            __webpack_require__(
              /*! ./websocket-reducer */ "./src/reducers/websocket-reducer.js"
            );
          ...
          /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ =
            function (config) {
              ...
              return function (state, action) {
                ...
                var _queriesReducer = (0,
                  _queries_reducer__WEBPACK_IMPORTED_MODULE_2__.default)(
                    {
                ...
                if (
                  (config.isRequestAction(action) &&
                    !config.isRequestActionQuery(action)) ||
                  ((0, _actions__WEBPACK_IMPORTED_MODULE_3__.isResponseAction)(
                    action
                  ) &&
                    !config.isRequestActionQuery(
                      (0,
                      _actions__WEBPACK_IMPORTED_MODULE_3__.getRequestActionFromResponse)(
                        action
                      )
                    ))
                ) {
                  mutations = (0,
                  _mutations_reducer__WEBPACK_IMPORTED_MODULE_4__.default)(
                    mutations,
                    action
                  );
                }
                ...
                return _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()(
                  {},
                  (0,
                  _requests_keys_reducer__WEBPACK_IMPORTED_MODULE_5__.default)(
                    _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()(
                      {},
                      (0,
                      _requests_reset_reducer__WEBPACK_IMPORTED_MODULE_6__.default)(
                        _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()(
                          {
                            queries: queries,
                            mutations: mutations,
                            cache: (0,
                            _cache_reducer__WEBPACK_IMPORTED_MODULE_7__.default)(
                              state.cache,
                              action
                            ),
                          },
                          (0,
                          _progress_reducer__WEBPACK_IMPORTED_MODULE_8__.default)(
                            {
                              downloadProgress: state.downloadProgress,
                              uploadProgress: state.uploadProgress,
                            },
                  ...
                  ),
                  {
                    normalizedData: normalizedData,
                    ssr: config.ssr
                      ? (0, _ssr_reducer__WEBPACK_IMPORTED_MODULE_9__.default)(
                          state.ssr,
                          action,
                          config
                        )
                      : null,
                    watchers: (0,
                    _watchers_reducer__WEBPACK_IMPORTED_MODULE_10__.default)(
                      state.watchers,
                      action,
                      config
                    ),
                    websocket: (0,
                    _websocket_reducer__WEBPACK_IMPORTED_MODULE_11__.default)(
                      state.websocket,
                      action,
                      config
                    ),
        ...
        /***/ (
          ...
          /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ =
            function (state, action) {
              if (
                action.type !==
                _constants__WEBPACK_IMPORTED_MODULE_1__.RESET_REQUESTS
              ) {
                return state;
              }
              ...
              queries = (0, _helpers__WEBPACK_IMPORTED_MODULE_2__.mapObject)(
                queries,
                function (k, v) {
              ...
              mutations = (0, _helpers__WEBPACK_IMPORTED_MODULE_2__.mapObject)(
                mutations,
                function (k, v) {
              ...
              cache =
                clearAll && action.resetCached
                  ? {}
                  : (0, _helpers__WEBPACK_IMPORTED_MODULE_2__.mapObject)(
                      cache,
                      function (k, v) {
                        var cacheValue = cache[k];
              ...
              downloadProgress = clearAll
                ...
                : (0, _helpers__WEBPACK_IMPORTED_MODULE_2__.mapObject)(
                    downloadProgress,
                    function (k, v) {
                      return clearAll || keys.includes(k)
                        ? resetMutation(v)
                        : v;
                    }
                  );
          ...
          /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ =
            function (state, action, config) {
              ...
              if (
                config.ssr === "server" &&
                action.type ===
                  _constants__WEBPACK_IMPORTED_MODULE_2__.JOIN_REQUEST &&
                action.rehydrate
              ) {
                return [].concat(state, [
                  {
              ...
              if (
                ...
                config.isRequestAction(action) &&
                (((_action$meta = action.meta) != null &&
                  _action$meta.ssrResponse) ||
                  ((_action$meta2 = action.meta) != null &&
                    _action$meta2.ssrError))
              ) {
  ...
  \*************************************/
        ...
        /***/ (
          ...
          /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ =
            function (data, action, mutationConfig) {
              if (
                (0, _actions__WEBPACK_IMPORTED_MODULE_0__.isResponseAction)(
                  action
                )
              ) {
                if (
                  (0, _actions__WEBPACK_IMPORTED_MODULE_0__.isSuccessAction)(
                    action
                  )
                ) {
                ...
                return mutationConfig.revertData
                  ? mutationConfig.revertData(data)
                  : data;
              }
        ...
        /***/ (
          ...
          /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ =
            function (state, action, config) {
              ...
              if (
                action.type ===
                _constants__WEBPACK_IMPORTED_MODULE_2__.ADD_WATCHER
              ) {
                var _extends2;
              ...
              if (
                action.type ===
                  _constants__WEBPACK_IMPORTED_MODULE_2__.REMOVE_WATCHER &&
                state[action.requestType] === 1
              ) {
                // eslint-disable-next-line no-unused-vars
                var _action$requestType = action.requestType,
                  ...
                  remaining =
                    _babel_runtime_helpers_objectWithoutPropertiesLoose__WEBPACK_IMPORTED_MODULE_0___default()(
                      state,
                      [_action$requestType].map(_toPropertyKey)
                    );
        ...
        /***/ (
          ...
          /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ =
            function (state, action, config) {
              ...
              if (
                action.type ===
                _constants__WEBPACK_IMPORTED_MODULE_0__.WEBSOCKET_OPENED
              ) {
                return {
                  pristine: false,
                  connected: true,
              ...
              if (
                action.type ===
                _constants__WEBPACK_IMPORTED_MODULE_0__.WEBSOCKET_CLOSED
              ) {
                return {
  ...
  \************************************************/
        ...
        /***/ (
          ...
          /* harmony import */ var _get_mutation__WEBPACK_IMPORTED_MODULE_0__ =
            __webpack_require__(
              /*! ./get-mutation */ "./src/selectors/get-mutation.js"
            );

          /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ =
            function (props) {
              return function (state) {
                return (0, _get_mutation__WEBPACK_IMPORTED_MODULE_0__.default)(
                  state,
                  props
                );
              };
  ...
  \***************************************/
        ...
        /***/ (
          ...
          /* harmony import */ var reselect__WEBPACK_IMPORTED_MODULE_0__ =
            __webpack_require__(/*! reselect */ "reselect");
          /* harmony import */ var reselect__WEBPACK_IMPORTED_MODULE_0___default =
            /*#__PURE__*/ __webpack_require__.n(
          ...
          var getMutationState = function getMutationState(
            state,
            type,
            requestKey
          ) {
          ...
          var createMutationSelector = function createMutationSelector(
            type,
            requestKey
          ) {
            return (0, reselect__WEBPACK_IMPORTED_MODULE_0__.createSelector)(
              function (state) {
              ...
              function (state) {
                ...
                return (_state$requests$downl =
                  state.requests.downloadProgress[type + (requestKey || "")]) !=
                  null
                  ? _state$requests$downl
                  : null;
              },
              function (state) {
                var _state$requests$uploa;

                return (_state$requests$uploa =
                  state.requests.uploadProgress[type + (requestKey || "")]) !=
                  null
                  ? _state$requests$uploa
                  : null;
              },
  ...
  \*********************************************/
        ...
        /***/ (
          ...
          /* harmony import */ var _get_query__WEBPACK_IMPORTED_MODULE_0__ =
            __webpack_require__(
              /*! ./get-query */ "./src/selectors/get-query.js"
            );

          /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ =
            function (props) {
              return function (state) {
                return (0, _get_query__WEBPACK_IMPORTED_MODULE_0__.default)(
                  state,
                  props
                );
              };
  ...
  \************************************/
        ...
        /***/ (
          ...
          /* harmony import */ var reselect__WEBPACK_IMPORTED_MODULE_1__ =
            __webpack_require__(/*! reselect */ "reselect");
          /* harmony import */ var reselect__WEBPACK_IMPORTED_MODULE_1___default =
            /*#__PURE__*/ __webpack_require__.n(
              reselect__WEBPACK_IMPORTED_MODULE_1__
            );
          /* harmony import */ var _normalizers__WEBPACK_IMPORTED_MODULE_2__ =
            __webpack_require__(
              /*! ../normalizers */ "./src/normalizers/get-dependent-keys.js"
            );
          /* harmony import */ var _normalizers__WEBPACK_IMPORTED_MODULE_3__ =
            __webpack_require__(
              /*! ../normalizers */ "./src/normalizers/denormalize.js"
            );
          ...
          var isQueryEqual = function isQueryEqual(currentVal, previousVal) {
            ...
            if (
              ...
              var currentDependencies = (0,
              _normalizers__WEBPACK_IMPORTED_MODULE_2__.getDependentKeys)(
                currentVal.data,
                currentVal.normalizedData,
                currentVal.usedKeys
              );
              var previousDependencies = (0,
              _normalizers__WEBPACK_IMPORTED_MODULE_2__.getDependentKeys)(
                previousVal.data,
              ...
              for (
                var _iterator =
                    _createForOfIteratorHelperLoose(currentDependencies),
                  _step;
          ...
          var createCustomSelector = (0,
          reselect__WEBPACK_IMPORTED_MODULE_1__.createSelectorCreator)(
            reselect__WEBPACK_IMPORTED_MODULE_1__.defaultMemoize,
            isQueryEqual
          );
          ...
          var createQuerySelector = function createQuerySelector(
            type,
            requestKey
          ) {
            return createCustomSelector(
              function (state, defaultData, multiple) {
                ...
                return {
                  ...
                  downloadProgress:
                    (_state$requests$downl =
                      state.requests.downloadProgress[
                        type + (requestKey || "")
                      ]) != null
                      ? _state$requests$downl
                      : null,
              ...
              function (_ref) {
                ...
                return {
                  data: normalized
                    ? (0,
                      _normalizers__WEBPACK_IMPORTED_MODULE_3__.denormalize)(
          ...
          var getDefaultQuery = function getDefaultQuery(
            defaultData,
            multiple
          ) {
            if (
          ...
          /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ =
            function (state, _ref2) {
              ...
              if (!querySelectors.get(queryState.ref)) {
                querySelectors.set(
                  queryState.ref,
                  createQuerySelector(type, requestKey)
                );
              }

              return querySelectors.get(queryState.ref)(
                state,
                defaultData,
                multiple
              );
