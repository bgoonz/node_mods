...
var _requestsKeysReducer = _interopRequireDefault(
  require("./requests-keys-reducer")
);
...
var _requestsResetReducer = _interopRequireDefault(
  require("./requests-reset-reducer")
);
...
var _default = function _default(config) {
  ...
  return function (state, action) {
    ...
    return (0, _extends2["default"])(
      {},
      (0, _requestsKeysReducer["default"])(
        (0, _extends2["default"])(
          {},
          (0, _requestsResetReducer["default"])(
            (0, _extends2["default"])(
              {
                queries: queries,
                mutations: mutations,
      ...
      ),
      {
        ...
        ssr: config.ssr
          ? (0, _ssrReducer["default"])(state.ssr, action, config)
          : null,
        watchers: (0, _watchersReducer["default"])(
          state.watchers,
          action,
          config
        ),
        websocket: (0, _websocketReducer["default"])(
          state.websocket,
          action,
          config
        ),
