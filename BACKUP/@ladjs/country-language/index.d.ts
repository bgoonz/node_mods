...
export function getLanguageCodes(
  codeType?: LanguageCodeType
): string[] | string;
export function getLanguageCodes<R extends unknown>(
  codeType: LanguageCodeType | undefined,
  cb: CbType<R, string[]>
): R;
...
export function getCountryCodes<R extends unknown>(
  codeType: CountryCodeType | undefined,
  cb: CbType<R, string[]>
): R;
...
export function getCountry<R extends unknown>(
  countryCode: string,
  cb: CbType<R, Country>,
  noLangInfo?: false
): R;
...
export function getLanguage<R extends unknown>(
  languageCode: string,
  cb: CbType<R, Language>,
  noCountryInfo?: false
): R;
export function getLanguage<R extends unknown>(
  languageCode: string,
  cb: CbType<R, LanguageData>,
  noCountryInfo: true
): R;
...
export function getCountryLanguages<R extends unknown>(
  countryCode: string,
  cb: CbType<R, LanguageCodes[]>
): R;

export function getLanguageCountries(
  languageCode: string
): CountryCodes[] | string;
export function getLanguageCountries<R extends unknown>(
  languageCode: string,
  cb: CbType<R, CountryCodes[]>
): R;

export function getCountryMsLocales(
  countryCode: string
): LanguageCulturesMs[] | string;
export function getCountryMsLocales<R extends unknown>(
  countryCode: string,
  cb: CbType<R, LanguageCulturesMs[]>
): R;

export function getLanguageMsLocales(
  languageCode: string
): LanguageCulturesMs[] | string;
export function getLanguageMsLocales<R extends unknown>(
  languageCode: string,
  cb: CbType<R, LanguageCulturesMs[]>
): R;

export function getLanguageFamilyMembers(family: string): Language[] | string;
export function getLanguageFamilyMembers<R extends unknown>(
  family: string,
  cb: CbType<R, Language[]>
): R;
