...
var _extractWithPath = _interopRequireDefault(
  require("../jsonpath/extractWithPath")
);

var _arrayToJSONMatchPath = _interopRequireDefault(
  require("../jsonpath/arrayToJSONMatchPath")
);
...
class SquashingBuffer {
  ...
  constructor(doc) {
    ...
    if (doc) {
      ...
      (0, _debug.default)(
        "Reset mutation buffer state to document being deleted"
      );
    }
  ...
  addOperation(op) {
    ...
    if (
      ...
      for (
        var _i = 0, _Object$keys = Object.keys(setPatch);
      ...
      if (Object.keys(unoptimizable).length > 0) {
        (0, _debug.default)(
          "Unoptimizable set-operation detected, purging optimization buffer"
        );
        this.staged.push({
          patch: {
    ...
    if (
      ...
      this.PRESTAGE &&
      op.createIfNotExists._id === this.PRESTAGE._id
    ) {
    ...
    (0, _debug.default)(
      "Unoptimizable mutation detected, purging optimization buffer"
