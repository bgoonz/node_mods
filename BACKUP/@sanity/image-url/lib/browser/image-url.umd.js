;(function (global, factory) {
  ...
  function specToImageUrl(spec) {
    ...
    var filename =
      spec.asset.id + '-' + spec.asset.width + 'x' + spec.asset.height + '.' + spec.asset.format
  ...
  function rewriteSpecName(key) {
    ...
    for (
      var _iterator = _createForOfIteratorHelperLoose(specs), _step;
  ...
  var ImageUrlBuilder = /*#__PURE__*/ (function () {
    function ImageUrlBuilder(parent, options) {
      this.options = parent
        ? _extends(_extends({}, parent.options || {}), options || {})
        : _extends({}, options || {})
    }
